...
\begin{document}
	...
	\begin{wrapfigure}{l}{5cm}
		...
		cm]{../editorial/editorial_Jesús}
		\caption*{
			\centering
			MC. Jesus K. Perez Castilla		
			\textit{Equipo técnico de Epidemiología. GERESA Cusco}
...
5. Román BR, Moscoso S, Chung SA, Terceros BL, Álvarez-Risco A, Yáñez JA. Treatment of COVID-19 in peru and bolivia, and self-medication risks. Rev Cuba Farm [Internet]. 2020;53(2):1–20. Disponible en: http://www.revfarmacia.sld.cu/index.php/far/article/view/435/310
	...
	\noindent La Figura \ref{fig:vacuna_edad} muestra la cobertura de vacunación por grupo etario en la Región Cusco. Se evidencia que la cobertura de vacunación va incrementado, siendo directamente proporcional a la edad.
	...
	La Figura \ref{fig:mortalidad_ordenada} muestra a las provincias de la región ordenadas de mayor a menor según la tasa de mortalidad acumulada, desde el 1 de enero hasta el 27 de julio del 2022, siendo las provincias con mayor tasa de mortalidad;  Canchis (2,8 defunciones/ 10 000 hab), Quispicanchis (2,4 defunciones/ 10 000 hab), La Convención y Cusco (ambas con 1,8 defunciones/ 10 000 hab). 
	...
	La Figura \ref{fig:incidencia_provincial} muestra la tendencia de la incidencia acumulada a través del año 2022. Podemos observar que despues de un largo tiempo de comportamiento en meseta, la provincia del Cusco tiene una tendencia al ascenso desde la SE 25.
	...
	\noindent La aparición de la variante ómicron generó la tercera ola y está generando la cuarta ola de COVID-19 en el Perú debido a su gran transmisibilidad. Asimismo es importante resaltar la identificación de las nuevas subvariantes BA.4 y BA.5 de ómicron en el mes de junio. En la Figura \ref{fig:variantes} y \ref{fig:subvariantes} se observa que en la región de Cusco, la variante ómicron (100$\%$) es la única prevalente para el mes de junio.
	...
	\begin{figure}[h]
	\caption{Prevalencia de las variantes de SARS Cov-2 aisladas en la región de Cusco, hasta Junio-2022. }\label{fig:subvariantes}
	\begin{center}
