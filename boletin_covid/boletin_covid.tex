...
\section*{Evaluación Provincial de 5 Indicadores}
		...
		\noindent Las figuras de abajo (Figura \ref{fig:inc_mort_calca}, \ref{fig:positividad_calca}) muestran el comportamiento de la tasa de incidencia, mortalidad y  positividad. Con respecto a la tasa de incidencia, se evidencia su tendencia al descenso en la dos últimas semanas, mientras que la tasa de mortalidad ha presentado un incremento en a última semana. 
		
		En la Figura \ref{fig:exceso_calca} se muestra que hay un exceso de cuatro defunciones respecto al año 2019.
		...
		\noindent La Figura \ref{fig:inc_mort_canchis} se envidencia que tras el ascenso marcado de la tasa de incidencia en las dos primeras semanas del 2022, tras ello la tasa de incidencia miestra una tendencia al descenso. Con respecto a la tasa de mortalidad se han reportado un incremento de muertes en la SE 03 y SE 06.    
		\noindent La Figura \ref{fig:positividad_canchis} muestra el descenso de ambas tasas de positividad tanto antigénicas y moleculares desde la SE 06 del 2022.
		
		En la Figura \ref{fig:exceso_canchis} se muestra que hay un exceso de menos 02 defunciones (exceso negativo) respecto al año 2019.
		...
		\noindent La Figura \ref{fig:positividad_chumbivilcas} muestra una tendencia al descenso desde la SE 03 de la tasa de positividad de pruebas antigénicas de la SE 03, mientras que la positividad de pruebas moleculares se ha mantenido variable. 
		
		En la Figura \ref{fig:exceso_chumbivilcas} se muestra que hay un exceso de 3 defunciones respecto al año 2019.
		...
		\noindent La Figura \ref{fig:inc_mort_cusco} se evidencia un descenso marcado de la tasa de incidencia desde la SE 03, mientras que la tasa de mortalidad muestra un discreto ascenso en la última semana.   
		\noindent La  Figura \ref{fig:positividad_cusco} muestra el mismo comportamiento para las tasas de positividad de ambas pruebas a partir de la SE 04 del 2022. 
	...
	En la Figura \ref{fig:exceso_cusco} se muestra que hay exceso de 14 defunciones respecto al año 2019.
		...
		\noindent Las figuras inferiores (Figura \ref{fig:inc_mort_laconv}, \ref{fig:positividad_laconv}) muestran el comportamiento de la tasa de incidencia y mortalidad, con respecto a la tasa de incidencia se muestra una tendencia al descenso desde la SE 03. 
	
	En la Figura \ref{fig:exceso_laconv}  muestra que hay un exceso de 2 defunciones respecto al año 2019.     
		...
		\noindent Las figuras de abajo (Figura \ref{fig:inc_mort_paruro}, \ref{fig:positividad_paruro}) muestran el comportamiento de la tasa de incidencia, mortalidad y positividad. Tras el ascenso marcado de la tasa de incidencia en la SE 03, la tasa de incidencia  muestra una pendiente en descenso hasta la SE 07 donde se reportó un mayor número de casos.   
	 ...
	 En la Figura \ref{fig:exceso_paruro} muestra que no hubieron exceso de muertes. 
		...
		\noindent Las figuras de abajo (Figura \ref{fig:inc_mort_paucartam}, \ref{fig:positividad_paucartam}) muestran el comportamiento de la tasa de incidencia, mortalidad y positividad. Se evidencia la tendencia al descenso de la tasa de incidencia desde la SE O3.   
	En la Figura \ref{fig:exceso_paucartam} se muestra un exceso 1 defunción respecto al año 2021.  
	...
	En la Figura \ref{fig:exceso_quisp} se muestra que hay un exceso de 1 defunción respectos al año 2019.
		...
		En la Figura \ref{fig:exceso_urub} se muestra un exceso de menos una defunción (exceso negativo) respecto al año 2019.
...
%---------------------------------------------------------------------------
		...
		Hasta el 22 de febero del 2022 se secuenciaron 393 muestras a nivel de la región de Cusco 
	...
	Asímismo, la Figura \ref{fig:mapa_variantes} muestra las variantes de COVID-19 aisladas por zonas. 
