...
\section*{Evaluación Provincial de 5 Indicadores}
	...
	En la Figura \ref{fig:exceso_cusco} se muestra que hay exceso de 5 defunciones (exceso positivo) respecto al año 2019.
		...
		\begin{figure}[h]
			\caption{Tasa de Positividad de Prueba Molecular y Antigénica Comparativa en la Provincia de Espinar hasta la SE 03,2021.}\label{fig:positividad_espinar}
			\begin{center}
		...
		\begin{figure}[h]
			\caption{Exceso de Defunciones Comparativo en la Provincia de Espinar hasta la SE 03,2021.}\label{fig:exceso_espinar}
			\begin{center}
	...
	En la Figura \ref{fig:exceso_paucartam} se muestra que un exceso de cuatro defunciones (exceso negativo) respecto al año 2019.
		...
		\begin{figure}[h]
			\caption{Exceso de Defunciones Comparativo en la Provincia de Paucartambo 2020 y 2021, hasta la SE 03,2022.}\label{fig:exceso_paucartam}
			\begin{center}
...
%---------------------------------------------------------------------------
	...
	Asímismo, la Figura \ref{fig:mapa_variantes}  muestra el lugar de aislamiento de las Variantes encontradas en la Región. La  Variante Delta, es la que predomina actualmente en nuestra región.
			...
			\begin{figure}[h]
				\caption{Distribución provincial de las variantes de SARS-Cov-2 aisladas en la Región Cusco, hasta la SE 03.}
...
\clearpage
	...
	\begin{table}[h]
		\caption{Defunciones Cero por COVID-19 a nivel Provincial hasta la SE 03,2022.}
		\resizebox{\textwidth}{!}{%
