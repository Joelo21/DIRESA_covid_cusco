...
\section*{Evaluación Provincial de 5 Indicadores}
		...
		\noindent La figura inferior (Figura \ref{fig:inc_mort_acomayo}, Figura\ref{fig:positividad_acomayo}) muestra un comportamiento variable de la tasa de mortalidad a lo largo del año, presentando una disminución marcada desde la SE 37. Con respecto a la tasa de incidencia, se ha mantenido baja sin variaciones bruscas con un reportes de casos entre semanas, para la SE 51 la tasa de incidencia muestra una pendiente en ascenso. 
		...
		\noindent La figura de abajo (Figura \ref{fig:inc_mort_canchis}, \ref{fig:positividad_canchis}) muestra el comportamiento de la tasa de incidencia, mortalidad y positividad. Con respecto a la tasa de incidencia se observa un marcado descenso desde la SE 25, y desde la SE 51 la tasa de incidencia se muestra en meceta. En relación a la tasa de mortalidad, para la SE 51 su pendiente se muestra en ascenso. 	
		...
		\noindent Las figuras de abajo (Figura \ref{fig:inc_mort_chumbivilcas}, \ref{fig:positividad_chumbivilcas}) muestran el comportamiento de la tasa de incidencia, mortalidad y positividad. En relación a la tasa de incidencia, se ha mantenido baja y en meceta desde la SE 38.  Con respecto a la tasa de mortalidad, se mantuvo variable con picos entre semanas. 
		...
		\noindent La figura de abajo (Figura \ref{fig:inc_mort_cusco},\ref{fig:positividad_cusco}) muestran el comportamiento de la tasa de incidencia, mortalidad y positividad. Con respecto a la tasa de incidencia se evidencia una tendencia al descenso al igual que la tasa de mortalidad desde la SE 40. Sin embargo, para la SE 51 la tasa de incidencia muestra una pendiente en discreto ascenso.  
