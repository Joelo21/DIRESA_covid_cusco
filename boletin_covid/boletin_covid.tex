...
Las Figuras \ref{fig:positividad_pcr} y \ref{fig:positividad_ag} muestran el número de positivos detectados por pruebas moleculares y antigénicas y sus tasas de positividad, en ambas pruebas se observa una marcada tendencia al descenso desde la SE 04, alcanzando una tasa de positividad de 3,4$\%$ en el caso de pruebas moleculares y de 1,3$\%$ en el caso de pruebas antigenicas. 
...
el número de casos positivos en población pediátrica hasta la SE 06, tras lo cuál se observa el descenso  
