...
\end{figure}
	...
	\begin{table}[h]		\caption{Defunciones Cero por COVID-19 a nivel Provincial hasta la SE 43-2022.}
		\resizebox{\textwidth}{!}{%
	...
	\begin{table}[h]		\caption{Tabla de Letalidad, Mortalidad e Incidencia a nivel Regional por Covid19, 2020 - 2022 (SE 43)}
		\resizebox{\textwidth}{!}{%
