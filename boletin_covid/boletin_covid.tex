...
\let\cleardoublepage\clearpage
	...
	El mensaje debe transmitirse, las vacunas salvan vidas y la mejor vacuna es la que llega primero.
	...
	La novedad en esta edición; se presenta el avance de cobertura de vacunación por sexo y por grupo etario, así como un análisis sobre las variantes de COVID-19 en la región. 
	...
	\begin{figure}[h]
		...
		\begin{center}
			\includegraphics[width=0.65\linewidth]{../figuras/1_casos_por_sexo}
		\end{center}
		{\footnotesize {Fuente de datos: SISCOVID, NOTICOVID.}}
	\end{figure}
\pagebreak

La Figura  \ref{fig:fallecidos_edad_sexo}  muestra el número de muertes hasta la SE 44 por grupo etario y sexo. Se puede apreciar que el mayor número de muertes se reporta en el grupo etario de 70 a 79 años(772 muertes acumuladas), seguido del grupo etario de 60 a 69 años (709 muertes acumuladas). Cabe mencionar que en casi todos los grupos etarios la cantidad de fallecidos de sexo masculino supera a la cantidad de fallecidos de sexo femenino.
	\begin{figure}[h]
		...
		\begin{center}
			\includegraphics[width=0.65\linewidth]{../figuras/2_muertes_sexo}
		\end{center}
		{\footnotesize {Fuente de datos: SISCOVID, NOTICOVID.}}
	\end{figure}
...
\begin{figure}[h]
	...
	\begin{center}
		\includegraphics[width=0.65\linewidth]{../figuras/sintomaticos_20_21.pdf}
	\end{center}
	{\footnotesize {Fuente de datos: SISCOVID, NOTICOVID.}}
\end{figure}
...
\noindent La tendencia de la tasa de incidencia en el tiempo se  encuentra graficada en la Figura \ref{fig:incidencia} se observa que tras la disminución de la tasa de Incidencia en la SE 41 (23 casos/100 000 * personas), se tiene un crecimiento sostenido de la los casos nuevos de COVID-19, llegando a registrarse una Tasa de 57 casos/100 000* personas, el número más alto registrado desde la SE 31.
   ...
   \begin{figure}[h]
   	...
   	\begin{center}
   		\includegraphics[width=0.65\linewidth]{../figuras/positividad_diaria}
   	\end{center}
   	{\footnotesize {Fuente de datos: SISCOVID, NOTICOVID.}}
   \end{figure}
   \begin{figure}[h]
...
\clearpage
	...
	\noindent  La Figura \ref{fig:exceso_regional} muestra que, a nivel regional, el exceso de defunciones por todas las causas ha disminuido en las últimas semanas. Para la SE 43 se registra un exceso de menos 3 fallecidos ,  respecto al año 2019, cifra bastante menor a las semanas previas.
...
En la Figura \ref{fig:ocupacion_2nivel}, se observa el número de camas disponibles y porcentaje de ocupación en el Nivel II, en general el porcentaje de ocupación se ha mantenido bajo (menos del 15$\%$) desde la semana 30. Para la SE 43 el porcentaje de ocupación fue sólo del 7 $\%$. 
...
\begin{landscape}
	...
	\noindent El Cuadro  muestra la tasa de letalidad y mortalidad de todas las provincias de la Región Cusco. Se presentan las provincias ordenadas de mayor a menor tasa de mortalidad encontrándose la mayor Tasa de Mortalidalidad ( 278.9) en la provincia de Canchis. 
...
La Figura \ref{fig:mortalidad_ordenada} muestra a las provincias de la Región ordenadas de mayor a menor Tasa de Mortalidad. Se evidencia que la provincia de Canchis tiene la Tasa de Mortalidad más alta con una tasa de 27.9 defunciones / 10 000* personas.  
...
De la misma forma, la Figura \ref{fig:incidencia_provincial} muestra la tendencia de la Incidencia acumulada a través del año, donde se evidencia que desde la SE 20 que la pendiente de crecimiento de la tasa de Incidencia acumulada ha disminuido. 
\begin{figure}[h]
...
Asímismo la Figura \ref{fig:mapa_variantes}  muestra el lugar de aislamiento de las Variantes encontradas en la Región. Se presenta el número de casos acumulados,  siendo la Variante Lamba la que preenta el mayor número de casos acumulados sobretodo provincia de Cusco y Canchis, seguida de la Variante es la Delta, con la mayoría de casos aislados en la Provincia Cusco
...
\noindent En la Figura \ref{fig:defunciones_cero} se muestra las provincias con Cero defunciones reportadas (casillas en amarillo) por cada semana epidemiológica. Se evidencia que para la SE 43, 10 de las 13 provincias de la Región Cusco no reportaron muertes en su territorio.
\begin{figure}[h]
			\caption{Defunciones reportadas por cada Provincia y Defunciones Cero en la Región Cusco, hasta la SE 43.}\label{fig:defunciones_cero}
			\begin{center}
				\includegraphics[width=0.95\linewidth]{../figuras/defunciones_cero}
			\end{center}
			{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID, SINADEF.}}
		\end{figure}
\pagebreak
