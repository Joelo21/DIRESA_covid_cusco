...
\noindent La disponibilidad y ocupación de camas UCI se ve resumida en la Figura \ref{fig:ocupacion_uci}, se evidencia que para la SE 46, el número de camas UCI decreció a 32 (siete camas menos respecto a las semanas anteriores), sin embargo el porcentaje de ocupación permanece constante. 
...
En la Figura \ref{fig:ocupacion_2nivel}, se observa el número de camas disponibles y su porcentaje de ocupación en el Nivel II. Se evidencia que el porcentaje de ocupación de camas tiene una tendencia al descenso, 
