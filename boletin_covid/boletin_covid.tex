...
\let\cleardoublepage\clearpage
	...
	\begin{figure}[h]
		...
		\begin{center}
			\includegraphics[width=0.65\linewidth]{../figuras/Graficos Boletin Mensual/figura1}
		\end{center}
	...
	\begin{figure}[h]
		...
		\begin{center}
			\includegraphics[width=0.65\linewidth]{../figuras/Graficos Boletin Mensual/figura2}
		\end{center}
		{\footnotesize {Fuente de datos: SISCOVID, NOTICOVID.}}
	\end{figure}
...
%---------------------------------------------------------------------------
	...
	\begin{figure}[h]
		...
		\begin{center}
			\includegraphics[width=0.65\linewidth]{../figuras/Graficos Boletin Mensual/figura3}
		\end{center}
		{\footnotesize {Fuente de datos: SISCOVID, NOTICOVID.}}
	\end{figure}
	...
	\begin{center}
		\includegraphics[width=0.65\linewidth]{../figuras/Graficos Boletin Mensual/figura4}
	\end{center}
	{\footnotesize {Fuente de datos: SISCOVID, NOTICOVID.}}
	\end{figure}
	...
	\begin{center}
		\includegraphics[width=0.65\linewidth]{../figuras/Graficos Boletin Mensual/figura5}
	\end{center}
	{\footnotesize {Fuente de datos: SISCOVID, NOTICOVID.}}
	\end{figure}
	...
	\begin{center}
		\includegraphics[width=0.65\linewidth]{../figuras/Graficos Boletin Mensual/figura5b}
...
%---------------------------------------------------------------------------
	...
	\begin{center}
		\includegraphics[width=0.65\linewidth]{../figuras/Graficos Boletin Mensual/figura6}
	\end{center}
	{\footnotesize {Fuente de datos: SISCOVID, NOTICOVID.}}
	\end{figure}
	...
	\begin{center}
		\includegraphics[width=0.65\linewidth]{../figuras/Graficos Boletin Mensual/figura7}
	\end{center}
	...
	\begin{center}
		\includegraphics[width=0.65\linewidth]{../figuras/Graficos Boletin Mensual/figura8}
	\end{center}
	{\footnotesize {Fuente de datos: REFERENCIAS Y CONTRAREFERENCIAS.}}
	\end{figure}
	...
	\begin{center}
		\includegraphics[width=0.65\linewidth]{../figuras/Graficos Boletin Mensual/figura9}
	\end{center}
	{\footnotesize {Fuente de datos: REFERENCIAS Y CONTRAREFERENCIAS.}}
	\end{figure}
...
\clearpage
	...
	\begin{center}
		\includegraphics[width=0.65\linewidth]{../figuras/Graficos Boletin Mensual/figura11a}
	\end{center}
	{\footnotesize {Fuente de datos: SISCOVID, NOTICOVID.}}
	\end{figure}
	...
	\begin{center}
		\includegraphics[width=0.65\linewidth]{../figuras/Graficos Boletin Mensual/figura11b}
	\end{center}
	{\footnotesize {Fuente de datos: SISCOVID, NOTICOVID.}}
	\end{figure}
	...
	\begin{center}
		\includegraphics[width=0.65\linewidth]{../figuras/Graficos Boletin Mensual/figura11c}
	\end{center}
	{\footnotesize {Fuente de datos: SISCOVID, NOTICOVID.}}
	\end{figure}
	...
	\begin{center}
		\includegraphics[width=0.65\linewidth]{../figuras/Graficos Boletin Mensual/figura11d}
	\end{center}
...
\clearpage
	...
	\begin{center}
		\includegraphics[width=0.65\linewidth]{../figuras/Graficos Boletin Mensual/figura12}
	\end{center}
...
%---------------------------------------------------------------------------
	...
	\begin{figure}[h]
		...
		\begin{center}
			\includegraphics[width=0.65\linewidth]{../figuras/Graficos Boletin Mensual/figura16}
		\end{center}
		{\footnotesize {Fuente de datos: SISCOVID, NOTICOVID.}}
	\end{figure}
	...
	\begin{figure}[h]
		...
		\begin{center}
			\includegraphics[width=0.65\linewidth]{../figuras/Graficos Boletin Mensual/figura17}
		\end{center}
		{\footnotesize {Fuente de datos: SINADEF.}}
	\end{figure}
	...
	\begin{figure}[h]
		...
		\begin{center}
			\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_m1}
		\end{center}
		{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID, SINADEF.}}
	\end{figure}
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_p1}
	\end{center}
	...
	\noindent Las figuras de abajo (Figura \ref{fig:inc_mort_anta}, \ref{fig:positividad_anta})  muestran una disminución importante desde la SE13 en la tasa de mortalidad, que aunque aumentó desde la SE33, llegó a ser bastante baja en la SE38. Similarmente, la tasa de incidencia tiene una caída más sostenida. Hay un pequeño aumento en la tasa de positividad de pruebas moleculares similar a la de pruebas antigénicas estas últimas semanas. En la Figura \ref{fig:exceso_anta} se muestra que no hay exceso de defunciones respecto al año 2019.
		...
		\begin{center}
			\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_m2}
		\end{center}
		{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID, SINADEF.}}
	\end{figure}
	...
	\begin{figure}[h]
		...
		\begin{center}
			\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_p2}
		\end{center}
		{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID.}}
	\end{figure}
	...
	\begin{figure}[h]
		...
		\begin{center}
			\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_m3}
		\end{center}
		{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID, SINADEF.}}
	\end{figure}
	...
	\begin{figure}[h]
		...
		\begin{center}
			\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_p3}
		\end{center}
		{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID.}}
	\end{figure}
...
\clearpage
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_m4}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID, SINADEF.}}
	\end{figure}
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_p4}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID.}}
	\end{figure}
...
\clearpage
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_m5}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID, SINADEF.}}
	\end{figure}
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_p5}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID.}}
	\end{figure}
...
\clearpage
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_m6}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID, SINADEF.}}
	\end{figure}
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_p6}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID.}}
	\end{figure}
...
\clearpage
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_m7}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID, SINADEF.}}
	\end{figure}
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_p7}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID.}}
	\end{figure}
...
\clearpage
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_m8}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID, SINADEF.}}
	\end{figure}
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_p8}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID.}}
	\end{figure}
...
\clearpage
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_m9}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID, SINADEF.}}
	\end{figure}
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_p9}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID.}}
	\end{figure}
...
\clearpage
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_m10}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID, SINADEF.}}
	\end{figure}
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_p10}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID.}}
	\end{figure}
...
\clearpage
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_m11}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID, SINADEF.}}
	\end{figure}
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_p11}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID.}}
	\end{figure}
...
\clearpage
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_m12}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID, SINADEF.}}
	\end{figure}
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_p12}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID.}}
	\end{figure}
...
\clearpage
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_m13}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID, SINADEF.}}
	\end{figure}
	...
	\begin{center}
		\includegraphics[width=0.7\linewidth]{../figuras/Graficos Boletin Mensual/provincia_p13}
	\end{center}
	{\footnotesize {Fuente de datos: NOTICOVID, SISCOVID.}}
	\end{figure}
