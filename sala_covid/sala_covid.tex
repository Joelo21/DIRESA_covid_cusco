...
\begin{frame}
		...
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 20 de noviembre del 2021. \\}
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,248 $ defunciones por COVID-19 por millón de habitantes. \\
	\end{frame}
...
Nota 2: Baja $3.0\% $ , 6 fallecidos menos.\\
\textbf{Riesgos}: Piura: tres alzas en cinco últimas semanas. Superó máximo de 13 semanas. Dos semanas con tasa de fallecidos diarios >2 x millón.\\
Cuatro regiones más con tasas >2. La Libertad crece tres semanas.\\
31 días sin nuevo mínimo diario (SE41)\\
\textbf{Estancamiento}: Estancamiento: 13 regiones estancadas(±1), Sólo dos regiones suben >1 semana.\\} 
\vspace{0.01cm}
$\rightarrow$ {\color{mycolor5}Cusco}: Las defunciones representan un $-50.0\% $ del pico de la segunda ola. \\
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, ultra thick] (5.75,3.60) circle [x radius=3.4cm, y radius=.18cm, rotate=0];
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2021-11-17.\\}
	\vspace{0.01cm}
	...
	$\nearrow$ Cusco sube a la posición 14 con un RT de $1.03$ $ [0.99-1.07]$.
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 20 de noviembre del 2021. \\
	Nota 1: Perú: 1029 camas libres, subió $1.5\%$. Lima: 286 camas libres, baja $ 1.4\% $. \\
	Suben:{*} Lima región (2.9\%), Lima metropolitana (1.2\%), Callao (2.1\%) e Ica (2.5\%) en la costa central.\\
	Huánuco (0.5\%), Junín (2.2\%), Huancavelica (0.6\%) y Ayacucho (9.4\%) en la sierra central/sur.\\
	Tacna (2.9\%).\\
	Todas estas regiones crecen 3-5 semanas excepto Callao (2)** y Huancavelica (1)** \\
	Semana previa: 17 regiones.\\
	Muy > que media: Tumbes (93\%), Piura y Áncash (62-63\%), Lima metropolitana, Callao y {\color{mycolor2}Cusco} (54-58\%), La Libertad y Ayacucho (47-49\%).\\}
	\vspace{0.01cm}
	$\nearrow$ Todas subieron menos Piura, Áncash y {\color{mycolor2}Cusco}.
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.1,2.4) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 20 de noviembre del 2021.\\}
	\vspace{0.1cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.5,2.87) circle [x radius=2.0cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 20 de noviembre del 2021. \\} 
		\vspace{0.01cm}
...
\begin{frame}
	...
	\end{center}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2021-11-17. Reporte de número reproductivo efectivo (Rt) de COVID-19. Disponible haciendo clic en el siguiente enlace: \href{https://www.dge.gob.pe/portalnuevo/informacion-publica/reporte-de-numero-reproductivo-efectivo-rt/}{CDC-Rt}. \\}
	\vspace{0.01cm}
...
\begin{frame}[label=resumen]
	...
	\begin{itemize}
		...
		\item Se ha mantenido constante la \textbf{\color{mycolor4}desaceleración} en el número de \textbf{\color{mycolor3}casos sintomáticos} y defunciones por COVID-19, con \textbf{\color{mycolor4}"cero defunciones"} para la SE45.
		\item La \textbf{\color{mycolor3}incidencia de casos por el total de pruebas realizadas} presenta un incremento de casos a nivel de la provincia de Cusco, Anta y Calca. Traduciendo un \textbf{\color{mycolor3}incremento de casos asintomáticos}.
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en mayor \textbf{\color{mycolor4}descenso} con un $4.1\%$, manteniéndose en este rango durante las últimas trece semanas. Mientras que, la \textbf{\color{mycolor3}tasa de positividad} para pruebas moleculares aumentó a $19.7\%$ para la SE45.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} aún es \textbf{\color{mycolor4} alta}, a pesar de haber disminuido a un $74\% $ y mantenerse como tal durante las últimas 4 semanas. 
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, se ha mantenido en descenso con un $13\%$, manteniéndose así también las últimas 4 semanas \textbf{\color{mycolor4}} 
	\item Para la SE 45, las variantes secuenciadas de COVID-19, muestran un incremento de la variante delta a un $100\%$, siendo las características de presentación clínica similares con las otras variantes.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Todas las provincias presentan desaceleración de casos y defunciones para la SE 45. El exceso regional de mortalidad general es de -8.
