...
\end{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 05 de Marzo del 2022. \\
	\textbf Nota 1: Perú: 1071 camas libres, subió 2.5\% -  Lima: 404 camas libres, baja 0.7\%
	\\
	\textbf Suben*: \\
	Selva Norte: Amazonas y Cajamarca. \\
	Siera Centro: Arequipa, Apurímac y Ancash.\\
	\textbf Que media: Tumbes (86.0\%), Ancash (77.6\%), Arequipa (62.7\%), Arequipa (61.4\%), Cusco (59.1\%), Huánuco (56.1\%), Piura (55.7\%), Ayacucho (55.1\%), La Libertad (51.4\%), Moquegua (50.9\%), Loreto (50.5\%), Lambayeque (49.7\%), Lima región (43.1\%) y Puno (42.9\%).\\ 
