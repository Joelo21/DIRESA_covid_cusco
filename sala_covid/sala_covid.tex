...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 08 de Enero del 2022}}
...
\date{Semana Epidemiológica 01, 2022}
...
\begin{document}
	...
	\vspace{0.01cm}
	$\rightarrow$ 20\% Ómicron en Lima en la SE52, 2/10 muestras.\\
	$\rightarrow$ Callao no reporta muestras para la SE52.\\
	$\rightarrow$ Delta: 67/93=72\% de las muestras del país en la SE52.\\
...
\end{center}
\begin{tikzpicture}[overlay]
	\draw[mycolor2, ultra thick] (5.2,3.35) circle [x radius=3.8cm, y radius=.2cm, rotate=0];
\end{tikzpicture}
{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 08 de enero del 2022.\\
%Nota 1: Sube Piura. \\
%Nota 2: Mayor valor en 21 semanas.\\	
\textbf{Riesgos}:\\
				El “muro” de omicrón, alza vertical en múltiples regiones del país.\\
				Fallecidos máximos Lambayeque y Lima metropolitana en 26/24 semanas.\\
				Percepción que omicrón es leve.\\
				Más fallecidos en adultos.\\
				Pocas UCI disponibles en toda la costa norte-centro.\\		
				Incremento de hospitalizaciones.\\	
\textbf{Estancamiento}:Sólo tres regiones con fuerte alza.\\
					  No hemos observado alza exponencial (aún).\\}
\vspace{0.01cm}
$\rightarrow$ {\color{mycolor5}Cusco}: Las defunciones representan un $2.52\% $ del pico de la segunda ola.\\
\end{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 08 de enero del 2022. \\
	\textbf Nota 1: Perú: 11071 camas libres, subió 1.4\%, Lima: 1071 camas libres, subió 1.4\% \\
	\textbf Suben:* Piura, Cajamarca, San Martín y La Libertad: norte. Lima región y Callao: costa central Arequipa, Moquegua y Tacna: costa sur, Loreto y Ucayali: selva baja Huancavelica, Ayacucho, Cusco y Puno: sierra centro-sur.\\
	Siete regiones suben 2-5 semanas.\\
	Cajamarca y Ucayali suben 13.3\% y 10.8\% en cinco semanas, San Martín sube 11.5\% en cuatro semanas, La Libertad, Huancavelica, Ayacucho y Puno suben 8.0-19.0\% en dos semanas.\\
	\textbf Que media: Tumbes (89.4\%), Piura (70.1\%), Ancash (68.1\%), Lambayeque (64.9\%), Ayacucho (64.7\%), La Libertad (58.4\%), Lima región (53.9\%), Lima metropolitana (50.1\%), Callao (49.2\%), Cusco (46.7\%), y Arequipa (45.6\%). Siete suben.\\} 
	\vspace{0.01cm}
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.1,2.70) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 08 de enero del 2022.\\}
	\vspace{0.1cm}
	$\searrow$ Cusco baja a la posición 19.
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.5,2.40) circle [x radius=2.0cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 08 de enero del 2022. \\} 
		\vspace{0.01cm}
		$\nearrow$ Cusco pasa al puesto 22.
