...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 19 de Noviembre del 2022}}
...
\date{Semana Epidemiológica 46, 2022}
...
\begin{frame}
	...
	\end{center}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2022. Actualización: 2022-11-22. Reporte de número reproductivo efectivo (Rt) de COVID-19. Disponible haciendo clic en el siguiente enlace: \href{https://www.dge.gob.pe/portalnuevo/informacion-publica/reporte-de-numero-reproductivo-efectivo-rt/}{CDC-Rt}. \\}
	\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}
		\frametitle{Total y Ocupación de Camas Hospitalarias, Hospital Nacional Adolfo Guevara Velasco, 2021-20222. Datos Actualizados hasta la sem 43.}
		\vspace{-.2cm}
		\begin{center}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF - NOTICOVID. \\}
		\vspace{0.2cm}
		$\rightarrow$ Para la SE 46, la provincia del \textbf{\color{mycolor3}Cusco} registró \textbf{\color{mycolor3}cero} defunciónes por COVID-19.\\
		$\rightarrow$ Las demás provincias registraron \textbf{\color{mycolor3}cero} defunciónes por COVID-19.\\
...
\begin{frame}[label=Resumen]
	...
	\begin{itemize}
		...
		\item A la presente SE 46, se mantiene un \textbf{\color{mycolor4} incremento} en el número de \textbf{\color{mycolor3}casos}, mientras las hospitalizaciones y defunciones se encuentran aún bajas.
		\item La \textbf{\color{mycolor3}tasa de positividad para pruebas moleculares} \textbf{\color{mycolor4}ascendió} a $15.2\%$ y la \textbf{\color{mycolor3}tasa de positividad de pruebas antigénicas} ascendió a 9.2$\%$. AScensos que superan el 5$\%$ en la última semana	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor3} descendió al $0\%$ a nivel regional}.
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}ascendió al $14\%$} (hasta la SE46). 
	\item Para la SE 44, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Tasa de crecimiento semanal de \textbf{\color{mycolor4}casos} sintomáticos y no sintomáticos en \textbf{\color{mycolor3}ámbar}.
		...
		\begin{itemize}
			\item Para la SE46, la provincia de Cusco y la Convención se encuentran con un incremento de casos del $40\%$, el resto aún presenta escasos casos. Las defunciones y hospitalizaciones aun se encuentran bajas.
		\end{itemize}
	\end{itemize}
\end{frame}
