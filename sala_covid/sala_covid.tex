...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 20 de Agosto del 2022}}
...
\date{Semana Epidemiológica 33, 2022}
...
%\end{frame}
	...
	%	\end{tikzpicture}
		{\tiny Fuente:REUNIS (Repositorio Único Nacional de Información en Salud). Consultado el 20 de Agosto del 2022.\\} 
		\vspace{0.01cm}
	...
	\begin{frame}
			...
			\end{tikzpicture}
			{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 20 de Agosto del 2022.\\}
	\vspace{0.01cm}
	...
	\begin{frame}
		...
		\end{tikzpicture}
		{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2022. Actualización: 2022-08-20.\\}
		\vspace{0.01cm}
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			...
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 33	}}                                                   \\ \hline
	...
	-		\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_nouci.png}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 33}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						5               & 3                    & 2                  & 60\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 33}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						2                & 2                    & 0                  & 100\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 33 }}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 2                     & 4                   & 33\%                        \\ \hline
					\end{tabular}%
				}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.2cm}
		$\rightarrow$ Para la SE 33, la provincia del \textbf{\color{mycolor5}Cusco} registró \textbf{\color{mycolor5}dos} defunciones por COVID-19.\\
		$\rightarrow$ La provincia de Canas y Quispicanchis registrarón \textbf{\color{mycolor5}una} defunción y la provincia de La Convención registró \textbf{\color{mycolor5}dos} defunciónes por COVID-19.\\
...
\begin{frame}[label=Resumen]
	...
	\vspace{-.5cm}
	\begin{itemize}
		\item La Región de Cusco se ubica en el \textbf{\color{mycolor4}octavo lugar} de \textbf{\color{mycolor3}mortalidad} acumulada a nivel nacional, con un índice de propagación de $0.84 $.   
		\item Continúa la \textbf{\color{mycolor4} desaceleración} en el número de \textbf{\color{mycolor3}casos} y hospitalizaciones no UCI. 
		\item La \textbf{\color{mycolor3}tasa de positividad para pruebas moleculares} \textbf{\color{mycolor4}ascendió} a un $35.1\%$, mientras que la \textbf{\color{mycolor3}tasa de positividad de pruebas antigénicas} descendió a un $20.8\%$.
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor3} ascendió al $47\%$ a nivel regional}.
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}descendió al $60\%$}. 
	\item Para la SE 32, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana, siendo notorio el incremento de la variante BA.5, que tiene una mayor transmisibilidad, pero no mortalidad, pudiendo presentarse en poblaciones vacunadas debido a su capacidad de escape inmunológico.
