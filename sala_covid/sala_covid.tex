...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 11 de diciembre del 2021}}
...
\date{Semana Epidemiológica 49, 2021}
...
%	\end{tikzpicture}
	{\tiny Fuente: Juan Carbajal ($@$juank23\_7). Consultado el 11 de diciembre del 2021. \\} 
	\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, ultra thick] (5.75,3.48) circle [x radius=3.4cm, y radius=.18cm, rotate=0];
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2021-12-11.\\}
	\vspace{0.01cm}
	...
	$\nearrow$ Cusco sube a la posición 15 con un RT de $1.08$ $ [1.04-1.12]$.
...
\begin{frame}
	...
	\end{center}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2021-12-11. Reporte de número reproductivo efectivo (Rt) de COVID-19. Disponible haciendo clic en el siguiente enlace: \href{https://www.dge.gob.pe/portalnuevo/informacion-publica/reporte-de-numero-reproductivo-efectivo-rt/}{CDC-Rt}. \\}
	\vspace{0.01cm}
