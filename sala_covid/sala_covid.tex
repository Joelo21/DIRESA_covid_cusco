...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 06 de Agosto del 2022}}
...
\date{Semana Epidemiológica 30, 2022}
...
%\end{frame}
	...
	%	\end{tikzpicture}
		{\tiny Fuente:REUNIS (Repositorio Único Nacional de Información en Salud). Consultado el 06 de Agosto del 2022.\\} 
		\vspace{0.01cm}
	...
	\begin{frame}
			...
			\end{tikzpicture}
			{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 06 de Agosto del 2022.\\}
	\vspace{0.01cm}
	$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,469 $ defunciones por COVID-19 por millón de habitantes. \\
	\end{frame}
	...
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 06 de Agosto del 2022.\\
	\textbf{Riesgos}:\\
				Lima metropolitana sube por cuarta semana seguida, alza de 29.8\%.\\
				Costa Centro y Sierra/Selva suben de 7-20\%.\\
				Todas la DIRIS en Lima suben menos Este.\\
				Parte de Costa y Siera Sur sube.\\
				Mayores tasas de fallecidos en (1.24-2.22).\\	
	\textbf{Menor Riesgo}: \\
				A nivel nacional se estancan los fallecidos.\\	
				DIRIS Lima Este disminuye.\\	
				}
	\vspace{0.01cm}
	$\rightarrow$ {\color{mycolor5}Cusco}: Las defunciones representan un $5.66\% $ del pico de la segunda ola.\\
	\end{frame}
	...
	\begin{frame}
		...
		\end{tikzpicture}
		{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2022. Actualización: 2022-08-06.\\}
		\vspace{0.01cm}
  ...
  \begin{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 06 de Agosto del 2022. \\
		\textbf Perú: 873 camas libres, sube 2.2\% -  Lima: 329 camas libres, sube 2.8\%. \\
		\textbf >Suben*: \\
		Costa: Piura Lima metropolitana y región, Callao y Moquegua.\\
		Sierra/Selva Norte: San Martin, Cajamarca, y Loreto.\\
		Sierra Sur: Cusco, Puno. - Sierra Centro: Junín.\\
		\textbf Cinco regiones suben 2-3 semanas.\\
		Callao sube 6.27\% en 2 sem. - Junín sube 3.71\% en 2 sem.\\
		Lima metropolitana sube 4.95\% en 3 sem. - Loreto sube 12.50\% en 2 sem.\\
		Puno sube 8.61\% en 3 sem.\\ 
		\textbf >Que media:\\
		Arequipa (43.9\%), Ancash (42.3\%), La Libertad (38.0\%), Ayacucho (34.6\%), Tumbes (33.3\%), Huánuco (27.7\%), Apurímac (25.5\%), Cusco (22.9\%), Callao (18.6\%) y Lima metropolitana (17.4\%). \\
		} 
		\vspace{0.01cm}
		$\nearrow$ Tres de estas 10 regiones suben
\end{frame}
...
\begin{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.6,2.72) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 06 de Agosto del 2022.\\}
	\vspace{0.1cm}
	$\searrow$ Cusco se mantiene en la posición 20.
\end{frame}
...
\begin{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (3.8,2.75) circle [x radius=2.8cm, y radius=.15cm, rotate=0];
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 06 de Agosto del 2022. \\} 
	\vspace{0.01cm}
	$\nearrow$ Cusco baja a la posición 20.	
...
\begin{frame}[label=cobertura_vacuna]
	...
	\vspace{-.5cm}
	\begin{center}
		\includegraphics[width=0.9\linewidth, trim={.2cm .5cm .2cm .2cm},clip]{../figuras/vacunacion_grupo_edad_dosis.png}
	\end{center}
	{\tiny Fuente de datos: SICOVAC - HIS MINSA, Dirección de Estadística GERESA Cusco.} 
\end{frame}
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			...
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 31	}}                                                   \\ \hline
	...
	-		\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_nouci.png}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 31}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						5               & 3                    & 2                  & 60\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 31}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						2                & 1                    & 1                  & 50\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 31 }}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 4                     & 2                   & 67\%                        \\ \hline
					\end{tabular}%
				}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.2cm}
		$\rightarrow$ Para la SE 31, la provincia del \textbf{\color{mycolor5}Cusco} registró \textbf{\color{mycolor5}cero} defunciones por COVID-19.\\
		$\rightarrow$ La provincia de Anta registró \textbf{\color{mycolor5}una} defunción y la provincia de La Convención registró \textbf{\color{mycolor5}dos} defunciones por COVID-19.\\
		$\rightarrow$ Las demás provincias de la región del Cusco registraron \textbf{\color{mycolor5}cero} defunciones por COVID-19.
	\end{frame}
...
\begin{frame}[label=Resumen]
	...
	\begin{itemize}
		...
		\item Se presenta \textbf{\color{mycolor4} desaceleración} en el número de \textbf{\color{mycolor3}casos} y hospitalizaciones. 
		\item La \textbf{\color{mycolor3}tasa de positividad para pruebas moleculares} \textbf{\color{mycolor4}ascendió} a un $26.4\%$ y la \textbf{\color{mycolor3}tasa de positividad de pruebas antigénicas} ascendió a un $28\%$.
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor3} al $37\%$ a nivel regional}.
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}se mantuvo estable con el $66\%$}. 
	\item Para la SE 31, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana, siendo notorio el incremento de la variante BA.5, que tiene una mayor transmisibilidad, pero no mortalidad, pudiendo presentarse en poblaciones vacunadas debido a su capacidad de escape inmunológico.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE30, se presenta desaceleración en el número de casos y hospitalizaciones a nivel de todas las provincias.
		\end{itemize}
	\end{itemize}
\end{frame}
