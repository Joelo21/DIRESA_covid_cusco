...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 10, las provincias de  Anta, Calca, Canchis, La Convención y Paucartambo registraron \textbf{\color{mycolor5}defunciones} por COVID-19.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE10, todas las provincias permanecen en  descenso marcado de casos y fallecidos por cuarta semana consecutiva.
