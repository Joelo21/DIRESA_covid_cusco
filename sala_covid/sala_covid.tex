...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 09 de Julio del 2022}}
...
\date{Semana Epidemiológica 27, 2022}
...
%	\end{tikzpicture}
	{\tiny Fuente:REUNIS (Repositorio Único Nacional de Información en Salud). Consultado el 09 de Julio del 2022.\\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 09 de Julio del 2022.\\}
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,455 $ defunciones por COVID-19 por millón de habitantes. \\
\end{frame}
...
\textbf{Riesgos}:\\
			Sube 34.1\% esta semana, alza solo en resto del país.\\
			Máximo de fallecidos en 12 semanas.\\
			Costa Centro sube 12 fallecidos.\\
			Sube DIRIS Norte 3 fallecidos.\\
			Suben fallecidos >60 años.\\
			Ica con >1 fallecido x millón esta semana.\\
\textbf{Menor Riesgo}: \\
			Las macro-regiones Costa Norte, Costa Sur, Sierra/Selva Baja y Sierra/Selva Norte se estancan o disminuyen.\\	
			}
\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, ultra thick] (5.35,2.92) circle [x radius=3.4cm, y radius=.18cm, rotate=0];
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2022. Actualización: 2022-07-09.\\}
	\vspace{0.01cm}
	...
	$\nearrow$ Cusco se encuentra a la posición 09 con un RT de $1.20$ $ [1.15-1.25]$.
	\end{frame}
  ...
  \begin{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 09 de Julio del 2022. \\
	\textbf Perú: 892 camas libres, sube 1.2\% -  Lima: 333 camas libres, sube 1.2\%. \\
	\textbf Suben*: \\
	Costa: Tumbes, La Libertad, Lima región, Callao, Arequipa y Moquegua.\\
	Sierra: Cajamarca, Junín, Apurímac, Cusco y Puno.\\
	Selva: Amazonas.\\
	\textbf Cuatro regiones suben > 1 semana. \\
	Apurímac sube 5.71\% en 3 sem - Cusco sube 13.36\% en 2 sem.\\
	Puno sube 5.70\% en 2 sem - Tumbes sube 33.33\% en 2 sem.\\
	\textbf >Que media: \\
	La Libertad (43.5\%), Arequipa (42.1\%), Ancash (34.5\%), Tumbes (33.3\%), Cusco (17.1\%), Lima metropolitana (12.9\%) y Callao (11.8\%).\\
	Cinco de estas siete regiones suben esta semana.\\
	El número de camas ocupadas sube tres semanas a nivel nacional, crece en La Libertad, Ancash y Callao en la costa centro-norte, y Arequipa y Cusco en la sierra sur.\\	
} 
	\vspace{0.01cm}
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.6,2.25) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 09 de Julio del 2022.\\}
	\vspace{0.1cm}
	$\searrow$ Cusco se mantiene en la posición 13.
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.8,2.25) circle [x radius=2.8cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 09 de Julio del 2022. \\} 
		\vspace{0.01cm}
		$\nearrow$ Cusco baja a la posición 23.	
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			...
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 27}}                                                   \\ \hline
	...
	-		\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_nouci.png}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 27}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						5               & 4                    & 1                  & 80\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 27}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						2                & 1                    & 1                  & 50\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 27 }}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 0                     & 6                   & 0\%                        \\ \hline
					\end{tabular}%
				}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 27, la provincia del \textbf{\color{mycolor5}Cusco} registro \textbf{\color{mycolor5}una} defunción por COVID-19.\\
		$\rightarrow$ La provincia de La Convención registro \textbf{\color{mycolor5}una} defunción y la provincia de Urubamba registró \textbf{\color{mycolor5}dos} defunciones por COVID-19.\\
...
\begin{frame}[label=Resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad para pruebas moleculares} \textbf{\color{mycolor4}se mantuvo estable} con un $19.1\%$, y la \textbf{\color{mycolor3}tasa de positividad de pruebas antigénicas} con un $17.3\%$.
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}aumentó} al $64\%$ a nivel regional.
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}disminuyó al $49\%$}. 
	\item Para la SE 28, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana, habiéndose registrado subvariantes, siendo la última detectada la BA.5, que tiene una mayor transmisibilidad. Los datos mundiales refieren que esta subvariante no presenta mayor mortalidad y puede presentarse en poblaciones vacunadas debido a su capacidad de presentación en personas que eran inmunes a otras formas de ómicron.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Tasa de \textbf{\color{mycolor4}positividad} de pruebas \textbf{\color{mycolor4}antigénicas en verde y moleculares} en \textbf{\color{mycolor3}ámbar}.
			\item Disponibilidad de \textbf{\color{mycolor4}camas hospitalarias}: no UCI: cambió a \textbf{\color{mycolor3}ámbar}.
		...
		\begin{itemize}
			\item El ascenso de casos se ve favorecido en la provincia de Cusco, no así en el resto de provincias, las defunciones aún se mantienen bajas a nivel regional
			\item Para la SE27, se mantiene el ascenso en el número de casos, con un ascenso en el número de hospitalizaciones (ascenso que se produjo en la SE 24 y que aún se mantiene). defunciones.
		\end{itemize}
	\end{itemize}
\end{frame}
