...
\begin{frame}[label=resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en \textbf{\color{mycolor4}descenso} con un $3\%$, manteniéndose en este rango durante las últimas dieciséis semanas. Al igual que, la \textbf{\color{mycolor3}tasa de positividad} para pruebas moleculares se mantiene en descenso en $9\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} es \textbf{\color{mycolor4} alta}, habiéndose mantenido en el rango de $69-75\% $ y mantenerse como tal durante las últimas 7 semanas. 
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, se ha mantenido entre $13-16\%$.
	\item Para la SE 48, continua la predominancia de la variante delta con un $100\%$, del total de elegibles secuenciados por semana, siendo las características de presentación clínica similares con las otras variantes.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Todas las provincias presentan desaceleración de casos y defunciones. El exceso regional de mortalidad general es de -1.
