...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 06, las provincias de Calca, Canchis, Chumbivilcas y La Convención reportaron defunciones por COVID-19.
					
		$\rightarrow$ La provincia de Acomayo, Anta, Canas, Espinar, Paruro, Paucartambo, Quispicanchis y Urubamba registran \textbf{\color{mycolor5}cero} defunciones en la última semana epidemiológica.	
...
\begin{frame}[label=resumen]
	...
	\begin{itemize}
		...
		\item Existe un \textbf{\color{mycolor4}descenso} en el número de \textbf{\color{mycolor3}casos} COVID-19, con desaceleración en el número de hospitalizados y defunciones.
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en  \textbf{\color{mycolor4}descenso} con un $19.9\%$, así como la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares también se mantienen en descenso con un $19.9\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}aumentó} a $91\% $ a nivel regional, es decir aumento \textbf{\color{mycolor3}1.75 veces} desde el inicio de la tercera ola, aunque su aceleración no es sostenida
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, descendió a $36\%$, sin embargo aún se mantiene \textbf{\color{mycolor3}3 veces} más desde el inicio de la tercera ola
	\item Para la SE 06, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana, siendo las características de presentación clínica similares con las otras variantes, con casos leves en la presentación clínica.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Tasa de \textbf{\color{mycolor4}positividad} de pruebas \textbf{\color{mycolor4}antigénicas y moleculares}en \textbf{\color{mycolor3}ámbar}
		...
		\begin{itemize}
			\item Para la SE06, todas las provincias presentan descenso en el crecimiento de casos
