...
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,452 $ defunciones por COVID-19 por millón de habitantes. \\
\end{frame}
...
\textbf{Riesgos}:\\
			Sube 87\% esta semana, alza en Lima metropolitana y resto del país.\\
			Máximo de fallecidos en 11 semanas.\\
			Lima metropolitana, Arequipa y Piura suben 5-7 fallecidos.\\
			Sube toda la costa y la sierra/selva sur, y la DIRIS Lima Centro.\\
			Suben fallecidos en personas >25 años excepto 60-69 años.\\
			Incremento de fallecidos >80años.\\
\textbf{Menor Riesgo}: \\
			Las macro-regiones Selva Baja, Sierra/Selva Centro y Norte se estancan o disminuyen levemente.\\	
			}
\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, ultra thick] (5.35,4.27) circle [x radius=3.4cm, y radius=.18cm, rotate=0];
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2022. Actualización: 2022-07-02.\\}
	\vspace{0.01cm}
	...
	$\nearrow$ Cusco se encuentra a la posición 09 con un RT de $1.55$ $ [1.50-1.60]$.
	\end{frame}
  ...
  \begin{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 09 de Julio del 2022. \\
	\textbf Perú: 903 camas libres, sube 4.0\% -  Lima: 329 camas libres, sube 5.7\%. \\
	\textbf Suben*: \\
	Costa: Tumbes y Lima metropolitana.\\
	Sierra: Pasco, Apurímac, Cusco y Puno.\\
	\textbf Dos regiones suben>1 semana: \\
	Apurímac sube 18.83\% en 2 sem.\\
	Lima metropolitana sube 2.75\% en 2 sem.\\
	\textbf >Que media: \\
	La Libertad (40.1\%), Ancash (35.4\%), Arequipa (34.2\%), Tumbes (17.7\%), Lima metropolitana (13.8\%), Callao (11.2\%) y Ica (11.1\%).\\
	Solo dos de estas siete regiones suben esta semana.\\
	El número de camas ocupadas sube dos semanas a nivel nacional y en Lima metropolitana.\\	
} 
	\vspace{0.01cm}
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.6,3.78) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 09 de Julio del 2022.\\}
	\vspace{0.1cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.8,2.42) circle [x radius=2.8cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 09 de Julio del 2022. \\} 
		\vspace{0.01cm}
		$\nearrow$ Cusco baja a la posición 22.	
...
\begin{frame}[label=Resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad para pruebas moleculares} \textbf{\color{mycolor4}aumentó} a $19.5\%$, y la \textbf{\color{mycolor3}tasa de positividad de pruebas antigénicas} a $17.1\%$.
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item El ascenso de casos se ve favorecido en la provincia de Cusco, no así en el resto de provincias, las defunciones aún bajas a nivel regional
			\item Para la SE25, se mantiene el ascenso en el número de casos, con un ascenso en el número de hospitalizaciones en la zona de no UCI (ascenso que se produjo en la SE 24 y que se mantiene).Aún se mantienen bajas las defunciones.
		\end{itemize}
	\end{itemize}
\end{frame}
