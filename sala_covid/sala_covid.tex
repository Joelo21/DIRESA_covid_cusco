...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 20 de noviembre del 2021}}
...
\date{Semana Epidemiológica 46, 2021}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, ultra thick] (5.75,2.66) circle [x radius=3.4cm, y radius=.18cm, rotate=0];
		\end{tikzpicture}
	...
	$\nearrow$ Cusco sube a la posición 21 con un RT de $0.98$ $ [0.94-1.02]$.
...
\begin{frame}
	...
	\end{center}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2021-11-21. Reporte de número reproductivo efectivo (Rt) de COVID-19. Disponible haciendo clic en el siguiente enlace: \href{https://www.dge.gob.pe/portalnuevo/informacion-publica/reporte-de-numero-reproductivo-efectivo-rt/}{CDC-Rt}. \\}
	\vspace{0.01cm}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		$\rightarrow$ Para la SE 46, la mayoría de las provincias de la región del \textbf{\color{mycolor5}Cusco} reportaron \textbf{\color{mycolor5}cero} defunciónes por COVID-19, excepto Chumbivilcas, \textbf{\color{mycolor5}Cusco} y Quispicanchis.
		
		$\rightarrow$ La provincia de Acomayo registra \textbf{\color{mycolor5}cero} defunciones en las ultimas 9 semanas epidemiológicas
