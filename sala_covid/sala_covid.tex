...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 12 de Noviembre del 2022}}
...
\date{Semana Epidemiológica 45, 2022}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF - NOTICOVID. \\}
		\vspace{0.2cm}
		$\rightarrow$ Para la SE 45, la provincia del \textbf{\color{mycolor3}Cusco} registró \textbf{\color{mycolor3}cero} defunciónes por COVID-19.\\
