...
\begin{frame}[label=Resumen]
	...
	\begin{itemize}
		...
		\item A la presente SE 47, se mantiene un \textbf{\color{mycolor4} incremento} en el número de \textbf{\color{mycolor3}casos}, mientras las hospitalizaciones y defunciones se encuentran aún bajas.
