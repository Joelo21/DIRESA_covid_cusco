...
\end{frame}
	...
	\begin{frame}
		...
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2022. Actualización: 2022-06-04.\\}
	\vspace{0.01cm}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 22, la provincia del \textbf{\color{mycolor5}Cusco} registraron \textbf{\color{mycolor5}dos} defunciones por COVID-19.\\
