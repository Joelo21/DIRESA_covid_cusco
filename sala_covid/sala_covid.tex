...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}aumentó} al $65\%$ a nivel regional.
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}disminuyó al $42\%$}. 
	\item Para la SE 28, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana, habiéndose registrado subvariantes, siendo notorio el incremento de la variante BA.4 y BA.5, que tienen una mayor transmisibilidad. Los datos mundiales refieren que estas subvariantes no presenta mayor mortalidad y puede presentarse en poblaciones vacunadas debido a su capacidad de presentación en personas que eran inmunes a otras formas de ómicron.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Para la SE28, se mantiene el ascenso en el número de casos, con un ascenso en el número de hospitalizaciones, no presentándose incremento en las defunciones.
		\end{itemize}
	\end{itemize}
\end{frame}
