...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		$\rightarrow$ Notablemente, las provincias de la región del \textbf{\color{mycolor5}Cusco} reportaron \textbf{\color{mycolor5}cero} defunciónes, excepto Chumbivilcas, \textbf{\color{mycolor5}Cusco} y Quispicanchis por COVID-19 en la ultima semana (SE46) epidemiológica.
		
		$\rightarrow$ La provincia de Acomayo registra \textbf{\color{mycolor5}cero} defunciones en las ultimas 9 semanas epidemiológica
...
\begin{frame}[label=resumen]
	...
	\vspace{-.5cm}
	\begin{itemize}
		\item La Región de Cusco se ubica en el \textbf{\color{mycolor4}octavo lugar} de \textbf{\color{mycolor3}mortalidad} acumulada a nivel nacional, con una índice de propagación de $0.99 $.
		\item Se ha mantenido constante la \textbf{\color{mycolor4}desaceleración} en el número de \textbf{\color{mycolor3}casos sintomáticos} y defunciones por COVID-19, con \textbf{\color{mycolor4}"tres defunciones"} para la SE46.
		...
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en mayor \textbf{\color{mycolor4}descenso} con un $4.2\%$, manteniéndose en este rango durante las últimas trece semanas. Mientras que, la \textbf{\color{mycolor3}tasa de positividad} para pruebas moleculares aumentó a $11.4\%$ para la SE46.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} es \textbf{\color{mycolor4} media}, a pesar de haber disminuido a un $54\% $ y mantenerse como tal durante las últimas 4 semanas. 
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, se ha mantenido en descenso con un $12\%$, manteniéndose así también las últimas 4 semanas \textbf{\color{mycolor4}} 
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Todas las provincias presentan desaceleración de casos y defunciones para la SE 46. El exceso regional de mortalidad general es de -21.
