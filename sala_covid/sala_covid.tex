...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} es \textbf{\color{mycolor4}baja} por primera vez, con un $52\% $ de ocupación a nivel regional. 
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE52, todas las provincias presentan una disminución de casos y defunciones, excepto Cusco, Quispicanchi, Paucartambo y Urubamba. El exceso regional de mortalidad general es de -45.
