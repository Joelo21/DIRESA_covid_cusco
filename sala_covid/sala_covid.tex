...
\begin{frame}[label=Resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad para pruebas moleculares} \textbf{\color{mycolor4}aumentó} a $10\%$, y la \textbf{\color{mycolor3}tasa de positividad de pruebas antigénicas} a $11.7\%$, lo que duplica el valor de la semana previa.
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}disminuyó} al $8\%$ a nivel regional.
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}se mantuvo estable con un $25\%$}. 
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Para la SE25, se mantiene el ascenso en el número de casos, con un ascenso estable en el número de hospitalizaciones en la zona de no UCI (ascenso que se produjo en la SE 24 y que se mantuvo para la SE25).Aún se mantienen bajas las defunciones.
		\end{itemize}
	\end{itemize}
\end{frame}
