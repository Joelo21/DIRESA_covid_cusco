...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 27 de noviembre del 2021}}
...
\date{Semana Epidemiológica 47, 2021}
...
\begin{document}
	...
	\begin{figure}
		...
		\end{subfigure}
	\end{figure}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 27 de noviembre del 2021. \\
...
\begin{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Juan Carbajal ($@$juank23\_7). Consultado el 29 de noviembre del 2021. \\} 
	\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2021-11-21.\\}
	\vspace{0.01cm}
...
\begin{frame}
	...
	\end{center}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2021-11-27. Reporte de número reproductivo efectivo (Rt) de COVID-19. Disponible haciendo clic en el siguiente enlace: \href{https://www.dge.gob.pe/portalnuevo/informacion-publica/reporte-de-numero-reproductivo-efectivo-rt/}{CDC-Rt}. \\}
	\vspace{0.01cm}
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 47}}                                                   \\ \hline
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 47}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 3                    & 3                  & 50\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 47}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						5                & 1                    & 4                  & 20\%                        \\ \hline
					\end{tabular}%
				}
...
\begin{frame}[label=resumen]
	...
	\vspace{-.5cm}
	\begin{itemize}
		\item La Región de Cusco se ubica en el \textbf{\color{mycolor4}octavo lugar} de \textbf{\color{mycolor3}mortalidad} acumulada a nivel nacional, con una índice de propagación de $0.98 $.
		\item Se ha mantenido la \textbf{\color{mycolor4}desaceleración} en el número de \textbf{\color{mycolor3}casos sintomáticos} y defunciones por COVID-19.
		\item La \textbf{\color{mycolor3}incidencia de casos por el total de pruebas realizadas} presenta un leve incremento de casos a nivel de la provincia de Canas, Paruro y Espinar. Traduciendo un \textbf{\color{mycolor3}incremento de casos asintomáticos}.
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en mayor \textbf{\color{mycolor4}descenso} con un $4.5\%$, manteniéndose en este rango durante las últimas quince semanas. Mientras que, la \textbf{\color{mycolor3}tasa de positividad} para pruebas moleculares se mantuvo en $11.4\%$ para la SE47.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\item Para la SE 47, continua la predominancia de la variante delta con un $90\%$, del total de elegibles secuenciados, siendo las características de presentación clínica similares con las otras variantes.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Todas las provincias presentan desaceleración de casos y defunciones, a excepción de Anta, Cusco, Quispicanchi y Urubamba que presentan un incremento de casos. El exceso regional de mortalidad general es de -21.
