...
\begin{frame}[label=Resumen]
	...
	\begin{itemize}
		...
		\item Aún se mantiene el \textbf{\color{mycolor4} incremento} en el número de \textbf{\color{mycolor3}casos}. 
		\item La \textbf{\color{mycolor3}tasa de positividad para pruebas moleculares} \textbf{\color{mycolor4}disminuyó} a $4.3\%$, pero la \textbf{\color{mycolor3}tasa de positividad de pruebas antigénicas} ascendió a $5.6\%$.
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}disminuyó} al $12\%$ a nivel regional.
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}aumentó un $18\%$} con el $25\%$. Asimismo, se debe notar que a partir de la SE18 se disminuyó la oferta total de camas disponibles en cada uno de los hospitales.
	\item Para la SE 24, predomina la variante ómicron en el $98\%$, del total de muestras secuenciadas por semana, siendo las características de presentación clínica similares con las otras variantes, con casos leves en la presentación clínica, secuenciamiento que se realiza en nuestra región desde hace 02 semanas.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE24, se mantiene el ascenso en el número de casos, con un ascenso en el número de hospitalizaciones en la zona de no UCI, aún se mantienen bajas las defunciones.
		\end{itemize}
	\end{itemize}
\end{frame}
