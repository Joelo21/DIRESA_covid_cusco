...
\begin{frame}[label=resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en  \textbf{\color{mycolor4}descenso} con un $1.2\%$, así como la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares también se mantienen en descenso con un $3.4\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}incrementó} al $88\%$ a nivel regional. El Hospital Antonio Lorena es el que presenta el $100\%$ de camas ocupadas por tercera semana.
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}disminuyó} a $9\%$.
	\item Para la SE 12, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana, siendo las características de presentación clínica similares con las otras variantes, con casos leves en la presentación clínica.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE12, todas las provincias permanecen en descenso marcado de casos y fallecidos.
