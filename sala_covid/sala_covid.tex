...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 30, la provincia del \textbf{\color{mycolor5}Cusco} registro \textbf{\color{mycolor5}dos} defunciónes por COVID-19.\\
		$\rightarrow$ La provincia de Acomayo registro \textbf{\color{mycolor5}una} defunción y la provincia de La Convención registro \textbf{\color{mycolor5}dos} defunciónes por COVID-19.\\
		$\rightarrow$ Las demás provincias de la región del \textbf{\color{mycolor5}Cusco} registraron \textbf{\color{mycolor5}cero} defunciónes por COVID-19.
	\end{frame}
