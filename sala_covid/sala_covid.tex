...
\begin{frame}[label=resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en mayor \textbf{\color{mycolor4}descenso} con un $4.7\%$, manteniéndose en este rango durante las últimas trece semanas. Mientras que, la \textbf{\color{mycolor3}tasa de positividad} para pruebas moleculares se mantuvo en $16.6\%$ para la SE44.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Todas las provincias presentan desaceleración de casos y defunciones para la SE 44. El exceso regional de mortalidad general es de -4.
