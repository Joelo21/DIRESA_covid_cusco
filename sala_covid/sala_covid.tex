...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 05 de Febrero del 2022}}
...
\date{Semana Epidemiológica 05, 2022}
...
\begin{document}
	...
	\begin{figure}
		...
		\end{subfigure}
	\end{figure}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 29 de enero del 2022.\\} 
	\vspace{0.01cm}
	$\rightarrow$ 77.8\% ómicron en Lima en la SE02, 9 muestras\\
	$\rightarrow$ No muestras en Callao.\\
	$\rightarrow$ Omicrón: 101/109=92.7\% de las muestras del país en la SE02\\
	$\rightarrow$ Resultados de 2-3 semanas atrás. Vacíos en 10 regiones.\\	
\end{frame}

\begin{frame}[label=epi_nacional]
	\frametitle{Casos Nacionales suben 39.2\%, nuevo record de pandemia}
	\vspace{.1cm}
	\begin{figure}
		\centering
		\begin{subfigure}[b]{0.42\textwidth}
		...
		\draw[mycolor2, thick] (-2.40,3.75) circle [x radius=2.5cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		\hfill
	...
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 29 de enero del 2022.\\} 
	\vspace{0.01cm}
	$\rightarrow$ Suben todas las regiones menos Cusco.\\
	$\rightarrow$ Mayores subidas: Ucayali (237\%), Loreto (165\%), Huancavelica (132\%), Madre de Dios (129\%) y Amazonas (103\%), principalmente en la Amazonía.\\
\end{frame}

\begin{frame}[label=epi_nacional]
	\frametitle{Positividad antigénica subió 6.97\%, alza porcentual de 18.4\%}
	\vspace{-.1cm}
	\begin{figure}
		\centering
	...
	\vspace{0.01cm}
		$\rightarrow$ Suben todas las regiones menos Cusco.\\
	$\rightarrow$ Incrementos >>>: Madre de Dios (21.7\%), Ucayali (18.4\%), Tacna (17.2\%), Pasco (15.4\%), Loreto (15.0\%), Tumbes (14.9\%), Huancavelica (14.3\%) y Amazonas (14.0\%).\\
\end{frame}
...
%	\end{tikzpicture}
	{\tiny Fuente:REUNIS (Repositorio Único Nacional de Información en Salud). Consultado el 29 de enero del 2022.\\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 29 de enero del 2022.\\}
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,313 $ defunciones por COVID-19 por millón de habitantes. \\
	\end{frame}
...
\textbf{Riesgos}:\\
			Lima metropolitana, Callao y Lima región: fallecidos en alza vertical\\
				Records de 30 semanas.\\
				Tasa >5 fallecidos diarios x millón.\\
				2-4 semanas al alza.\\
				Alza explosiva en otras regiones.\\
				Nadie baja, 20 regiones suben.\\		
\textbf{Menor Riesgo}:Amazonía con tasas < 1.0.\\
					  Sierra/selva norte y centro con tasas entre 1.0 y 1.9.\\}
\vspace{0.01cm}
$\rightarrow$ {\color{mycolor5}Cusco}: Las defunciones representan un $14.47\% $ del pico de la segunda ola.\\
\end{frame}
	...
	\begin{frame}
		...
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2022-01-29.\\}
	\vspace{0.01cm}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 29 de enero del 2022. \\
	\textbf Nota 1: Perú: 873 camas libres, bajó 13.4\%,313 camas libres, bajó 8.2\%\\
	\textbf Suben:* Tumbes, Piura, Lambayeque y La Libertad.\\
	Costa central: Lima metropolitana, Callao y Ica.\\
	Selva:Amazonas, Loreto, Ucayali y Madre de Dios.\\
	Sierra/Selva Central: Huánuco y Junín.
	Costa Sur: Arequipa, Moquegua y Tacna.\\
	Sierra Sur: Ayacucho, Apurímac y Puno.\\
	Doce regiones suben 2-4 semanas
	Loreto sube 84\% en 4 de 5 sem. Puno sube 31\% en cuatro sem.Lambayeque sube 29\% en 7/9 sem. Moquegua sube 28\% en 5/7 sem. Ayacucho sube 26\% en 4 sem. Huánuco sube 24\% en 2 sem. Junín sube 22\% en 5/6 sem.\\
	\textbf Que media: Tumbes (90.7\%), Loreto (84.0\%), Piura (72.8\%), Lambayeque (72.3\%), Ayacucho (72.1\%) y Ancash (65.2\%), entre otras.\\
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.1,3.49) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 29 de enero del 2022.\\}
	\vspace{0.1cm}
	$\searrow$ Cusco baja a la posición 15.
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.8,2.40) circle [x radius=2.8cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 29 de enero del 2022. \\} 
		\vspace{0.01cm}
		$\nearrow$ Cusco sube a la posición 22.
...
\section{Indicadores Epidemiológicos, Región Cusco}
	...
	\begin{frame}
		...
		\vspace{-.5cm}
		\begin{center}
			\includegraphics[width=0.8\linewidth]{../figuras/sintomaticos_20_21_22.png}
		\end{center} 
	...
	\begin{frame}[label=epi_cusco]
		...
		\vspace{-.5cm}
		\begin{center}
			\includegraphics[width=.9\linewidth]{../figuras/positivos_20_21_22.png}
		\end{center}
		{\tiny Fuente de datos: SISCOVID, NOTICOVID.} \\
%			Nota: {\color{mycolor1} --- ---: Navidad}, {\color{mycolor1} - -: Año Nuevo}, {\color{mycolor2} - -: Semana Santa}, {\color{mycolor3} - -: Elecciones Primera Vuelta}, {\color{mycolor4} $- \cdot$: Elecciones Segunda Vuelta}. \\}	
	...
	\begin{frame}[label=TipoPrueba]
		...
		\vspace{-.15cm}
		\begin{center}
			\includegraphics[width=0.7\linewidth, trim={0cm 0cm 0cm 0cm},clip]{../figuras/sinto_prueba_20_21_22.png}
		\end{center}
	\vspace{-.5cm}
		{\tiny Fuente de datos: SISCOVID, NOTICOVID.}\\
	...
	\begin{frame}
		...
		\vspace{-.5cm}
		\begin{center}
			\includegraphics[width=0.9\linewidth]{../figuras/positivos_crecimiento_2021.png}
		\end{center} 
		{\tiny Fuente de datos: SISCOVID, NOTICOVID. \\
...
\begin{frame}
	...
	\end{center}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2022-01-29. Reporte de número reproductivo efectivo (Rt) de COVID-19. Disponible haciendo clic en el siguiente enlace: \href{https://www.dge.gob.pe/portalnuevo/informacion-publica/reporte-de-numero-reproductivo-efectivo-rt/}{CDC-Rt}. \\}
	\vspace{0.01cm}
...
\end{frame}
	...
	\end{frame}
		...
		\begin{frame}
		\frametitle{Casos Promedios y Defunciones diarios}
		\vspace{-.5cm}
		\begin{center}
...
\end{frame}
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 05}}                                                   \\ \hline
	...
	\begin{frame}
		...
		\vspace{-.2cm}
		\begin{center}
			\includegraphics[width=0.77\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_uci.png}
		\end{center}
		{\tiny Fuente de datos: Referencias, contrareferencias.}
	\end{frame}
	\begin{frame}
	...
	-		\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_nouci.png}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 05}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 4                    & 1                  & 67\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 05}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						5                & 4                    &1                   & 80\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 05}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						14               & 8                     & 6                   & 57\%                        \\ \hline
					\end{tabular}%
				}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		$\rightarrow$ Para la SE 04, la provincia de Anta, Canas, Canchis, Chumbivilcas, Espinar, La Convencion, Paucartambo, Quispicanchis reportaron defunción por COVID-19 en la última semana epidemiológica en la región del \textbf{\color{mycolor5}Cusco}.
		
		$\rightarrow$ La provincia del \textbf{\color{mycolor5}Cusco} reporto \textbf{\color{mycolor5}nueve} defunciones por COVID-19 en la última semana epidemiológica.
		
		$\rightarrow$ La provincia de Acomayo, Calca, Paruro y Urubamba registran \textbf{\color{mycolor5}cero} defunciones en la ultima semana epidemiológica.	
...
\begin{frame}[label=resumen]
	...
	\vspace{-.5cm}
	\begin{itemize}
		\item La Región de Cusco se ubica en el \textbf{\color{mycolor4}octavo lugar} de \textbf{\color{mycolor3}mortalidad} acumulada a nivel nacional, con una índice de propagación de $1.4 $.   
		\item Existe un \textbf{\color{mycolor4}descenso} en el número de \textbf{\color{mycolor3}casos} COVID-19, con una inflexión la última semana, con ascenso en el número de hospitalizados y de defunciones, sin embargo este último indicador aun se mantiene en el área verde del semáforo epidemiológico, que indica bajo riesgo.
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en  \textbf{\color{mycolor4}estacionaria} con un $42.8\%$, así como la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares también tuvo un descenso hasta un $35.9\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}aumentó} a $84\% $ a nivel regional, es decir aumento \textbf{\color{mycolor3}1.6 veces} desde el inicio de la tercera ola
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, aumentó a $54\%$, es decir \textbf{\color{mycolor3}4.5 veces} más desde el inicio de la tercera ola
	\item Para la SE 04, predomina la variante ómicron en un $93\%$, del total de muestras secuenciadas por semana, siendo las características de presentación clínica similares con las otras variantes, con casos de presentación leve en su mayoría.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Tasa de crecimiento semanal de \textbf{\color{mycolor4}casos} en \textbf{\color{mycolor3}ámbar}.
			...
			\item Disponibilidad de \textbf{\color{mycolor4}camas hospitalarias}: no UCI: en \textbf{\color{mycolor3}rojo}.
		...
		\begin{itemize}
			\item Para la SE04, todas las provincias, a excepción de Canas y Chumbivilcas presentan un crecimiento estacionario en el número de casos, con tendencia al descenso. 
