...
\textbf{Riesgos}:\\
			Ancash y Arequipa >=2 fallecidos.\\
...
\end{frame}
  ...
  \begin{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 14 de Mayo del 2022. \\
	\textbf Nota 1: 1122 camas libres, baja 2.4\% -  Lima: 460 camas libres, bajo 1.9\%
	\\
	\textbf Suben*: \\
	Costa norte-centro: La Libertad, Amcash e Ica.\\
	Selva y Sierra sur: Amazonas, Huánuco y Madre de Dios.\\
	Amazonia: Amazonas, San Martin, Loreto y Ucayali. -  Sierra Centro: Pasco.\\ 
	\textbf Suben dos regiones por 2semanas:* \\
	La Libertad sube 11.68\% en 2 sem. Madre de Dios sube 2.73\% en 2 sem.\\
	\textbf >Que media: \\
	La Libertad (69.3\%), Cusco (48.7\%), Callao (43.8\%), Ancash (43.4\%) y Piura (19.8\%).\\ 
	Solo una de estas cinco regiones suben esta semana.
} 
	\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.8,3.66) circle [x radius=2.8cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 18, las provincias de la region del Cusco registraron \textbf{\color{mycolor5} una} defuncion por COVID-19 a excepción de La Convención.\\
...
\begin{frame}[label=resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra   \textbf{\color{mycolor4}estacionaria} con un $1.1\%$, así como la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares también se mantiene estable con un $1.7\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}disminuyó} al $68\%$ a nivel regional (con un descenso del $9\%$), habiéndose ocupado el $100\%$ de camas en el Hospital Nacional Adolfo Guevara Velasco (6/6). 
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}descendió} al $5\%$.
	\item Para la SE 178, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana, siendo las características de presentación clínica similares con las otras variantes, con casos leves en la presentación clínica, secuenciamiento que se realiza en nuestra región desde hace 02 semanas.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE18, todas las provincias permanecen en descenso marcado de casos y fallecidos.
