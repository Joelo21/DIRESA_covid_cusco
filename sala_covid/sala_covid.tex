...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 29 de Octubre del 2022}}
...
\date{Semana Epidemiológica 43, 2022}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF - NOTICOVID. \\}
		\vspace{0.2cm}
		$\rightarrow$ Para la SE 43, la provincia del \textbf{\color{mycolor5}Cusco} registró \textbf{\color{mycolor5}cero} defunciónes por COVID-19.\\
