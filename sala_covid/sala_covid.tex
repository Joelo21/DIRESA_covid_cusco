...
\begin{frame}[label=Resumen]
	...
	\begin{itemize}
		...
		\item A la presente SE 48, se mantiene un \textbf{\color{mycolor4} incremento} en el número de \textbf{\color{mycolor3}casos}, así como de hospitalizaciones, las defunciones se encuentran aún bajas.
		\item La \textbf{\color{mycolor3}tasa de positividad para pruebas moleculares} \textbf{\color{mycolor4}ascendió} a $28.5\%$ y la \textbf{\color{mycolor3}tasa de positividad de pruebas antigénicas} ascendió a 21$\%$. \end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3} no UCI} \textbf{\color{mycolor3}ascendió al $54\%$ a nivel regional}.
	\item La ocupación de camas \textbf{\color{mycolor3} UCI}, \textbf{\color{mycolor4}ascendió al $25\%$, un $14\%$ más a la semana previa}. 
	\item Para la SE 48, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana, con la aparición de sublinajes como XBB y BQ1 y BQ1.1.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE48, la provincia de Cusco, la Convención, Quispicanchis y Canchis se encuentran con mayor incremento de casos. Las defunciones aun se encuentran bajas.
		\end{itemize}
	\end{itemize}
\end{frame}
%
