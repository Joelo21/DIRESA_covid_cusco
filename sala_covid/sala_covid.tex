...
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,431 $ defunciones por COVID-19 por millón de habitantes. \\
		\end{frame}
...
\textbf{Menor Riesgo}: \\
			Todas las macro-regiones menos la sierra central bajan >40\%. \\
			Todas las DIRIS bajan >40\%. \\
			Todos los grupos etarios >16 años bajan >20\%. \\
			}
\vspace{0.01cm}
$\rightarrow$ {\color{mycolor5}Cusco}: Las defunciones representan un $5.03\% $ del pico de la segunda ola.\\
\end{frame}
	...
	$\nearrow$ Cusco se encuentra a la posición 06 con un RT de $0.59$ $ [0.54-0.63]$.
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 26 de Marzo del 2022. \\
	\textbf Nota 1: Perú: 1092 camas libres, subió 2.0\% -  Lima: 412 camas libres, subio 2.0\%
	\\
	\textbf Suben*: \\
	Selva: Madre de Dios y Loreto. \\
	Costa Centro: Callao.\\
	Sierra Sur: Cusco. \\
	\textbf Solo sube una region por 2 semanas: \\
	Loreto sube 9.8\%.\\
	\textbf Que media: Tumbes (84.8\%), Ancash (69.20\%), Cusco (60.4\%), Arequipa (53.9\%), Loreto (51.4\%), Piura y Ayacucho (50.0\%), La Libertad (49.1\%), Callao (44.1\%), Moquegua (43.4\%), Puno (41.3\%), Lambayeque (40.3\%) y Huánuco (36.8\%).\\ 
	Solo tres de estas 13 regiones suben.
} 
	\vspace{0.01cm}
...
\begin{frame}
	...
	{   \tiny Fuente de datos: NOTICOVID, SISCOVID, SINADEF.\\
		Tasa de letalidad ajustada 1 000 000 de habitantes*.\\
