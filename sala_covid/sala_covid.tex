...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 26 de Noviembre del 2022}}
...
\date{Semana Epidemiológica 47, 2022}
...
\begin{frame}
	...
	\end{center}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2022. Actualización: 2022-11-26. Reporte de número reproductivo efectivo (Rt) de COVID-19. Disponible haciendo clic en el siguiente enlace: \href{https://www.dge.gob.pe/portalnuevo/informacion-publica/reporte-de-numero-reproductivo-efectivo-rt/}{CDC-Rt}. \\}
	\vspace{0.01cm}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF - NOTICOVID. \\}
		\vspace{0.2cm}
		$\rightarrow$ Para la SE 47, la provincia del \textbf{\color{mycolor3}Cusco} registró \textbf{\color{mycolor3}cero} defunciónes por COVID-19.\\
...
\begin{frame}
	...
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}ascendió al $0\%$} (hasta la SE46). 
