...
\begin{frame}[label=resumen]
	...
	\begin{itemize}
		...
		\item Existe un \textbf{\color{mycolor4}ligero incremento} en el número de \textbf{\color{mycolor3}casos, más aún permanece el descenso en hospitalizados y defunciones} por COVID-19.
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra   \textbf{\color{mycolor4}estacionaria} con un ligero ascenso a $2.5\%$, así como la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares presenta un ascenso a $6.7\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE22, la provincia de Espinar, presenta un ligero ascenso en el número de casos, aún se mantienen bajas las defunciones.
