...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 01 de Enero del 2022}}
...
\date{Semana Epidemiológica 08, 2022}
...
\begin{document}
	...
	\begin{frame}[label=indice]
		...
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item Regional: Curva epidémica, incidencia, tasa de positividad, variantes ({\color{mycolor3}Nuevo} \hyperlink{variantes}{\beamergotobutton{variantes}}), defunciones, RT por distrito, exceso de defunciones, letalidad, mortalidad, y mortalidad por grupos de edad e hitos de vacunación.  \hyperlink{epi_cusco}{\beamergotobutton{epi. cusco.}} 
			\end{itemize} 
			\item Cobertura de Vacunación ({\color{mycolor3}Nuevo} \hyperlink{cobertura_vacuna}{\beamergotobutton{cobertura}}). 
	...
	\begin{figure}
		...
		\end{subfigure}
	\end{figure}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 01 de enero del 2022. \\} 
	\vspace{0.01cm}
	$\rightarrow$ 37.5\% Ómicron en Lima y Callao en SE51 (8 muestras).\\
	$\rightarrow$ Pocas muestras en la SE52 (11), todas de Piura.\\
	$\rightarrow$ No mezclar vigilancia especial, no permite usar estadísticas.\\
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{center}
		\includegraphics[width=1\linewidth]{../sala_nacional/vacunas_nacional.png} 
	\end{center}
%	\begin{tikzpicture}[overlay]
%		\draw[mycolor5, very thick] (9.5,3.40) circle [x radius=3.0cm, y radius=.58cm, rotate=90];
%	\end{tikzpicture}
	{\tiny Fuente:REUNIS (Repositorio Único Nacional de Información en Salud). Consultado el 08 de enero del 2022.\\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.5,4.70) circle [x radius=2.cm, y radius=.13cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 08 de enero del 2022.\\}
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,278 $ defunciones por COVID-19 por millón de habitantes. \\
	\end{frame}
...
\end{center}
\begin{tikzpicture}[overlay]
	\draw[mycolor2, ultra thick] (5.2,3.60) circle [x radius=3.8cm, y radius=.2cm, rotate=0];
\end{tikzpicture}
{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 08 de enero del 2022.\\
%Nota 1: Sube Piura. \\
%Nota 2: Mayor valor en 21 semanas.\\	
\textbf{Riesgos}:\\
				Sobre-optimismo: Reporte cae durante fiestas, documentado en 2020 y en otros países*\\
				Fuertísima circulación de omicrón, en Lima y resto del país.\\
				10 millones de no vacunados con nueve veces más riesgo de morir.\\
				Percepción que omicrón es leve.\\
				Más fallecidos en adultos jóvenes.\\		
				Pocas UCI disponibles en toda la costa norte-centro.\\	
\textbf{Estancamiento}:Nueve regiones suben >2, 14 regiones no varían (±1), una crecen mínimamente(2)\\
					  Sólo Piura cae fuertemente (13), No hemos observado alza exponencial (aún)\\}
\vspace{0.01cm}
$\rightarrow$ {\color{mycolor5}Cusco}: Las defunciones representan un $1.27\% $ del pico de la segunda ola.\\
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, ultra thick] (5.75,3.88) circle [x radius=3.4cm, y radius=.18cm, rotate=0];
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2022-01-08.\\}
	\vspace{0.01cm}
	...
	$\nearrow$ Cusco se encuentra a la posición 12 con un RT de $1.05$ $ [1.01-1.09]$.
	...
	\vspace{-.5cm}
	\begin{center}
		\includegraphics[width=0.56\linewidth]{../sala_nacional/camas_regional.png}
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, ultra thick] (4.15,3.75) circle [x radius=.50cm, y radius=.50cm, rotate=0];
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 08 de enero del 2022. \\
	\textbf Nota 1: Perú: 1056 camas libres,sube 2.8\%, Lima: 332 camas libres, subió 2.4\%. \\
	\textbf Suben:* Amazonas, Cajamarca y San Martín en la sierra/selva norte. Lambayeque, La Libertad y Ancash en la costa norte-central. Pasco, Junín, Huancavelica y Ayacucho en la sierra/selva central Ucayali y Madre de Dios en selva Puno.\\
	Nueve regiones suben 2-4 semanas, todas c/área amazónica menos una.\\
	Cajamarca y Ucayali en cuatro semanas seguidas suben 8.5\% y 7.1\%, San Martín y Junín en dos semanas seguidas crecen 9.4\% y 5.4\%, Amazonas, Lambayeque y Ancash crecen 15-25\% en al menos cuatro de las últimas seis semanas.\\
	\textbf Que media: Tumbes (90.4\%), Ancash (75.0\%), Lambayeque (68.2\%), Piura (61.5\%), Libertad (57.5\%), Ayacucho (51.7\%), Lima metropolitana (51.3\%), Lima región (48.0\%), Callao (48.2\%) y Arequipa (45.1\%). Sólo cuatro suben\\} 
	\vspace{0.01cm}
%	$\nearrow$ Todas subieron menos Tumbes y Callao y sólo tres suben dos o más semanas.
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.1,4.27) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 08 de enero del 2022.\\}
	\vspace{0.1cm}
	$\searrow$ Cusco baja a la posición 10.
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.5,2.85) circle [x radius=2.0cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 08 de enero del 2022. \\} 
		\vspace{0.01cm}
		$\nearrow$ Cusco pasa al puesto 19.
...
\section{Indicadores Epidemiológicos, Región Cusco}
	...
	\begin{frame}
		...
		\vspace{-.5cm}
		\begin{center}
			\includegraphics[width=0.8\linewidth]{../figuras/sintomaticos_20_21_2022.pdf}
		\end{center} 
	...
	\begin{frame}[label=epi_cusco]
		...
		\vspace{-.5cm}
		\begin{center}
			\includegraphics[width=.9\linewidth]{../figuras/positivos_20_21_2022.pdf}
		\end{center}
		{\tiny Fuente de datos: SISCOVID, NOTICOVID. \\
	...
	\begin{frame}[label=TipoPrueba]
		...
		\vspace{-.15cm}
		\begin{center}
			\includegraphics[width=0.7\linewidth, trim={0cm 0cm 0cm 0cm},clip]{../figuras/sinto_prueba_20_21_2022.pdf}
		\end{center}
	\vspace{-.5cm}
		{\tiny Fuente de datos: SISCOVID, NOTICOVID.}\\
		Ver detalles de sintomaticos por tipo de prueba para cada provincia haciendo click en los siguientes enlaces:
...
\begin{frame}
		...
		\vspace{-.5cm}
		\begin{center}
			\includegraphics[width=0.8\linewidth]{../figuras/positividad_pcr_2022.pdf}
		\end{center}
		{\tiny Fuente de datos: SISCOVID, NOTICOVID.}
\end{frame}
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{center}
		\includegraphics[width=0.8\linewidth]{../figuras/positividad_ag_2022.pdf}
	\end{center}
	{\tiny Fuente de datos: SISCOVID, NOTICOVID.}
\end{frame}
...
\vspace{-.5cm}
\begin{center}
\includegraphics[width=0.9\linewidth]{../figuras/variantes.png}
\end{center}
...
\begin{frame}
	...
	\end{center}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2022-01-08. Reporte de número reproductivo efectivo (Rt) de COVID-19. Disponible haciendo clic en el siguiente enlace: \href{https://www.dge.gob.pe/portalnuevo/informacion-publica/reporte-de-numero-reproductivo-efectivo-rt/}{CDC-Rt}. \\}
	\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\vspace{-.5cm}
		\begin{center}
			\includegraphics[width=0.9\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/defunciones_20_21_2022.pdf}
		\end{center}
	...
	\begin{frame}
		...
		\vspace{-.5cm}
		\begin{center}
			\includegraphics[width=0.9\linewidth]{../figuras/defunciones_crecimiento_2022.pdf}
		\end{center} 
		{\tiny Fuente de datos: SINADEF. \\
			Nota: {\color{mycolor1} - -: Año Nuevo}, {\color{mycolor2} - -: Semana Santa}, {\color{mycolor3} - -: Elecciones Primera Vuelta}, {\color{mycolor4} $- \cdot$: Elecciones Segunda Vuelta}. \\}
	\end{frame}
	...
	\begin{frame}
		...
		\vspace{-.5cm}
		\begin{center}
			\includegraphics[width=0.9\linewidth]{../figuras/mortalidad_edad_2022.pdf}
		\end{center}
...
\vspace{-.8cm} 
		...
		$\rightarrow$ {\small La curva de tasa de mortalidad estuvo en descenso y las \textbf{\color{mycolor3}vacunas} contribuyeron a \textbf{\color{mycolor3}mantener y reducir} la tasa de mortalidad.} \hyperlink{indice}{\beamergotobutton{Índice}}
\end{frame}
...
\end{frame}
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 01}}                                                   \\ \hline
	...
	\begin{frame}
		...
		\vspace{-.2cm}
		\begin{center}
			\includegraphics[width=0.77\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_uci.pdf}
		\end{center}
		{\tiny Fuente de datos: Referencias, contrareferencias.}
	\end{frame}
	\begin{frame}
		...
		\vspace{-.2cm}
		\begin{center}
	-		\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_nouci.pdf}
			
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 01}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 4                    & 2                  & 67\%                        \\ \hline
					\end{tabular}%
				}
	...
	\begin{frame}
		...
		\vspace{-.2cm}
		\begin{center}
			\includegraphics[width=0.77\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_lorena_uci.pdf}				
		\end{center}
		{\tiny Fuente de datos: Referencias, contrareferencias.}
	\end{frame}
	\begin{frame}
		...
		\vspace{-.2cm}
		\begin{center}
			\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_lorena_nouci.pdf}	
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 01}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						5                & 2                    & 3                  & 40\%                        \\ \hline
					\end{tabular}%
				}
	...
	\begin{frame}
		...
		\vspace{-.2cm}
		\begin{center}
			\includegraphics[width=0.77\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_adolfo_uci.pdf}
		\end{center}
		{\tiny Fuente de datos: Referencias, contrareferencias}
	\end{frame}
	\begin{frame}
		...
		\vspace{-.2cm}
		\begin{center}
			\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_adolfo_nouci.pdf}
			
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 01}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						14               & 3                     & 11                   & 21\%                        \\ \hline
					\end{tabular}%
				}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		$\rightarrow$ Para la SE 01,la provincia de Calca, Canchis, Espinar y La Convención reportaron \textbf{\color{mycolor5}una} defunción por COVID-19 en la última semana epidemiológica en la región del \textbf{\color{mycolor5}Cusco}.
		
		$\rightarrow$ La provincia del \textbf{\color{mycolor5}Cusco} reporto \textbf{\color{mycolor5}una} defunciones por COVID-19 en la última semana epidemiológica.
		
		$\rightarrow$ La provincia de Acomayo, Canas y Paruro registran \textbf{\color{mycolor5}cero} defunciones en las ultimas 9 semanas epidemiológicas.	
...
\begin{frame}[label=resumen]
	...
	\vspace{-.5cm}
	\begin{itemize}
		\item La Región de Cusco se ubica en el \textbf{\color{mycolor4}octavo lugar} de \textbf{\color{mycolor3}mortalidad} acumulada a nivel nacional, con una índice de propagación de $1.05 $.   
		\item Se ha mantenido estacionaria la \textbf{\color{mycolor4}desaceleración} en el número de \textbf{\color{mycolor3}casos} y defunciones por COVID-19.
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en ascenso \textbf{\color{mycolor4}descenso} con un $7\%$, manteniéndose en este rango durante los últimas cuatro meses. Mientras que la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares se mantiene en $7\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} es \textbf{\color{mycolor4}baja} con un $52\% $ de ocupación a nivel regional. 
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, ha disminuido a un $12\%$.
	\item Para la SE 52, predomina la variante delta en un $93\%$, del total de elegibles secuenciados, siendo las características de presentación clínica similares con las otras variantes.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Tasa de \textbf{\color{mycolor4}positividad} de pruebas \textbf{\color{mycolor4}antigénicas} en \textbf{\color{mycolor3}verde} y de prueba moleculares en \textbf{\color{mycolor3}verde}.
		...
		\begin{itemize}
			\item Para la SE52, todas las provincias presentan una disminución de casos y defunciones, excepto Cusco, Quispicanchi, Paucartambo y Urubamba, que han presentado un leve incremento de casos, siendo más notorio en la provincia de Cusco. El exceso regional de mortalidad general es de -45.
...
\begin{frame}[label=recomendaciones]
	...
	\begin{itemize}
			...
			\item Énfasis en distanciamiento social, mascarilla, lavado de manos.
			...
			\item Fortalecer el uso adecuado de EPP bien usado
