...
\begin{frame}[label=Resumen]
	...
	\begin{itemize}
		...
		\item A la presente SE 47, se mantiene un \textbf{\color{mycolor4} incremento} en el número de \textbf{\color{mycolor3}casos}, así como de hospitalizaciones, las defunciones se encuentran aún bajas.
		\item La \textbf{\color{mycolor3}tasa de positividad para pruebas moleculares} \textbf{\color{mycolor4}ascendió} a $21.2\%$ y la \textbf{\color{mycolor3}tasa de positividad de pruebas antigénicas} ascendió a 19.6$\%$. Ascensos que superan el 5$\%$ en la última semana	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI} \textbf{\color{mycolor3} descendió al $38\%$ a nivel regional, tras el último ascenso de la previa}.
	\item La ocupación de camas \textbf{\color{mycolor3} UCI}, \textbf{\color{mycolor4}ascendió al $11\%$, un $3\%$ más a la semana previa} (hasta la SE47). 
	\item Para la SE 47, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE47, la provincia de Cusco, la Convención y Canchis se encuentran con un incremento de casos. Las defunciones y hospitalizaciones aun se encuentran bajas.
		\end{itemize}
	\end{itemize}
\end{frame}
