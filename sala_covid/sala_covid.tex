...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 25 de diciembre del 2021}}
...
\date{Semana Epidemiológica 51, 2021}
...
\begin{document}
	...
	\begin{figure}
		...
		\end{subfigure}
	\end{figure}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 25 de diciembre del 2021. \\} 
	\vspace{0.01cm}
...
%	\end{tikzpicture}
	{\tiny Fuente: Juan Carbajal ($@$juank23\_7). Consultado el 25 de diciembre del 2021. \\} 
	\vspace{0.01cm}
...
\begin{frame}
	...
	\end{center}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2021-12-25. Reporte de número reproductivo efectivo (Rt) de COVID-19. Disponible haciendo clic en el siguiente enlace: \href{https://www.dge.gob.pe/portalnuevo/informacion-publica/reporte-de-numero-reproductivo-efectivo-rt/}{CDC-Rt}. \\}
	\vspace{0.01cm}
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 51}}                                                   \\ \hline
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		$\rightarrow$ Para la SE 51,las provincias de Calca, Chumbivilcas, \textbf{\color{mycolor5}Cusco} y Espinar, reportaron defunciones por COVID-19 en la última semana epidemiológica en la región del \textbf{\color{mycolor5}Cusco}.
