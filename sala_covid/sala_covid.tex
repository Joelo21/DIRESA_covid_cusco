...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 21 de Mayo del 2022}}
...
\date{Semana Epidemiológica 20, 2022}
...
%	\end{tikzpicture}
	{\tiny Fuente:REUNIS (Repositorio Único Nacional de Información en Salud). Consultado el 21 de Mayo del 2022.\\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 21 de Mayo del 2022.\\}
\vspace{0.01cm}
...
\textbf{Riesgos}:\\
			Ancash tiene el mayor número de fallecidos (4).\\
			Estancado en 3-4 fallecidos por cinco semanas.\\
			Fallecidos nacionales en >80\% estancados en 8-9 fallecidos por cuatro semanas.\\
...
\end{frame}
	...
	\begin{frame}
		...
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2022. Actualización: 2022-05-21.\\}
	\vspace{0.01cm}
  ...
  \begin{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 21 de Mayo del 2022. \\
	\textbf Nota 1: 1077 camas libres, baja 2.4\% -  Lima: 406 camas libres, bajo 3.8\%
	\\
	\textbf Suben*: \\
	Costa Centro: Lima Metropolitana y Lima Región.\\
	Sierra: Cajamarca, Junín y Puno.\\
	\textbf Ninguna región sube>1 semana. \\
	\textbf >Que media: \\
	La Libertad (64.7\%), Ancash (35.9\%), Tumbes (33.3\%), Piura (19.5\%), Arequipa (17.1\%) Cusco (16.6\%) e Ica (14.7\%).\\ 
	Solo una de estas siete regiones suben esta semana.\\
	El número de camas UCI ocupadas no baja en Piura, La Libertad, Ancash, Ica y Arequipa.\\
} 
	\vspace{0.01cm}
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			...
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 20}}                                                   \\ \hline
	...
	-		\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_nouci.png}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 20}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 2                    & 4                  & 33\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 20}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						2                & 1                    & 1                  & 50\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 20 }}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 0                     & 6                   & 0\%                        \\ \hline
					\end{tabular}%
				}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 20, las provincias de la region del Cusco registraron \textbf{\color{mycolor5} cero} defunciones por COVID-19.\\
