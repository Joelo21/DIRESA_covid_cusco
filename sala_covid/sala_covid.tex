...
\begin{frame}[label=resumen]
	...
	\begin{itemize}
		...
		\item Existe un \textbf{\color{mycolor4}descenso} en el número de \textbf{\color{mycolor3}casos} COVID-19, con desaceleración en el número de hospitalizados no UCI y de defunciones.
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en  \textbf{\color{mycolor4}estacionaria} con un $37\%$ y la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares también se mantienen estacionaria con un $38\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}aumentó} a $87\% $ a nivel regional, es decir aumento \textbf{\color{mycolor3}1.7 veces} desde el inicio de la tercera ola
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, descendió a $46\%$, sin embargo aún se mantiene \textbf{\color{mycolor3}3.8 veces} más desde el inicio de la tercera ola
	\item Para la SE 54, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana, siendo las características de presentación clínica similares con las otras variantes, con casos de presentación leve en su mayoría.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE05, todas las provincias presentan desaceleración en el crecimiento de casos, siendo el descenso preferentemente en las provincias de Cusco y Urubamba. 
