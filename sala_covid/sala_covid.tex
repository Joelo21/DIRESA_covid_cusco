...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 18 de diciembre del 2021}}
\author{Fatima Concha \& Joel Sumerente} 
\institute{Dirección de Epidemiología e Investigación \\ \textbf{\color{mycolor3}DEIS, GERESA - Cusco}}
\date{Semana Epidemiológica 50, 2021}
...
\begin{document}
	...
	\begin{figure}
		...
		\end{subfigure}
	\end{figure}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 11 de diciembre del 2021. \\
		Delta >(95\%), se mantiene muy alto.\\
		Lima: Gamma circula en Lima. Callao: Delta domina. Resto del país casi igual.\\
		Resultados de dos semanas atrás. Faltan fuentes clave.\\} 
	\vspace{0.01cm}
	$\rightarrow$ La variante Delta domina completamente en Lima y todas las macro-regiones. \\
	$\rightarrow$ Gamma persiste con muy baja frecuencia.\\
	$\rightarrow$ Muy pocas muestras en costa sur y selva baja para caracterizar adecuadamente las variantes.
	
\end{frame}

\begin{frame}
	\frametitle{Incremento de Cifras de Personas Vacunadas con Dos Dosis a Nivel Nacional}
	\vspace{-.5cm}
	\begin{center}
...
%	\end{tikzpicture}
	{\tiny Fuente: Juan Carbajal ($@$juank23\_7). Consultado el 18 de diciembre del 2021. \\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 18 de diciembre del 2021. \\}
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,271 $ defunciones por COVID-19 por millón de habitantes. \\
	\end{frame}
...
\textbf{Riesgos}:59 días sin nuevo mínimo diario (SE41).\\
				Lima Metropolitana sigue en valores altos.\\
				Lima región, empata máximo de 18 semanas.\\
				Callao, máximo en 13 semanas.\\
				Lambayeque, máximo en 20 semanas.\\
				Piura, tasas fallecidos >2 por tercera vez en cuatro semanas.\\
\textbf{Estancamiento}:15 regiones no varían (±1),cuatro crecen mínimamente (2).
					   Sólo cinco regiones suben,ninguna muy importantemente (>14)\\}
\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2021-12-18.\\}
	\vspace{0.01cm}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 18 de diciembre del 2021. \\
	\textbf Nota 1: Perú: 986 camas libres,no cambio. Lima: 273 camas libres 4. \\
	\textbf Suben:{*} Tumbes, Cajamarca y Lambayeque en el norte, Áncash, Lima Región y Callao en la Costa Central.
	Ayacucho, Arequipa, Moquegua  y Tacna en la Costa/Sierra Sur\\
	Ucayali y Huánuco en la Selva Central.\\
	07 Regiones crecen 2-6 semanas.
	Ayacucho sube (36.08\%) en siete de las últimas ochos semanas, Lima región sube (24.45\%) en ocho de las últimas nueve semanas, Tacna sube (17.14\%) en seis de las ultimas siete semanas, Huánuco sube (13.83\%)  en seis  de las últimas siete semanas.\\
	\textbf Que media: Tumbes (91.25\%), Áncash (73.77\%), Piura (72.60\%), Ayacucho (72.44\%), Lambayeque (62.63\%), Lima Metropolitana (60.16\%), La Libertad (56.58\%), Lima Región (51.96\%), Callao (51.57\%) y Arequipa (49.79\%)
	\\} 
	\vspace{0.01cm}
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.1,3.33) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 18 de diciembre del 2021.\\}
	\vspace{0.1cm}
	$\searrow$ Cusco se mantiene en la posición 16.
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.5,3.03) circle [x radius=2.0cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 18 de diciembre del 2021. \\} 
		\vspace{0.01cm}
		$\nearrow$ Cusco pasa al puesto 18.
...
\section{Indicadores Epidemiológicos, Región Cusco}
	...
	\begin{frame}[label=TipoPrueba]
		...
		\vspace{-.15cm}
		\begin{center}
			\includegraphics[width=0.7\linewidth, trim={0cm 0cm 0cm 0cm},clip]{../figuras/sinto_prueba_20_21.pdf}
		\end{center}
	\vspace{-.5cm}
		{\tiny Fuente de datos: SISCOVID, NOTICOVID.}\\
...
\begin{frame}
		...
		\vspace{-.5cm}
		\begin{center}
			\includegraphics[width=0.9\linewidth]{../figuras/positividad_pcr.pdf}
		\end{center}
		{\tiny Fuente de datos: SISCOVID, NOTICOVID.}
\end{frame}
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{center}
		\includegraphics[width=0.9\linewidth]{../figuras/positividad_ag.pdf}
	\end{center}
	{\tiny Fuente de datos: SISCOVID, NOTICOVID.}
\end{frame}
...
\begin{frame}
	...
	\end{center}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2021-12-18. Reporte de número reproductivo efectivo (Rt) de COVID-19. Disponible haciendo clic en el siguiente enlace: \href{https://www.dge.gob.pe/portalnuevo/informacion-publica/reporte-de-numero-reproductivo-efectivo-rt/}{CDC-Rt}. \\}
	\vspace{0.01cm}
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 50}}                                                   \\ \hline
	...
	-		\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_nouci.pdf}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 50}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 3                    & 3                  & 50\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 50}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						5                & 0                    & 5                  & 0\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 50}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						14               & 2                     & 12                   & 14\%                        \\ \hline
					\end{tabular}%
				}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		$\rightarrow$ Para la SE 50,las provincias de Anta, Espinar y Quispicanchi, reportaron defunciones por COVID-19 en la última semana epidemiológica en la región del \textbf{\color{mycolor5}Cusco}.
		
		$\rightarrow$ La provincia del \textbf{\color{mycolor5}Cusco} reporto \textbf{\color{mycolor5}Cero} defunciones por COVID-19 en la última semana epidemiológicas.
		
		$\rightarrow$ La provincia de Acomayo y Calca registran \textbf{\color{mycolor5}Cero} defunciones en las ultimas 9 semanas epidemiológicas		
...
\begin{frame}[label=resumen]
	...
	\vspace{-.5cm}
	\begin{itemize}
		\item La Región de Cusco se ubica en el \textbf{\color{mycolor4}octavo lugar} de \textbf{\color{mycolor3}mortalidad} acumulada a nivel nacional, con una índice de propagación de $1.08 $.
		\item Se ha mantenido estacionaria la \textbf{\color{mycolor4}desaceleración} en el número de \textbf{\color{mycolor3}casos sintomáticos} y defunciones por COVID-19.
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en \textbf{\color{mycolor4}descenso} con un $3\%$, manteniéndose en este rango durante las últimas diecisiete semanas. Mientras que la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares es del $13\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} es \textbf{\color{mycolor4} alta}, habiéndose mantenido en el rango de $69-75\% $ y mantenerse como tal durante las últimas 8 semanas. 
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, se ha mantenido entre $13-16\%$.
	\item Para la SE 50, predomina la variante delta en un $90\%$, del total de elegibles secuenciados, siendo las características de presentación clínica similares con las otras variantes.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item La mayoría de las provincias presentan desaceleración de casos y defunciones, a excepción de la provincia de Calca, Quispicanchi y Paucartambo, las que para la SE 50 presentan un leve incremento de casos. El exceso regional de mortalidad general es de -2.
