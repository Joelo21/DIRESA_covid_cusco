...
\begin{frame}[label=Resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad para pruebas moleculares} \textbf{\color{mycolor4}ascendió} al $25.2\%$ y la \textbf{\color{mycolor3}tasa de positividad de pruebas antigénicas} se mantiene en 31.6$\%$ \end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3} no UCI} \textbf{\color{mycolor3}ascendió al $78\%$ a nivel regional, un $4\%$ más a la semana previa}.
	\item La ocupación de camas \textbf{\color{mycolor3} UCI}, \textbf{\color{mycolor4}descendió al $27\%$, un $4\%$ menos a la semana previa}. 
	\item Para la SE 51, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana, manteniéndose la presencia de sublinajes como XBB y BQ1 y BQ1.1.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE51, la provincia de Cusco, la Convención, Quispicanchis y Canchis mantienen desaceleración en el número de casos, con elevadas tasas de positividad. Las defunciones aun se encuentran bajas.
		\end{itemize}
	\end{itemize}
\end{frame}
%
