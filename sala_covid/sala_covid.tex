...
\begin{document}
	...
	\vspace{0.01cm}
	$\rightarrow$ 12 casos Omicrón, posible transmisión comunitaria. \\
	$\rightarrow$ Delta >99\%, mantiene muy alto.\\
	$\rightarrow$ Casi desapareció 2\% de Gamma y Lambda.\\
	$\rightarrow$ Resultados de 2-3 semanas atrás. Vacíos en 10 regiones.	
\end{frame}

\begin{frame}
	\frametitle{Proporción de Personas Vacunadas Mayores de 12 años Contra la Covid19 en el Perú}
	\vspace{-.5cm}
	\begin{center}
...
\begin{frame}
		...
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 18 de diciembre del 2021.\\}
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,274 $ defunciones por COVID-19 por millón de habitantes. \\
	\end{frame}
...
\end{center}
\begin{tikzpicture}[overlay]
	\draw[mycolor2, ultra thick] (5.3,3.58) circle [x radius=3.8cm, y radius=.2cm, rotate=0];
\end{tikzpicture}
...
\textbf{Riesgos}:Cinco alzas nacionales seguidas.\\
				Gran alza en Lima metropolitana, séptima alza en 12 semanas, máximo en 16 semanas.\\
				Ica iguala su máximo valor en 17 semanas.Junín alcanza su máximo valor en 16 semanas.\\
				Lambayeque, máximo en 20 semanas. Ya circula omicrón en la comunidad.\\
				Mortalidad sube en 60-69 y 70+ años.\\			
\textbf{Estancamiento}:Sólo Lima metropolitana e Ica suben >7, 10 regiones no varían (±1), tres crecen mínimamente (2)\\
					   Ninguna región sube fuerte (>14), No hay alza exponencial (aún)\\}
\vspace{0.01cm}
$\rightarrow$ {\color{mycolor5}Cusco}: Las defunciones representan un $2.53\% $ del pico de la segunda ola.\\
\end{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 18 de diciembre del 2021. \\
	\textbf Nota 1: Perú: 1037 camas libres,sube 5-2\%, Lima: 306 camas libres, subió 12.1\%. \\
	\textbf Suben:{*} Cajamarca, San Martín, Huánuco, Junin, Ucayali y Madre de Dios en regiones con área amazónica Piura y La Libertad en costa norte Ica y Moquegua en la costa sur.\\
	Cuatro regiones crecen 2-4 semanas\\
	Huánuco creció cuatro semanas seguidas y 20.13\% en siete de las últimas ocho.\\
	Ucayali creció dos semanas después de tener 0\% de ocupación por seis semanas.\\
	Piura creció 22.86\% durante ocho de las últimas 12 semanas.\\
	\textbf Que media: Tumbes (91.03\%), Piura (74.70\%), Áncash (68.98\%), Lima Metropolitana (58.03\%), Libertad (57.26\%), Lambayeque (53.21\%), Ayacucho (52.68\%), Callao (49.46\%) y Arequipa (47.63\%)\\
	Todos menos Ayacucho en la costa. Sólo tres suben esta semana.\\} 
	\vspace{0.01cm}
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.1,3.48) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 18 de diciembre del 2021.\\}
	\vspace{0.1cm}
	$\searrow$ Cusco se baja a la posición 15.
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.5,3.17) circle [x radius=2.0cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 18 de diciembre del 2021. \\} 
		\vspace{0.01cm}
		$\nearrow$ Cusco pasa al puesto 17.
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		$\rightarrow$ Para la SE 50,las provincias de Calca, Chumbivilcas, \textbf{\color{mycolor5}Cusco} y Espinar, reportaron defunciones por COVID-19 en la última semana epidemiológica en la región del \textbf{\color{mycolor5}Cusco}.
		
		$\rightarrow$ La provincia del \textbf{\color{mycolor5}Cusco} reporto \textbf{\color{mycolor5}Una} defunción por COVID-19 en la última semana epidemiológicas.
		
		$\rightarrow$ La provincia de Acomayo y Urubamba registran \textbf{\color{mycolor5}Cero} defunciones en las ultimas 9 semanas epidemiológicas		
