...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 16, las provincias de la region del Cusco registraron \textbf{\color{mycolor5} cero} defunciones por COVID-19 a excepción del \textbf{\color{mycolor5}Cusco} y Chumbivilcas. \\
