...
\begin{frame}[label=Resumen]
	...
	\begin{itemize}
		...
		\item A la presente SE 50, se presenta \textbf{\color{mycolor4} desaceleración} en el número de \textbf{\color{mycolor3}casos}, aún con tenedencia al ascenso de hospitalizaciones, y defunciones bajas.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE50, la provincia de Cusco, la Convención, Quispicanchis y Canchis mantienen desaceleración en el número de casos, con elevadas tasas de positividad. Las defunciones aun se encuentran bajas.
		\end{itemize}
	\end{itemize}
\end{frame}
%
