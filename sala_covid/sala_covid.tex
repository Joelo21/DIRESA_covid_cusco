...
\begin{document}
	...
	\begin{figure}
		...
		\end{subfigure}
	\end{figure}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 05 de Febrero del 2022.\\} 
	\vspace{0.01cm}
	$\rightarrow$ 100\% ómicron en Lima y Callao en la SE04, 48 y 7 muestras respectivamente.\\
	$\rightarrow$ Omicrón: 128/128=100\% de muestras del país en SE04.\\
	$\rightarrow$ Resultados de 2-3 semanas atrás. Vacíos en 10 regiones.\\	
\end{frame}

\begin{frame}[label=epi_nacional]
	\frametitle{Casos nacionales bajan 50.5\%, vuelta en U?}
	\vspace{.1cm}
	\begin{figure}
		\centering
		...
		\draw[mycolor2, thick] (-2.05,3.72) circle [x radius=2.5cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		\hfill
	...
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 05 de Febrero del 2022.\\} 
	\vspace{0.01cm}
	$\rightarrow$ Sólo sube Tumbes, 32.6\%, crece siete semanas\\
	$\rightarrow$ La costa y Amazonía caen más fuertemente.\\
	$\rightarrow$ Diez regiones bajan >10\%.\\
	
\end{frame}

\begin{frame}[label=epi_nacional]
	\frametitle{Positividad antigénica cae 11.06\%, segunda y fuerte baja}
	\vspace{-.1cm}
	\begin{figure}
		\centering
		\begin{subfigure}[b]{0.35\textwidth}
		...
		\end{subfigure}
		\begin{tikzpicture}[overlay]
			\draw[mycolor2, thick] (-2.10,3.98) circle [x radius=2.4cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		\hfill
	...
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 05 de Febrero del 2022.\\} 
	\vspace{0.01cm}
		$\rightarrow$ Frenada simultánea de casi todo el país da que pensar, podría ser artificial?\\
\end{frame}
...
%	\end{tikzpicture}
	{\tiny Fuente:REUNIS (Repositorio Único Nacional de Información en Salud). Consultado el 05 de Febrero del 2022.\\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 05 de Febrero del 2022.\\}
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,365 $ defunciones por COVID-19 por millón de habitantes. \\
	\end{frame}
...
\textbf{Riesgos}:\\
			Costa sur sube 76\%, tasa >7 fallecidos diarios x millón desde Ica.\\	
			15 regiones suben.\\
			Costa norte sube tres semanas.\\
			Sierra/selva centro y norte sube >23\%. \\
\textbf{Menor Riesgo}:Lima/Callao y costa central bajan.\\
					 Amazonía con tasas ~1.25.\\
					 Sierra selva sur casi no sube.\\}
\vspace{0.01cm}
$\rightarrow$ {\color{mycolor5}Cusco}: Las defunciones representan un $20.75\% $ del pico de la segunda ola.\\
\end{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 05 de Febrero del 2022. \\
	\textbf Nota 1: Perú: 852 camas libres, bajó 3.6\%, Lima 255 camas libres, bajó 7.6\%\\
	\textbf No Suben:* Amazonia: Amazonas, Loreto y Ucayali.\\
	Costa norte: Piura, Lambayeque y Huancavelica.\\
	Suben 20 regiones, 17 suben 2-5 semanas.\\
	Moquegua sube 55\% en 7/9 sem. Puno sube 42\% en 6 sem.\\
	Huánuco sube 36\% en 4 sem. Junín sube 35\% en 7/8 sem. Ayacucho sube 30\% en 6 sem.\\
	\textbf Que media: Tumbes (100.0\%), Ancash (78.6\%), Ayacucho (76.2\%), Lambayeque (73.5\%), Piura (72.4\%), Lima Región (71.4\%), Puno (70.5\%), Huánuco (68.7\%), Loreto (67.1\%), Lima metropolitana (66.8\%), La Libertad (65.2\%) y Moquegua (61.6\%) \\
	Nueve de estas 12 regiones suben} \\
	\vspace{0.01cm}
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.1,2.72) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 05 de Febrero del 2022.\\}
	\vspace{0.1cm}
	$\searrow$ Cusco baja a la posición 20.
\end{frame}
