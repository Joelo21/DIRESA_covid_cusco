...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 29 de Enero del 2022}}
...
\date{Semana Epidemiológica 04, 2022}
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 04}}                                                   \\ \hline
	...
	-		\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_nouci.png}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 04}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 4                    & 1                  & 67\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 04}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						5                & 4                    &1                   & 80\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 04}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						14               & 9                     & 5                   & 64\%                        \\ \hline
					\end{tabular}%
				}
...
\begin{frame}[label=resumen]
	...
	\begin{itemize}
		...
		\item Existe un \textbf{\color{mycolor4}crecimiento} en el número de \textbf{\color{mycolor3}casos} COVID-19, con una pequeña inflexión de descenso en la última semana, con ascenso en el número de hospitalizados y de defunciones, sin embargo este último indicador aun se mantiene en el área verde del semáforo epidemiológico, que indica bajo riesgo.
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en  \textbf{\color{mycolor4}ascenso} con un $44\%$, así como la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares también creció hasta un $39\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}aumentó} a $81\% $ a nivel regional. 
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, aumentó a $47\%$, con un crecimiento más acelerado para esta semana.
	\item Para la SE 02, predomina la variante ómicron en un $87\%$, del total de muestras secuenciadas por semana, siendo las características de presentación clínica similares con las otras variantes, con casos de presentación leve en su mayoría.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE03, todas las provincias, a excepción de la provincia de Cusco y Urubamba presentan un crecimiento exponencial en el número de casos. Las provincias de Canchis, Canas y Espinar presentan el mayor crecimiento de casos.
