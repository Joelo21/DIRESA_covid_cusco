...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 22 de Enero del 2022}}
...
\date{Semana Epidemiológica 03, 2022}
...
\begin{document}
	...
	\begin{figure}
		...
		\end{subfigure}
	\end{figure}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 22 de enero del 2022.\\} 
	\vspace{0.01cm}
	$\rightarrow$ 17.2\% omicrón en Lima en la SE01, 29 muestras.\\
	$\rightarrow$ Callao muy pocas muestras.\\
	$\rightarrow$ Omicrón: 122/181=67\% de las muestras del país en la SE01, el resto son Delta.\\
	$\rightarrow$ Resultados de 2-3 semanas atrás. Vacíos en 10 regiones.\\	
\end{frame}

\begin{frame}[label=epi_nacional]
	\frametitle{Casos Nacionales suben 183\%, nuevo record de pandemia}
	\vspace{.1cm}
	\begin{figure}
		\centering
		\begin{subfigure}[b]{0.42\textwidth}
		...
		\draw[mycolor2, thick] (-2.40,3.45) circle [x radius=2.5cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		\hfill
		...
		\end{subfigure}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, ultra thick] (1.20,3.70) circle [x radius=.47cm, y radius=.47cm, rotate=0];
		\end{tikzpicture}
	\end{figure}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 22 de enero del 2022.\\} 
	\vspace{0.01cm}
	$\rightarrow$ Suben todas las regiones, 19 suben > 200\%.\\
	$\rightarrow$ Mayores subidas esta semana: Loreto (1034\%), Puno (476\%), Huancavelica (436\%), San Martín (370\%), Apurímac (360\%) y Ayacucho (348\%), en la Amazonía y sierra centro/sur.\\
\end{frame}

\begin{frame}[label=epi_nacional]
	\frametitle{Positividad antigénica subió 13.89\%, alza porcentual de 152\%}
	\vspace{-.1cm}
	\begin{figure}
		\centering
		...
		\end{subfigure}
		\begin{tikzpicture}[overlay]
			\draw[mycolor2, thick] (-2.10,3.78) circle [x radius=2.4cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		\hfill
		\begin{subfigure}[b]{0.60\textwidth}
			\centering
			\includegraphics[width=\textwidth]{../sala_nacional/Casos_Nacionales_3ra_ola_03.png}
			%\label{fig:70 a 79 años}
		\end{subfigure}
		\begin{tikzpicture}[overlay]
			\draw[mycolor2, ultra thick] (-4.70,3.65) circle [x radius=.50cm, y radius=.50cm, rotate=0];
		\end{tikzpicture}
	\end{figure}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 22 de enero del 2022.\\} 
	\vspace{0.01cm}
	$\rightarrow$ Mayores incrementos: San Martín (25.7\%), Loreto (25.6\%), Puno (24.0\%), Ayacucho (19.3\%) y Lambayeque (18.18\%), sin un foco geográfico.\\
\end{frame}
...
%	\end{tikzpicture}
	{\tiny Fuente:REUNIS (Repositorio Único Nacional de Información en Salud). Consultado el 22 de enero del 2022.\\} 
	\vspace{0.01cm}
...
\textbf{Riesgos}:\\
			Lima metropolitana, Callao y Lima región duplican, tasas > 2.0.\\
				Fallecidos subirán verticalmente? \\
				2-3 semanas de alza en varias regiones.\\
				Cinco regiones con records en 20+ semanas.\\
				La mitad del país con tasas > 1.0.\\
				Bajadas muy leves.\\		
\textbf{Estancamiento}:Mitad de regiones baja o se mantiene.\\
					  Costa norte no sube.\\}
\vspace{0.01cm}
$\rightarrow$ {\color{mycolor5}Cusco}: Las defunciones representan un $10.69\% $ del pico de la segunda ola.\\
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, ultra thick] (5.35,4.15) circle [x radius=3.4cm, y radius=.18cm, rotate=0];
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2022-01-22.\\}
	\vspace{0.01cm}
	...
	$\nearrow$ Cusco se encuentra a la posición 10 con un RT de $1.40$ $ [1.36-1.44]$.
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 22 de enero del 2022. \\
	\textbf Nota 1: Perú: 1008 camas libres, bajó 5.9\%,Lima: 341 camas libres, bajó 5.0\%\\
	\textbf Suben:* Norte: Piura, Lambayeque y San Martín.\\
	Costa central: Lima región, Lima metropolitana, Callao y Ica.\\
	Selva baja: Loreto y Ucayali. Sierra/selva central: Huánuco y Junín.\\
	Sur: Ayacucho, Cusco, Moquegua y Tacna. Once regiones suben 2-5 semanas\\
	Loreto sube 75\% en 3 de 4 semanas, sin camas disponibles. Lima región sube 33.8\% en 8 / 11 semanas.\\
	Ayacucho sube 25.1\% en 3 semanas, Lambayeque sube 23.9\% en 6 / 8 s, Ucayali sube 19.8\% en seis semanas.\\
	\textbf Que media: Tumbes (87.3\%), Loreto (75.0\%), Ayacucho (70.8\%), Piura (70.3\%), Lambayeque (66.7\%), Ancash (66.4\%) y Lima región (61.3\%), entre otras.\\
	Cinco de estas suben.\\} 
	\vspace{0.01cm}
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.1,3.32) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 22 de enero del 2022.\\}
	\vspace{0.1cm}
	$\searrow$ Cusco baja a la posición 16.
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.8,2.55) circle [x radius=2.8cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 22 de enero del 2022. \\} 
		\vspace{0.01cm}
		$\nearrow$ Cusco baja a la posición 21.
...
\section{Indicadores Epidemiológicos, Región Cusco}
	...
	\begin{frame}
		...
		\vspace{-.5cm}
		\begin{center}
			\includegraphics[width=0.8\linewidth]{../figuras/sintomaticos_20_21_22.pdf}
		\end{center} 
...
\begin{frame}
	...
	\end{center}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2022-01-22. Reporte de número reproductivo efectivo (Rt) de COVID-19. Disponible haciendo clic en el siguiente enlace: \href{https://www.dge.gob.pe/portalnuevo/informacion-publica/reporte-de-numero-reproductivo-efectivo-rt/}{CDC-Rt}. \\}
	\vspace{0.01cm}
...
%		\vspace{-.5cm}
%		\begin{center}
%			\includegraphics[width=0.9\linewidth]{../figuras/exceso_region_21_22.pdf}
%		\end{center}
%		{\tiny Fuente de datos: SINADEF.} 
%	\end{frame}
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 03}}                                                   \\ \hline
	...
	-		\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_nouci.pdf}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 03}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 5                    & 1                  & 83\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 03}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						5                & 5                    &0                   & 100\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 03}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						14               & 11                     & 3                   & 79\%                        \\ \hline
					\end{tabular}%
				}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		$\rightarrow$ Para la SE 02, la provincia de Canchis reporto \textbf{\color{mycolor5}una} defunción por COVID-19 en la última semana epidemiológica en la región del \textbf{\color{mycolor5}Cusco}.
		...
		$\rightarrow$ La provincia de Acomayo, La Convención y Paruro registran \textbf{\color{mycolor5}cero} defunciones en las ultimas 9 semanas epidemiológicas.	
...
\begin{frame}[label=resumen]
	...
	\begin{itemize}
		...
		\item Existe un \textbf{\color{mycolor4}crecimiento acelerado} en el número de \textbf{\color{mycolor3}casos} COVID-19, más el número de defunciones aún es bajo.
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en gran \textbf{\color{mycolor4}ascenso} con un $42\%$, así como la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares también creció hasta un $35\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}aumentó} a $78\% $ a nivel regional. 
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, aumentó a $31\%$.
	\item Para la SE 02, predomina la variante ómicron en un $77\%$, del total de muestras secuenciadas por semana, siendo las características de presentación clínica similares con las otras variantes, con casos de presentación leve en su mayoría.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Tasa de crecimiento semanal de \textbf{\color{mycolor4}casos} en \textbf{\color{mycolor3}rojo}.
			\item Tasa de crecimiento semanal de \textbf{\color{mycolor4}defunciones} en \textbf{\color{mycolor3}verde}.
			\item Tasa de \textbf{\color{mycolor4}positividad} de pruebas \textbf{\color{mycolor4}antigénicas} en \textbf{\color{mycolor3}rojo} y de prueba moleculares en \textbf{\color{mycolor3}rojo}.
		...
		\begin{itemize}
			\item Para la SE02, todas las provincias presentan un crecimiento exponencial en el número de casos. Las provincias de Cusco, Urubamba y La Convención, presentan el mayor crecimiento de casos, seguidas de Canchis y Anta. 
