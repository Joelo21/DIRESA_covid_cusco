...
\begin{frame}[label=epi_nacional]
	...
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 12 de Febrero del 2022.\\} 
	\vspace{0.01cm}
	$\rightarrow$ Sólo sube Tumbes, 2.3\%, crece ocho semanas\\
	$\rightarrow$ La costa y Amazonía caen más fuertemente.\\
	$\rightarrow$ Todas las regiones menos Tumbes crecen >25\%.\\
	
\end{frame}

\begin{frame}[label=epi_nacional]
	\frametitle{Positividad antigénica cae 11.06\%, tercera y fuerte baja}
	\vspace{-.1cm}
	\begin{figure}
		\centering
		\begin{subfigure}[b]{0.35\textwidth}
	...
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 12 de Febrero del 2022.\\} 
	\vspace{0.01cm}
		$\rightarrow$ Todas las regiones bajan por al menos dos semanas.\\
\end{frame}
...
\textbf{Riesgos}:\\
			3 Regiones suben.\\	
			Solo Ancash sube >=7 fallecidos.\\
			Madre de Dios y Tumbes en frontera, las tasas más altas.\\
\textbf{Menor Riesgo}:Todas las macro-regiones bajan >13.0\%.\\
					Las DIRIS bajan también y todos los grupos etarios.\\
					Costa centro, sierra/selva norte bajan >26.0\%.\\
					Lima y Callao bajan 29.4\% y 54.8\%, respectivamente.\\}
\vspace{0.01cm}
...
\end{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 12 de Febrero del 2022. \\
	\textbf Nota 1: 904 camas libres, subió 6.1\% -  300 camas libres, subió 17.6\%
	\\
	\textbf No Suben:* Costa centro: Ancash, Ica, Callao, Lima metropolitana y Lima región.\\
	Sierra centro: Pasco y Huánuco.Amazonía: Loreto, Lambayeque y Ayacucho. \\
	Suben 16 regiones, 12 suben 2-5 semanas.\\
	Moquegua sube 60\% en 8/10 sem. Puno sube 43\% en 7 sem. Junín sube 36\% en 8/9 sem. \\
	Tacna sube 28\% en 6 sem. Arequipa sube 19\% en 4 sem. La Libertad sube 19\% en 6/7 sem. \\
	\textbf Que media: Tumbes (100.0\%), Ancash (78.2\%), Ayacucho y Piura (76.2\%), Puno (71.3\%), Lambayeque(70.8\%), Huánuco (67.0\%), Moquegua (66.2\%), Lima metropolitana (63.3\%), Arequipa (63.1\%), Cusco (62.9\%) y Lima región (58.1\%)\\
	Seis de estas 12 regiones suben.} \\
	\vspace{0.01cm}
...
\section{Indicadores Epidemiológicos, Región Cusco}
	\begin{frame}
		...
		\vspace{-.5cm}
		\begin{center}
			\includegraphics[width=0.9\linewidth]{../figuras/sintomaticos_20_21_22.png}
		\end{center} 
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 06}}                                                   \\ \hline
	...
	-		\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_nouci.png}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 06}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 5                    & 1                  & 67\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 06}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						5                & 2                    & 3                   & 40\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 06}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						14               & 8                     & 6                   & 57\%                        \\ \hline
					\end{tabular}%
				}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		$\rightarrow$ Para la SE 05, la provincia de Calca, Canchis, Chumbivilcas, La Convencion reportaron defunción por COVID-19 en la última semana epidemiológica en la región del \textbf{\color{mycolor5}Cusco}.
		
		$\rightarrow$ La provincia del \textbf{\color{mycolor5}Cusco} reporto \textbf{\color{mycolor5}cuatro} defunciones por COVID-19 en la última semana epidemiológica.
		
		$\rightarrow$ La provincia de Acomayo, Anta, Canas, Espinar, Paruro, Paucartambo, Quispicanchis y Urubamba registran \textbf{\color{mycolor5}cero} defunciones en la ultima semana epidemiológica.	
