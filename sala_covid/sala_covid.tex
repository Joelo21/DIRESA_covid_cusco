...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 03 de Diciembre del 2022}}
...
\date{Semana Epidemiológica 48, 2022}
...
\begin{frame}
	...
	\end{center}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2022. Actualización: 2022-12-05. Reporte de número reproductivo efectivo (Rt) de COVID-19. Disponible haciendo clic en el siguiente enlace: \href{https://www.dge.gob.pe/portalnuevo/informacion-publica/reporte-de-numero-reproductivo-efectivo-rt/}{CDC-Rt}. \\}
	\vspace{0.01cm}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 48}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						0               & 0                     & 0                   & 0\%                        \\ \hline
					\end{tabular}%
				}
...
\section{Indicadores por Provincias}
	...
	{\tiny Fuente de datos: SINADEF - NOTICOVID. \\}
	\vspace{0.2cm}
	$\rightarrow$ Para la SE 48, la provincia del \textbf{\color{mycolor3}Cusco} registró \textbf{\color{mycolor3}cero} defunciónes por COVID-19.\\
