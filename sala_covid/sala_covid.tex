...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 23 de Abril del 2022}}
...
\date{Semana Epidemiológica 16, 2022}
...
%	\end{tikzpicture}
	{\tiny Fuente:REUNIS (Repositorio Único Nacional de Información en Salud). Consultado el 23 de Abril del 2022.\\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 23 de Abril del 2022.\\}
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,444 $ defunciones por COVID-19 por millón de habitantes. \\
		\end{frame}
...
\textbf{Riesgos}:\\
			Suben >=2 fallecidos La Libertad y Tacna(3).\\
			Costa Sur y Sierra/Selva Norte suben >=2 fallecidos.\\
\textbf{Menor Riesgo}: \\
			24 Regiones y todas la DIRIS bajan o se estancan.\\
			Todos los grupos etarios bajan o se estacan excepto 60-69 años.\\			
			}
\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2022. Actualización: 2022-04-23.\\}
	\vspace{0.01cm}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 23 de Abril del 2022. \\
	\textbf Nota 1: Perú: 1151 camas libres, bajo 2.3\% -  Lima: 466 camas libres, bajo 5.3\%
	\\
	\textbf Suben*: \\
	Costa centro: Lima Región e Ica.\\
	Costa y Sierra Sur: Cusco, Apurimac, Arequipa, Moquegua y Tacna.\\
	Amazonia: Amazonas, San Martin, Loreto y Ucayali. -  Sierra Centro: Pasco.\\ 
	\textbf Suben cinco regiones por 2-3 semanas*: \\
	Amazonas sube 40.00\% en 2 semanas. - Lima región sube 5.39\% en 2 semanas.\\
	Loreto sube 18.18\% en 2 semanas. - San Martin sube 5.19\% en 3 semanas. - Ucayali sube 5.00\% en 2 semanas.\\
	\textbf >Que media: \\
	La Libertad (57.6\%), Cusco (55.0\%), Loreto (54.6\%), Tumbes (47.2\%), Callao (43.3\%), Ancash (39.1\%), Piura (25.3\%), Arequipa (24.7\%) y Lambayeque (22.8\%).\\ 
	Solo dos de estas 9 regiones suben esta semana.
} 
	\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.8,3.19) circle [x radius=2.8cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 23 de Abril del 2022. \\} 
		\vspace{0.01cm}
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			...
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 16}}                                                   \\ \hline
	...
	-		\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_nouci.png}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 16}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 4                    & 2                  & 64\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 16}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						5                & 1                    & 4                  & 23\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 16 }}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						14               & 0                     & 14                   & 0\%                        \\ \hline
					\end{tabular}%
				}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 16, las provincias de la region del Cusco registraron \textbf{\color{mycolor5} cero} defunciones por COVID-19 a excepción de La Convención.\\
...
\begin{frame}[label=resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en  \textbf{\color{mycolor4}descenso} con un $0.9\%$, así como la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares también se mantienen en descenso con un $1.5\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}disminuyó} al $63\%$ a nivel regional. Lográndose el primer descenso de hospitalizados a nivel de UCI.
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}incrementó} a $8\%$.
	\item Para la SE 16, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana, siendo las características de presentación clínica similares con las otras variantes, con casos leves en la presentación clínica.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE16, todas las provincias permanecen en descenso marcado de casos y fallecidos.
