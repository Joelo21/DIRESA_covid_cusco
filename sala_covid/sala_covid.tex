...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		$\rightarrow$ Para la SE 47,En todas las provincias de la región del \textbf{\color{mycolor5}Cusco} se reportaron \textbf{\color{mycolor5}cero} defunciónes por COVID-19 en la ultima semana.
		
		$\rightarrow$ La provincia de Acomayo y Calca registra \textbf{\color{mycolor5}cero} defunciones en las ultimas 9 semanas epidemiológicas
...
\begin{frame}[label=resumen]
	...
	\begin{itemize}
		...
		\item Se ha mantenido constante la \textbf{\color{mycolor4}desaceleración} en el número de \textbf{\color{mycolor3}casos sintomáticos} y defunciones por COVID-19.
		...
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en mayor \textbf{\color{mycolor4}descenso} con un $4.2\%$, manteniéndose en este rango durante las últimas catorce semanas. Mientras que, la \textbf{\color{mycolor3}tasa de positividad} para pruebas moleculares se mantuvo en $11.4\%$ para la SE46.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} es \textbf{\color{mycolor4} media}, a pesar de haber disminuido a un $69\% $ y mantenerse como tal durante las últimas 5 semanas. 
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, tuvo un pequeño ascenso hasta $15\%$, siendo el \textbf{Hospital Antonio Lorena} el que presenta la mayor ocupación a nivel regional con un $41\%$  
	\item Para la SE 46, las variantes secuenciadas de COVID-19, muestran un incremento de la variante delta a un $90\%$, siendo las características de presentación clínica similares con las otras variantes.
