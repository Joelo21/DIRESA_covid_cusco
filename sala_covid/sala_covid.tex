...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 24 de Diciembre del 2022}}
...
\date{Semana Epidemiológica 51, 2022}
...
\begin{frame}
	...
	\end{center}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2022. Actualización: 2022-12-26. Reporte de número reproductivo efectivo (Rt) de COVID-19. Disponible haciendo clic en el siguiente enlace: \href{https://www.dge.gob.pe/portalnuevo/informacion-publica/reporte-de-numero-reproductivo-efectivo-rt/}{CDC-Rt}. \\}
	\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			...
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 49 Datos actualizados 	}}                                                   \\ \hline
	...
	\begin{frame}
		\frametitle{Total y Ocupación de Camas Hospitalarias en el Nivel III, 2021-20222.}
		\vspace{-.5cm}
		\begin{center}
...
\section{Indicadores por Provincias}
	...
	{\tiny Fuente de datos: SINADEF - NOTICOVID. \\}
	\vspace{0.2cm}
	$\rightarrow$ Para la SE 51, la provincia del \textbf{\color{mycolor3}Cusco} registró \textbf{\color{mycolor3}cero} defunciónes por COVID-19.\\
	$\rightarrow$ La Provincia de Calca registra \textbf{\color{mycolor3}una} defunción por COVID-19.\\
	%		$\rightarrow$ Las demás provincias de la región del Cusco registraron \textbf{\color{mycolor5}cero} defunciónes por COVID-19.
\end{frame}
...
\begin{frame}[label=Resumen]
	...
	\begin{itemize}
		...
		\item A la presente SE 51, se presenta \textbf{\color{mycolor4} desaceleración} en el número de \textbf{\color{mycolor3}casos}, aún con tenedencia al ascenso de hospitalizaciones, y defunciones bajas.
		\item La \textbf{\color{mycolor3}tasa de positividad para pruebas moleculares} \textbf{\color{mycolor4}ascendió} al $33.1\%$ y la \textbf{\color{mycolor3}tasa de positividad de pruebas antigénicas} descendió a 24.7$\%$ \end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3} no UCI} \textbf{\color{mycolor3}descendió al $70\%$ a nivel regional, un $8\%$ menos a la semana previa}.
	\item La ocupación de camas \textbf{\color{mycolor3} UCI}, \textbf{\color{mycolor4}ascendió al $33\%$, un $6\%$ más a la semana previa}. 
	\item Para la SE 51, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Tasa de crecimiento semanal de \textbf{\color{mycolor4}casos} sintomáticos se encuentra en \textbf{\color{mycolor3}verde}.
			\item Tasa de crecimiento semanal de \textbf{\color{mycolor4}defunciones} en \textbf{\color{mycolor3}verde}.
			\item Tasa de \textbf{\color{mycolor4}positividad} de  \textbf{\color{mycolor4}pruebas moleculares} en \textbf{\color{mycolor3}rojo}, mientras que la de \textbf{\color{mycolor4}pruebas antigénicas} se encuentra en \textbf{\color{mycolor3}ámbar}
		...
		\begin{itemize}
			\item Para la SE51, todas las provincias presentan un descenso en el recuento de casos por COVID-19, siendo la provincia de Quispicanchis la uqe presenta la menor desaceleración.
		\end{itemize}
	\end{itemize}
\end{frame}
%
