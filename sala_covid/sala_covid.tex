...
%	\end{tikzpicture}
	{\tiny Fuente:R EUNIS (Repositorio Único Nacional de Información en Salud). Consultado el 19 de Febrero del 2022.\\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 19 de Febrero del 2022.\\}
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,305 $ defunciones por COVID-19 por millón de habitantes. \\
		\end{frame}
...
\textbf{Riesgos}:\\
			3 Regiones suben >=3 fallecidos.\\	
			Fallecidos en Callao suben muy levemente.\\
			Tasas de fallecidos mas altas en Moquegua, Tacna y Tumbes >6.20.\\
\textbf{Menor Riesgo}:Todas las macro-regiones bajan >19.0\%.\\
					Las DIRIS bajan también y todos los grupos etarios.\\
					Costa centro y norte >40.0\%.\\
					Lima metropolitana baja 47.0\%.\\}
\vspace{0.01cm}
$\rightarrow$ {\color{mycolor5}Cusco}: Las defunciones representan un $17.72\% $ del pico de la segunda ola.\\
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, ultra thick] (4.15,3.50) circle [x radius=.50cm, y radius=.50cm, rotate=0];
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 19 de Febrero del 2022. \\
	\textbf Nota 1: 946 camas libres, subió 4.6\% -  326 camas libres, subió 8.7\%
	\\
	\textbf Suben: Sierra Centro: Huánuco y Huancavelica. \\
	Sierra/Selva Norte: Amazonas y Cajamarca. \\
	Sur: Apurimac y Tacna.\\
	Amazonia: Ucayali.\\
	Suben siete regiones, tres suben 2-7 semanas. \\
	Tacna sube 32\% en 7 sem. Cajamarca sube 23\% en 4 sem. Apurimac sube 18\% en 3 sem.\\
	\textbf Que media: Tumbes (94.2\%), Ancash (77.4\%), Ayacucho (70.2\%), Lambayeque (70.1\%), Huánuco (67.5\%).\\ 
	 Piura (66.3\%), Puno (63.7\%), La Libertad (63.2\%), Moquegua (62.9\%), Arequipa (62.2\%), Cusco (61.6\%) y Lima metropolitana (57.2\%).\\ } 
	\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.8,3.05) circle [x radius=2.8cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 19 de Febrero del 2022. \\} 
		\vspace{0.01cm}
		$\nearrow$ Cusco sube a la posición 18.
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 07, las provincias de Acomayo, Calca y Paucartambo registraron \textbf{\color{mycolor5}cero} defunciones por COVID-19.
					
		$\rightarrow$ La provincia de \textbf{\color{mycolor5}Cusco}, registro \textbf{\color{mycolor5}ocho} defunciones en la última semana epidemiológica.	
