...
\begin{frame}[label=resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en gran \textbf{\color{mycolor4}ascenso} con un $22\%$, así como la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares también creció hasta un $36\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}aumentó} en un $15\% $ a nivel regional. 
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, aumentó en un $11\%$.
	\item Para la SE 01, predomina la variante delta en un $90\%$, del total de muestras secuenciadas por semana, siendo las características de presentación clínica similares con las otras variantes.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE01, la provincia de Cusco ha presentado un crecimiento exponencial en el número de casos, asimismo la provincia de Urubamba presenta un crecimiento gradual de casos. 
