...
\begin{frame}
	\frametitle{Tabla por Defunciones y Tasa de Letalidad Perú, 2020 - 2022}
	\vspace{-1.0cm}
	\begin{table}[]
		\resizebox{\textwidth}{!}{%
...
\begin{frame}[label=resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en  \textbf{\color{mycolor4}descenso} con un $3.1\%$, así como la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares también se mantienen en descenso con un $5.4\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}incrementó} al $86\% $ a nivel regional
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}disminuyó} a $10\%$.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE10, todas las provincias permanecen en  descenso marcado de casos y fallecidos por quinta semana consecutiva.
