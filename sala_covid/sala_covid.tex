...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		$\rightarrow$ Para la SE 04, la provincia de Canchis reporto \textbf{\color{mycolor5}una} defunción por COVID-19 en la última semana epidemiológica en la región del \textbf{\color{mycolor5}Cusco}.
