...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 09 de Abril del 2022}}
...
\date{Semana Epidemiológica 14, 2022}
...
%	\end{tikzpicture}
	{\tiny Fuente:REUNIS (Repositorio Único Nacional de Información en Salud). Consultado el 09 de Abril del 2022.\\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 09 de Abril del 2022.\\}
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,442 $ defunciones por COVID-19 por millón de habitantes. \\
		\end{frame}
...
\textbf{Riesgos}:\\
			5 regiones suben >=2 fallecidos. \\
			DIRIS Centro sube levemente. \\
			Macro-región sierra/selva central sube 3 fallecidos. \\
\textbf{Menor Riesgo}: \\
			Todas las macro-regiones, menos sierra centro, bajan o se estancan. \\
			Grupos etarios >25 años bajan >10. \\
			}
\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, ultra thick] (5.35,2.55) circle [x radius=3.4cm, y radius=.18cm, rotate=0];
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2022. Actualización: 2022-04-09.\\}
	\vspace{0.01cm}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 09 de Abril del 2022. \\
	\textbf Nota 1: Perú:1193 camas libres, subió 1.4\% -  Lima: 493 camas libres, subió 2.1\%
	\\
	\textbf Suben*: \\
	Costa norte: La Libertad y Lambayeque.\\
	Amazonia: Ucayali y San Martin.\\
	Sierra Sur: Huancavelica.\\
	\textbf Solo sube una región por 3 semanas \\
	La Libertad sube 11.85\%.\\
	\textbf Que media:La Libertad (64.6\%), Ancash (57.0\%), Cusco (54.3\%), Tumbes (50.0\%), Callao (44.9\%), Loreto (36.4\%), Piura (30.5\%), Puno (30.0\%), Huánuco (27.8\%), Moquegua (26.7\%), y Arequipa (26.1\%)\\ 
	Solo una de estas 11 regiones suben esta semana.
} 
	\vspace{0.01cm}
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.6,2.09) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 09 de Abril del 2022.\\}
	\vspace{0.1cm}
	$\searrow$ Cusco sube a la posición 26.
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.8,3.80) circle [x radius=2.8cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 09 de Abril del 2022. \\} 
		\vspace{0.01cm}
		$\nearrow$ Cusco baja a la posición 13.
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			...
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 14}}                                                   \\ \hline
	...
	-		\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_nouci.png}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 14}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 3                    & 3                  & 43\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 14}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						5                & 1                    & 4                  & 29\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 14 }}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						14               & 0                     & 14                   & 0\%                        \\ \hline
					\end{tabular}%
				}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 14, las provincias de la region del Cusco registraron \textbf{\color{mycolor5} cero} defunciones por COVID-19 a excepción del \textbf{\color{mycolor5}Cusco}. \\
		$\rightarrow$ La provincia del \textbf{\color{mycolor5}Cusco} registro \textbf{\color{mycolor5}dos} defunciónes por COVID-19.
	\end{frame}
...
\begin{frame}[label=resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en  \textbf{\color{mycolor4}descenso} con un $1.3\%$, así como la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares también se mantienen en descenso con un $1.1\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}disminuyó} al $84\%$ a nivel regional. El Hospital Antonio Lorena presenta el $100\%$ de camas ocupadas por cuarta semana. Asimismo, la disponibilidad de camas UCI disminuyó al $50\%$ en el HNAGV.
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}disminuyó} a $8\%$.
	\item Para la SE 14, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana, siendo las características de presentación clínica similares con las otras variantes, con casos leves en la presentación clínica.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE14, todas las provincias permanecen en descenso marcado de casos y fallecidos.
