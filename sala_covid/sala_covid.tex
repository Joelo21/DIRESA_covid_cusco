...
\textbf{Riesgos}:\\
			Lima región y Puno suben 2-3 fallecidos. \\
			Puno tiene > 1.0 fallecidos diario promedio por millón. \\
			DIRIS Lima Este sube levemente. \\
\textbf{Menor Riesgo}: \\
			Sierra centro baja >80\%. \\
			Costa centro y norte, la sierra/selva sur bajan 25-38\%. \\
			Personas 60+ años bajan >20\%. \\
			}
\vspace{0.01cm}
...
\end{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 09 de Abril del 2022. \\
	\textbf Nota 1: Perú:1177 camas libres, subió 0.2\% -  Lima: 483 camas libres, subió 3.2\%
	\\
	\textbf Suben*: \\
	Costa norte: La Libertad. \\
	Sierra sur: Ayacucho.\\
	\textbf Solo sube una región por 2 semanas \\
	La Libertad sube 1.96\%.\\
	\textbf Que media: Ancash (58.7\%), Cusco (58.2\%), Tumbes (50.0\%), La Libertad (52.7\%), Callao (45.9\%), Loreto (40.3\%), Puno (34.1\%), Piura (34.8\%), Moquegua (29.4\%), Ayacucho (31.3\%), Huánuco (29.4\%), Arequipa (27.8\%) y Cajamarca (26.2\%).\\ 
	Solo suben dos de estas 13 regiones suben.
} 
	\vspace{0.01cm}
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.6,1.90) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 09 de Abril del 2022.\\}
	\vspace{0.1cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.8,3.15) circle [x radius=2.8cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 09 de Abril del 2022. \\} 
		\vspace{0.01cm}
		$\nearrow$ Cusco sube a la posición 17.
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 14, las provincias de Paucartambo y Quispicanchis registraron \textbf{\color{mycolor5} una} defuncion por COVID-19. \\
		$\rightarrow$ La provincia del \textbf{\color{mycolor5}Cusco} registro \textbf{\color{mycolor5}cero} defunciónes por COVID-19.
	\end{frame}
