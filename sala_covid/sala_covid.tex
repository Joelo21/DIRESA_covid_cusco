...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 05 de Noviembre del 2022}}
...
\date{Semana Epidemiológica 44, 2022}
...
\begin{frame}
	...
	\end{center}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2022. Actualización: 2022-11-02. Reporte de número reproductivo efectivo (Rt) de COVID-19. Disponible haciendo clic en el siguiente enlace: \href{https://www.dge.gob.pe/portalnuevo/informacion-publica/reporte-de-numero-reproductivo-efectivo-rt/}{CDC-Rt}. \\}
	\vspace{0.01cm}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF - NOTICOVID. \\}
		\vspace{0.2cm}
		$\rightarrow$ Para la SE 44, la provincia del \textbf{\color{mycolor3}Cusco} registró \textbf{\color{mycolor3}cero} defunciónes por COVID-19.\\
		$\rightarrow$ Las demás provincias  registro \textbf{\color{mycolor3}cero} defunciónes por COVID-19.\\
...
\begin{frame}[label=Resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad para pruebas moleculares} \textbf{\color{mycolor4}ascendió} a $2.2\%$ y la \textbf{\color{mycolor3}tasa de positividad de pruebas antigénicas} descendió a 1.8$\%$.	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}ascendió al $14\%$}. 
	\item Para la SE 42, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Tasa de crecimiento semanal de \textbf{\color{mycolor4}defuciones} en \textbf{\color{mycolor3}verde}.
		...
		\begin{itemize}
			\item Para la SE43, todas las provincias se mantienen con escasos casos, defunciones y hospitalizaciones.
		\end{itemize}
	\end{itemize}
\end{frame}
