...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 10, las provincias de Acomayo, Anta, Calca, Canchis, Chumbivilcas, Espinar, Paucartambo y Urubamba registraron \textbf{\color{mycolor5}cero} defunciones por COVID-19.
