...
\textbf{Riesgos}: La Libertad, cuatro alzas, máximo en 19 semanas. 52 días sin nuevo mínimo diario(SE41).\\
\textbf{Estancamiento}:13 regiones no varían (±1),cuatro crecen mínimamente (2).Sólo siete regiones suben,sólo una muy importantemente (>14)\\}
\vspace{0.01cm}
$\rightarrow$ {\color{mycolor5}Cusco}: Las defunciones representan un $1.90\% $ del pico de la segunda ola.\\
\end{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 04 de diciembre del 2021. \\
	Nota 1: Perú: 986 camas libres, bajó $0.6\%$. Lima: 269 camas libres, bajó $2.5\%$. \\
	Suben:{*} Piura(4.52\%), Lambayeque(8.63\%) en la costa norte, Amazonas(5.90\%) y San Martín(0.82\%) en la sierra/selva central \\
	Áncash(11.21\%), Lima región(1.46\%) y Lima metropolitana(0.56\%) en la costa central.\\
	Huánuco(1.32\%) y Pasco(3.49\%) en la sierra/selva central.\\
	Ayacucho(9.44\%), Apurímac(2.90\%), Arequipa(2.90\%) y Puno(2.36\%) en la sierra sur.\\
	10 regiones crecen 2-6 semanas, incluyendo Lima metropolitana(6), Lima región que crecen 20\% en ocho, Ayacucho crece 32\% em cinco, y Piura crece ~20\% en ocho.
	Mucho > que media: Tumbes(91\%), Piura(73\%),Áncash y Ayacucho(69-70\%), La Libertad y Lima metropolitana(60-61\%), Lambayeque(53\%), Callao y Puno(49-50\%), Arequipa, {\color{mycolor2}Cusco} y Lima región(47\%).\\} 
	\vspace{0.01cm}
...
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 04 de diciembre del 2021.\\}
	\vspace{0.1cm}
	$\searrow$ Cusco pasa a la posición 16.
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.5,3.35) circle [x radius=2.0cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 04 de diciembre del 2021. \\} 
		\vspace{0.01cm}
		$\nearrow$ Cusco pasa al puesto 16	.
