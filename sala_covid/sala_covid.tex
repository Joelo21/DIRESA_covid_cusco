...
\begin{frame}[label=Resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad para pruebas moleculares} \textbf{\color{mycolor4}ascendió} a $2.5\%$ y la \textbf{\color{mycolor3}tasa de positividad de pruebas antigénicas} ascendió a 2.7$\%$.	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE44, todas las provincias se mantienen con escasos casos, defunciones y hospitalizaciones.
		\end{itemize}
	\end{itemize}
\end{frame}
