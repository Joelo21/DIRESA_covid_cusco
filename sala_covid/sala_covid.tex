...
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,443 $ defunciones por COVID-19 por millón de habitantes. \\
		\end{frame}
...
\textbf{Riesgos}:\\
			2 regiones suben >=2 fallecidos.\\
\textbf{Menor Riesgo}: \\
			Todas las macro-regiones bajan o se estancan.\\
			Todas la DIRIS bajan o se estancan.\\
			Todos los grupos etarios bajan o se estancan.\\
			
\textbf{Estancamiento}: \\
			Callao (5 semanas) y Ancash (3).\\
			}
\vspace{0.01cm}
...
\end{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 16 de Abril del 2022. \\
	\textbf Nota 1: Perú:1178 camas libres, subió 1.3\% -  Lima: 492 camas libres, subió 0.2\%
	\\
	\textbf Suben*: \\
	Costa centro: Lima Región.\\
	Costa norte: Lambayeque.\\
	Amazonia: Amazonas, San Martin, Loreto, Ucayali y Madre de Dios.\\
	\textbf Suben tres regiones por 2 semanas*: \\
	Lambayeque sube 19.24\% en 2 semanas.\\
	San Martin sube 9.57\% en 2 semanas.\\
	Ucayali sube 5.00\% en 2 semanas.\\
	\textbf Que media:La Libertad (63.3\%), Cusco (53.6\%), Tumbes (50.0\%), Loreto (49.4\%), Callao (44.3\%), Lambayeque (33.3\%), Piura (28.5\%), Arequipa (24.0\%) y Puno (23.3\%).\\ 
	Solo una de estas 10 regiones suben esta semana.
} 
	\vspace{0.01cm}
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.6,1.79) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 16 de Abril del 2022.\\}
	\vspace{0.1cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.8,3.33) circle [x radius=2.8cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 16 de Abril del 2022. \\} 
		\vspace{0.01cm}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 15, las provincias de la region del Cusco registraron \textbf{\color{mycolor5} cero} defunciones por COVID-19 a excepción del \textbf{\color{mycolor5}Cusco} y Chumbivilcas. \\
		$\rightarrow$ La provincia del \textbf{\color{mycolor5}Cusco} registro \textbf{\color{mycolor5}una} defunción por COVID-19.
	\end{frame}
