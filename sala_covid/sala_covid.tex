...
\begin{frame}[label=Resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad para pruebas moleculares} \textbf{\color{mycolor4}ascendió} a $1.6\%$ y la \textbf{\color{mycolor3}tasa de positividad de pruebas antigénicas} descendió a 1.1$\%$.	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor3} descendió al $9\%$ a nivel regional}.
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}descendió al $10\%$}. 
	\item Para la SE 41, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE41, todas las provincias se mantienen con escasos casos, defunciones y hospitalizaciones.
		\end{itemize}
	\end{itemize}
\end{frame}
