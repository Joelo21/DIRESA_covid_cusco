...
\textbf{Riesgos}:\\
			Ancash y Arequipa suben muy levemente (dos fallecidos más).\\
...
\end{frame}
	...
	$\nearrow$ Cusco se encuentra a la posición 09 con un RT de $1.35$ $ [1.30-1.40]$.
  ...
  \begin{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 02 de Julio del 2022. \\
	\textbf Perú: 941 camas libres, sube 2.6\% -  Lima: 249 camas libres, sube 0.9\%. \\
	\textbf Suben*: \\
	Costa: Piura, Ancash, Lima metroplitana, Moquegua y Tacna.\\
	Sierra: Junín, Huancavelica y Apurímac.\\
	\textbf Dos regiones suben>1 semana: \\
	Ancash sube 18.83\% en 2 sem.\\
	Huancavelica sube 3.40\% en 4 sem.\\
	\textbf >Que media: \\
	Ancash (59.3\%), La Libertad (43.1\%), Arequipa (34.2\%), Lambayeque (14.2\%), Lima metropolitana (12.0\%), Piura (11.6\%), Callao (11.5\%) e Ica (11.1\%).
	Tres de estas ocho regiones suben esta semana.\\
	El número de camas ocupadas sube muy levemente en Lima metropolitana y a nivel nacional.\\
} 
	\vspace{0.01cm}
...
\begin{frame}[label=Resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad para pruebas moleculares} \textbf{\color{mycolor4}aumentó} a $9.5\%$, y la \textbf{\color{mycolor3}tasa de positividad de pruebas antigénicas} a $11.6\%$, lo que duplica el valor de la semana previa.
	\end{itemize}
\end{frame}
