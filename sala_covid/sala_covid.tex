...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 16 de Abril del 2022}}
...
\date{Semana Epidemiológica 15, 2022}
...
%	\end{tikzpicture}
	{\tiny Fuente:REUNIS (Repositorio Único Nacional de Información en Salud). Consultado el 16 de Abril del 2022.\\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 16 de Abril del 2022.\\}
\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2022. Actualización: 2022-04-16.\\}
	\vspace{0.01cm}
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			...
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 15}}                                                   \\ \hline
	...
	-		\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_nouci.png}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 15}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 4                    & 2                  & 64\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 15}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						5                & 1                    & 4                  & 23\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 15 }}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						14               & 0                     & 14                   & 0\%                        \\ \hline
					\end{tabular}%
				}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE15, todas las provincias permanecen en descenso marcado de casos y fallecidos.
