...
\begin{frame}[label=Resumen]
	...
	\begin{itemize}
		...
		\item A la presente SE, se mantiene estable el \textbf{\color{mycolor4} descenso} en el número de \textbf{\color{mycolor3}casos} y hospitalizaciones no UCI.Las defunciones se mantuvieron bajas durante toda la cuarta ola.
		\item La \textbf{\color{mycolor3}tasa de positividad para pruebas moleculares} \textbf{\color{mycolor4}ascendió} a $4.7\%$ y la \textbf{\color{mycolor3}tasa de positividad de pruebas antigénicas} ascendió a3.2$\%$.	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}ascendió al $14\%$} (hasta la SE43). 
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE45, solo la provincia de Cusco se encuentra un incremento de casos del $30\%$, el resto aún presenta escasos casos. Las defunciones y hospitalizaciones aun se encuentran bajas.
		\end{itemize}
	\end{itemize}
\end{frame}
