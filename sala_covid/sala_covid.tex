...
\begin{frame}[label=resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en \textbf{\color{mycolor4}descenso} con un $3\%$, manteniéndose en este rango durante los últimas cuatro meses. Mientras que la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares disminuyó a $6\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item La mayoría de las provincias presentan desaceleración de casos y defunciones, a excepción de la provincia de Calca, Quispicanchi y Paucartambo, las que para la SE 50 presentan un leve incremento de casos. El exceso regional de mortalidad general es de -4.
