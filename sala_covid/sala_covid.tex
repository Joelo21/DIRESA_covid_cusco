...
\begin{frame}[label=Resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad para pruebas moleculares} \textbf{\color{mycolor4}ascendió} a un $0.6\%$ y la \textbf{\color{mycolor3}tasa de positividad de pruebas antigénicas} descendió a un $2\%$.
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}descendió al $15\%$}. 
	\item Para la SE 39, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE39, todas las provincias se mantienen con escasos casos, defunciones y hospitalizaciones.
		\end{itemize}
	\end{itemize}
\end{frame}
