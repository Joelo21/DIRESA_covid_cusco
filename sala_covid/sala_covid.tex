...
\begin{frame}[label=resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en \textbf{\color{mycolor4}descenso} con un $3\%$, manteniéndose en este rango durante las últimas diecisiete semanas. Mientras que la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares ascendió al $13\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\item Para la SE 49, continua la predominancia de la variante delta con un $100\%$, del total de elegibles secuenciados por semana, siendo las características de presentación clínica similares con las otras variantes.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Todas las provincias presentan desaceleración de casos y defunciones, a excepción de la provincia de La Convención la cual presenta un leve incremento de casos. El exceso regional de mortalidad general es de -2.
...
\begin{frame}[label=recomendaciones]
	...
	\begin{itemize}
			...
			\item Fortalecer la búsqueda activa de casos y el seguimiento clínico
