...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 30 de Abril del 2022}}
...
\date{Semana Epidemiológica 17, 2022}
...
%	\end{tikzpicture}
	{\tiny Fuente:REUNIS (Repositorio Único Nacional de Información en Salud). Consultado el 30 de Abril del 2022.\\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 30 de Abril del 2022.\\}
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,445 $ defunciones por COVID-19 por millón de habitantes. \\
		\end{frame}
...
\textbf{Riesgos}:\\
			Ica y Puno suben >=2 fallecidos.\\
			Diris Lima sube 2 fallecidos.\\
\textbf{Menor Riesgo}: \\
...
\end{frame}
	...
	\begin{frame}
		...
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2022. Actualización: 2022-04-30.\\}
	\vspace{0.01cm}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 30 de Abril del 2022. \\
	\textbf Nota 1: Perú: 1150 camas libres, bajo 0.6\% -  Lima: 469 camas libres, bajo 0.1\%
	\\
	\textbf Suben*: \\
	Costa norte-centro: La Libertad, Lima región y Callao.\\
	Selva y Sierra sur: Madre de Dios y Apurímac.\\
	Amazonia: Amazonas, San Martin, Loreto y Ucayali. -  Sierra Centro: Pasco.\\ 
	\textbf Suben cinco regiones por 2-3 semanas:* \\
	Apurímac sube 3.76\% en 2 sem. Lima región sube 6.87\% en 3 sem.\\
	\textbf >Que media: \\
	La Libertad (66.2\%), Cusco (50.4\%), Callao (44.1\%), Ancash (34.8\%), Loreto (34.0\%), Piura (24.1\%) y Arequipa (21.2\%).\\ 
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			...
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 17}}                                                   \\ \hline
	...
	-		\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_nouci.png}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 17}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						5               & 1                    & 4                  & 20\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 17}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						5                & 1                    & 4                  & 23\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 17 }}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 0                     & 6                   & 0\%                        \\ \hline
					\end{tabular}%
				}
