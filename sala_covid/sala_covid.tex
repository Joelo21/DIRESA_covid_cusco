...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 14 de Mayo del 2022}}
...
\date{Semana Epidemiológica 19, 2022}
...
%	\end{tikzpicture}
	{\tiny Fuente:REUNIS (Repositorio Único Nacional de Información en Salud). Consultado el 14 de Mayo del 2022.\\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 14 de Mayo del 2022.\\}
\vspace{0.01cm}
...
\textbf{Riesgos}:\\
			Puno tiene el mayor número de fallecidos (6).\\
			Selva baja, Sierra/Selva centro y sur suben mínimamente (dos fallecidos mas).\\
\textbf{Menor Riesgo}: \\
			Todas las macro-regiones bajan o se estancan.\\	
			Todas las DIRIS bajan o se estancan. \\		
			}
\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2022. Actualización: 2022-05-14.\\}
	\vspace{0.01cm}
  ...
  \begin{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 14 de Mayo del 2022. \\
	\textbf Nota 1: 1104 camas libres, baja 1.6\% -  Lima: 421 camas libres, bajo 8.5\%
	\\
	\textbf Suben*: \\
	Costa norte: Tumbes.\\
	Selva: San Martin y Madre de Dios.\\
	\textbf Suben dos regiones por 3 semanas:* \\
	 Madre de Dios sube 3.47\% en 3 sem.\\
	\textbf >Que media: \\
	La Libertad (66.1\%), Callao (40.7\%), Cusco (40.0\%), Ancash (37.5\%), Tumbes (33.3\%) Piura (19.6\%), Madre de Dios (18.4\%) y Arequipa (17.1\%).\\ 
	Solo una de estas ocho regiones suben esta semana.
} 
	\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.8,3.84) circle [x radius=2.8cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 07 de Mayo del 2022. \\} 
		\vspace{0.01cm}
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			...
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 19}}                                                   \\ \hline
	...
	-		\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_nouci.png}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 19}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 0                    & 6                  & 0\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 19}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						4                & 1                    & 3                  & 25\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 19 }}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 0                     & 6                   & 0\%                        \\ \hline
					\end{tabular}%
				}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 19, las provincias de la region del Cusco registraron \textbf{\color{mycolor5} cero} defunciones por COVID-19.\\
...
\begin{frame}[label=resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra   \textbf{\color{mycolor4}estacionaria} con un $1.3\%$, así como la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares también se mantiene estable con un $1.3\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}disminuyó} al $64\%$ a nivel regional (con un descenso del $9\%$), habiéndose ocupado el $100\%$ de camas en el Hospital Nacional Adolfo Guevara Velasco (6/6). 
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}descendió} al $3\%$.
	\item Para la SE 19, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana, siendo las características de presentación clínica similares con las otras variantes, con casos leves en la presentación clínica, secuenciamiento que se realiza en nuestra región desde hace 02 semanas.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE19, todas las provincias permanecen en descenso de casos y fallecidos.
