...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 04 de diciembre del 2021}}
...
\date{Semana Epidemiológica 48, 2021}
...
\begin{document}
	...
	\begin{figure}
		...
		\end{subfigure}
	\end{figure}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 04 de diciembre del 2021. \\
		Delta >(95\%), pareciera descender en última semana.\\
		Lima: Gamma sube? - Callao: Delta domina.Resto del país casi igual.\\
	...
	$\rightarrow$ Gamma persiste en sierra/selva sur con muy baja frecuencia.\\
...
\begin{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Juan Carbajal ($@$juank23\_7). Consultado el 04 de diciembre del 2021. \\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 04 de diciembre del 2021. \\}
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,254 $ defunciones por COVID-19 por millón de habitantes. \\
	\end{frame}
...
\end{tikzpicture}
{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 04 de diciembre del 2021.\\
Nota 1: Sube lima metropolitana y Lima región. \\
Nota 2: Mayores valores en 14-16 semanas\\
\textbf{Riesgos}: Tumbes con tasa fallecidos >2. 45 días sin nuevo mínimo diario(SE41).\\
\textbf{Estancamiento}:16 regiones no varían (±1), una crece mínimamente (2)Sólo cuatro regiones suben, solo dos importantemente (>7)\\}
\vspace{0.01cm}
$\rightarrow$ {\color{mycolor5}Cusco}: Las defunciones representan un $1.89\% $ del pico de la segunda ola.\\
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, ultra thick] (5.75,3.075) circle [x radius=3.4cm, y radius=.18cm, rotate=0];
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2021-12-04.\\}
	\vspace{0.01cm}
	...
	$\nearrow$ Cusco sube a la posición 18 con un RT de $0.88$ $ [0.84-0.92]$.
	...
	\vspace{-.5cm}
	\begin{center}
		\includegraphics[width=0.50\linewidth]{../sala_nacional/camas_regional.png}
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, ultra thick] (4.30,3.40) circle [x radius=.50cm, y radius=.50cm, rotate=0];
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 06 de diciembre del 2021. \\
	Nota 1: Perú: 980 camas libres, bajó $1.8\%$. Lima: 276 camas libres, subió $1.2\%$. \\
	Suben:{*} Piura(5.41\%), Lambayeque(1.40\%), La Libertad(9.83\%) y Ancash (0.86\%) en la costa norte.\\
	Lima metropolitana(1.47\%) y Lima región(4.88\%) en la costa central.\\
	Ayacucho(2.45\%), {\color{mycolor2}Cusco}(0.96\%), Madre de Dios(2.21\%) y Puno(7.14\%) en la sierra/selva sur.\\
	Arequipa(0.19\%) y Tacna(3.71\%) en la costa sur.
	Huánuco(6.84\%), Pasco(4.87\%), Junin(1.04\%) y Huancavelica(7.94\%) en la sierra/selva centro Amazonas(2.96\%)\\
	Nueve regiones crecen 2-6 semanas, incluyendo Lima metropolitana. \\
	Mucho > que media: Tumbes(92\%), Piura(69\%), La Libertad(64\%), Lima metropolitana, Ayacucho y Áncash(58-60\%), Callao y {\color{mycolor2}Cusco}(52-53\%),Puno y Lima región(46-47\%).\\} 
	\vspace{0.01cm}
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.1,3.04) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 04 de diciembre del 2021.\\}
	\vspace{0.1cm}
	$\searrow$ Cusco pasa a la posición 18.
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.5,3) circle [x radius=2.0cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 04 de diciembre del 2021. \\} 
		\vspace{0.01cm}
...
\begin{frame}
	...
	\end{center}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2021-12-06. Reporte de número reproductivo efectivo (Rt) de COVID-19. Disponible haciendo clic en el siguiente enlace: \href{https://www.dge.gob.pe/portalnuevo/informacion-publica/reporte-de-numero-reproductivo-efectivo-rt/}{CDC-Rt}. \\}
	\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 48}}                                                   \\ \hline
	...
	\begin{frame}
		...
		\vspace{-.2cm}
		\begin{center}
	-		\includegraphics[width=0.9\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_nouci.pdf}
			
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 48}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 3                    & 3                  & 50\%                        \\ \hline
					\end{tabular}%
				}
	...
	\begin{frame}
		...
		\vspace{-.2cm}
		\begin{center}
			\includegraphics[width=0.9\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_lorena_nouci.pdf}	
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 48}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						5                & 0                    & 5                  & 0\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 47}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						14               & 2                     & 12                   & 14\%                        \\ \hline
					\end{tabular}%
				}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		$\rightarrow$ Para la SE 48,en todas las provincias de la región del \textbf{\color{mycolor5}Cusco} excepto Acomayo y Paucartambo,reportaron defunciones por COVID-19 en la última semana epidemiológica.
		
		$\rightarrow$ La provincia del \textbf{\color{mycolor5}Cusco} reporta un total de \textbf{\color{mycolor5}doce} defunciones por COVID-19 en la última semana epidemiológicas.
		
		$\rightarrow$ La provincia de Acomayo y Paucartambo registran \textbf{\color{mycolor5}cero} defunciones en las ultimas 8 semanas epidemiológicas		
...
\begin{frame}[label=resumen]
	...
	\vspace{-.5cm}
	\begin{itemize}
		\item La Región de Cusco se ubica en el \textbf{\color{mycolor4}octavo lugar} de \textbf{\color{mycolor3}mortalidad} acumulada a nivel nacional, con una índice de propagación de $0.88 $.
		...
		\item La \textbf{\color{mycolor3}incidencia de casos por el total de pruebas realizadas} presenta un leve incremento de casos a nivel de la provincia de Cusco, Anta y Urubamba. Traduciendo un \textbf{\color{mycolor3}incremento de casos asintomáticos}.
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en mayor \textbf{\color{mycolor4}descenso} con un $3.2\%$, manteniéndose en este rango durante las últimas quince semanas. Mientras que, la \textbf{\color{mycolor3}tasa de positividad} para pruebas moleculares se mantuvo en $9.3\%$ para la SE47.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} es \textbf{\color{mycolor4} alta}, habiéndose mantenido en el rango de $69-75\% $ y mantenerse como tal durante las últimas 6 semanas. 
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, se ha mantenido entre $13-15\%$.
	\item Para la SE 47, continua la predominancia de la variante delta con un $92\%$, del total de elegibles secuenciados, siendo las características de presentación clínica similares con las otras variantes.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Todas las provincias presentan desaceleración de casos y defunciones, a excepción de Anta, Cusco y Urubamba que presentan un incremento de casos. El exceso regional de mortalidad general es de -10.
