...
\begin{document}
	...
	\begin{figure}
		...
		\end{subfigure}
	\end{figure}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 20 de noviembre del 2021. \\
	...
	\vspace{0.01cm}
	$\rightarrow$ La variante gamma persiste en sierra/selva sur con muy baja frecuencia. \\
...
\begin{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Juan Carbajal ($@$juank23\_7). Consultado el 20 de noviembre del 2021. \\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 20 de noviembre del 2021. \\}
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,251 $ defunciones por COVID-19 por millón de habitantes. \\
	\end{frame}
...
\end{tikzpicture}
{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 20 de noviembre del 2021.\\
Nota 1: Sube lima metropolitana y el resto del país también. \\
Nota 2: Callao subió también.\\
\textbf{Riesgos}: Piura: tres alzas seguidas, cuatro en seis últimas semanas. Alcanza máximo de 16 semanas. Tres semanas con tasa de fallecidos diarios >2 x millón. Triplica mínimo post 2ª ola de SE41\\
\textbf{Estancamiento}:17 regiones no varían (±1), una crece mínimamente (2)}\\ 
\vspace{0.01cm}
$\rightarrow$ {\color{mycolor5}Cusco}: Las defunciones representan un $0.0\% $ del pico de la segunda ola.\\
\end{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 20 de noviembre del 2021. \\
	Nota 1: Perú: 998 camas libres, bajó $3.0\%$. Lima: 270 camas libres, bajó $ 5.6\% $. \\
	Suben:{*} Tumbes(0.6\%), Cajamarca(1.8\%) y La Libertad(6.8\%) en la costa norte.\\
	Lima metropolitana(0.2\%) y callao(0.6\%) en la capital.\\
	Arequipa(2.0\%) y Tacna(8.9\%) en la costa sur.\\
	Huancavelica(3.7\%), Ayacucho(2.0\%) y Apurímac(6.8\%) en la sierra centro-sur.
	Todas estas regiones crecen 2-6 semanas excepto Apurimac, Arequipa y Cajamarca. \\
	Muy > que media: Tumbes(93\%), Piura(64\%), Lima metropolitana y Ancash(58\%), Ayacucho(57\%), Callao y La Libertad (54-55\%), {\color{mycolor2}Cusco} (52\%).\\} 
	\vspace{0.01cm}
	$\nearrow$ Todas subieron dos o más semanas.
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.1,2.55) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 20 de noviembre del 2021.\\}
	\vspace{0.1cm}
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 46}}                                                   \\ \hline
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 46}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 3                    & 3                  & 50\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 46}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						5                & 1                    & 4                  & 20\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 46}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						14               & 3                     & 11                   & 21\%                        \\ \hline
					\end{tabular}%
				}
...
\begin{frame}[label=laconvecion]
	\frametitle{Curva Epidemica de Sintomaticos por Tipo de Prueba, Provincia La Conveción}
	\vspace{-.5cm}
	\begin{center}
...
\begin{frame}[label=Paruro]
	\frametitle{Curva Epidemica de Sintomaticos por Tipo de Prueba, Provincia Paruro}
	\vspace{-.5cm}
	\begin{center}
...
\begin{frame}[label=Paucartambo]
	\frametitle{Curva Epidemica de Sintomaticos por Tipo de Prueba, Provincia Paucartambo}
	\vspace{-.5cm}
	\begin{center}
...
\begin{frame}[label=Quispicanchi]
	\frametitle{Curva Epidemica de Sintomaticos por Tipo de Prueba, Provincia Quispinachi}
	\vspace{-.5cm}
	\begin{center}
...
\begin{frame}[label=Urubamba]
	\frametitle{Curva Epidemica de Sintomaticos por Tipo de Prueba, Provincia Urubamba}
	\vspace{-.5cm}
	\begin{center}
