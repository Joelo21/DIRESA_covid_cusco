...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		$\rightarrow$ La provincia de La Convención registro \textbf{\color{mycolor5}una} defuncion y la provincia de Urubamba registro \textbf{\color{mycolor5}dos} defunciones por COVID-19.\\
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Para la SE28, se mantiene el ascenso en el número de casos, con un ascenso en el número de hospitalizaciones (ascenso que se produjo en la SE 24 y que aún se mantiene). defunciones.
		\end{itemize}
	\end{itemize}
\end{frame}
