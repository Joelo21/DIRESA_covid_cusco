...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 06 de noviembre del 2021}}
...
\date{Semana Epidemiológica 44, 2021}
...
\begin{document}
	...
	\begin{figure}
		...
		\end{subfigure}
	\end{figure}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 06 de noviembre del 2021. \\
...
\begin{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Juan Carbajal ($@$juank23\_7). Consultado el 06 de noviembre del 2021. \\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 06 de noviembre del 2021. \\}
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,245 $ defunciones por COVID-19 por millón de habitantes. \\
	\end{frame}
...
Nota 2: Sube $3.0\% $ , 5 fallecidos mas. Resto del país sube $6.5\% $, tercera semana al alza  \\
Mayor alza en el sur. \\
\textbf{Riesgos}: Tacna sube dos semanas, tasa diaria >3 x millón.\\
Ica y Lima región con tasas >1, Lima metropolitana cerca. \\
\textbf{Estancamiento}: Estancamiento: Sólo Lima sube bastante, 16 regiones estancadas(±1), Sólo una region sube dos semanas seguidas ($\pm 1$).\\} 
\vspace{0.01cm}
$\rightarrow$ {\color{mycolor5}Cusco}: Las defunciones representan un $-14.3\% $ del pico de la segunda ola. \\
\end{frame}
	...
	$\nearrow$ Cusco bajo a la posición 24 con un RT de $0.99$ $ [0.86-1.13]$.
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 06 de noviembre del 2021. \\
	Nota 1: Perú: 1014 camas libres, baja $1.3\%$. Lima: 290 camas libres, sube $ 2.7\% $. \\
	Suben $ >1\% $ {*}Costa norte: Tumbes (18.2\%), Piura (1.0\%), Lambayeque (4.8\%), La Libertad (5.1\%) y Ancash (4.5\%).Costa centro-sur Ica (5.5\%), Arequipa (3.6\%), Moquegua (5.2\%) y Tacna (1.7\%). Huanuco (7.8\%) y Pasco (10.5\%) en la sierra central y Ayacucho (2.4\%) {\color{mycolor2}Cusco} (1.2\%) en la sierra sur.
	Tumbes y Piura suben cuatro semanas consecutivas, La Libertad subió tres, Ancash, Huánuco, Ica y {\color{mycolor2}Cusco} dos semanas {\color{red}***}. Semanas previas: 13, 9, 6 y 5 regiones.\\
	Muy > que media: Piura (68\%) y Tumbes (67\%), Ancash (65\%),  {\color{mycolor2}Cusco} (60\%), Lima metropolitana (57\%) y La libertad (54\%).\\}
	\vspace{0.01cm}
	$\nearrow$ Todas menos Lima metropolitana subieron.
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.1,1.8) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 06 de noviembre del 2021.\\}
	\vspace{0.1cm}
	$\searrow$ Cusco pasa a la posición 24.
\end{frame}
...
\begin{frame}
	...
	\end{center}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2021-11-06. Reporte de número reproductivo efectivo (Rt) de COVID-19. Disponible haciendo clic en el siguiente enlace: \href{https://www.dge.gob.pe/portalnuevo/informacion-publica/reporte-de-numero-reproductivo-efectivo-rt/}{CDC-Rt}. \\}
	\vspace{0.01cm}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		$\rightarrow$ La última semana (SE44) sólo se registraron defunciones en Chumbivilcas y La Convención.
