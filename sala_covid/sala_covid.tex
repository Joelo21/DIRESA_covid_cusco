...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 26 de Marzo del 2022}}
...
\date{Semana Epidemiológica 12, 2022}
...
%	\end{tikzpicture}
	{\tiny Fuente:REUNIS (Repositorio Único Nacional de Información en Salud). Consultado el 26 de Marzo del 2022.\\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 26 de Marzo del 2022.\\}
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,439 $ defunciones por COVID-19 por millón de habitantes. \\
		\end{frame}
...
\textbf{Riesgos}:\\
			6 regiones suben >=2 fallecidos. \\
			Sierra/selva central sube. \\
			Suben en >80 años. \\
\textbf{Menor Riesgo}: \\
			Sierra/selva norte baja >70\%. \\
			Costa norte baja >35\%. \\
			Grupos etarios 25-69 bajan >25\%. \\
			}
\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, ultra thick] (5.35,3.60) circle [x radius=3.4cm, y radius=.18cm, rotate=0];
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2022. Actualización: 2022-03-26.\\}
	\vspace{0.01cm}
	...
	$\nearrow$ Cusco se encuentra a la posición 14 con un RT de $0.59$ $ [0.54-0.63]$.
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, ultra thick] (3.90,4.05) circle [x radius=.50cm, y radius=.50cm, rotate=0];
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 26 de Marzo del 2022. \\
	\textbf Nota 1: Perú: 1175 camas libres, subió 2.0\% -  Lima: 468 camas libres, subio 11.7\%
	\\
	\textbf Suben*: \\
	Costa centro: La libertad, Callao y Ancash. \\
	Sierra sur: Apurimac y Cusco.\\
	Sierra cemtro: Pasco. \\
	\textbf Solo sube una region por 3 semanas: \\
	Callao sube 0.14\%.\\
	\textbf Que media: Ancash (61.9\%), Cusco (59.3\%), Tumbes (50.9\%), La Libertad (50.8\%), Callao (49.3\%), Loreto (44.1\%), Puno (38.6\%), Piura (34.9\%), Moquegua (34.5\%), Ayacucho (31.3\%), Huánuco (30.0\%), Arequipa (29.4\%) y Cajamarca (28.6\%).\\ 
	Solo cuatro de estas 13 regiones suben.
} 
	\vspace{0.01cm}
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.6,1.80) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 26 de Marzo del 2022.\\}
	\vspace{0.1cm}
	$\searrow$ Cusco baja a la posición 26.
\end{frame}
...
\begin{frame}[label=cobertura_vacuna]
	\frametitle{Gráfico de Dispersion sobre la Cobertura de Vacunación por Provincias, Región Cusco}
	\vspace{-.5cm}
	\begin{center}
		\includegraphics[width=0.95\linewidth, trim={.2cm .5cm .2cm .2cm},clip]{../sala_nacional/Cobertura Vacunacion Provincias.jpg}
	\end{center}
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			...
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 12}}                                                   \\ \hline
	...
	-		\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_nouci.png}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 12}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 3                    & 3                  & 43\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 11}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						5                & 1                    & 4                  & 20\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 12 }}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						14               & 1                     & 13                   & 7\%                        \\ \hline
					\end{tabular}%
				}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 12, las provincias de \textbf{\color{mycolor5}Cusco} y La Convención  registraron \textbf{\color{mycolor5} defunciones} por COVID-19. \\
		$\rightarrow$ La provincia del \textbf{\color{mycolor5}Cusco} registro \textbf{\color{mycolor5}una} defuncion por COVID-19.
	\end{frame}
...
\begin{frame}[label=resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en  \textbf{\color{mycolor4}descenso} con un $2.1\%$, así como la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares también se mantienen en descenso con un $5.3\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}incrementó} al $93\% $ a nivel regional
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}disminuyó} a $8\%$.
	\item Para la SE 11, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana, siendo las características de presentación clínica similares con las otras variantes, con casos leves en la presentación clínica.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE11, todas las provincias permanecen en  descenso marcado de casos y fallecidos por quinta semana consecutiva.
