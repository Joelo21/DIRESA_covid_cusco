...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 04 de Junio del 2022}}
...
\date{Semana Epidemiológica 22, 2022}
...
%	\end{tikzpicture}
	{\tiny Fuente:REUNIS (Repositorio Único Nacional de Información en Salud). Consultado el 04 de Junio del 2022.\\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 04 de Junio del 2022.\\}
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,447 $ defunciones por COVID-19 por millón de habitantes. \\
\end{frame}
...
\textbf{Riesgos}:\\
			Lima metropolitana incrementa 5 fallecidos.\\
			DIRIS Lima Norte y Centro suben 2-3 fallecidos.\\
			Ancash, segunda región con más fallecidos, no baja de 3-4 por seis semanas.\\
			Costa centro incrementa en 100\%.\\
			25-59 años aumentan 4 fallecidos (100\%) y 70-79 años aumentan 9 fallecidos (450\%).\\
\textbf{Menor Riesgo}: \\
...
\end{frame}
	...
	\begin{frame}
		...
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2022. Actualización: 2022-05-28.\\}
	\vspace{0.01cm}
  ...
  \begin{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 04 de Junio del 2022. \\
	\textbf Perú: 1043 camas libres, baja 3.2\% -  Lima: 392 camas libres, bajo 3.2\%. \\
	\textbf Suben*: \\
	Costa y Sierra Sur: Apurimac, Arequipa y Moquegua.\\
	Costa Norte: Tumbes, Piura y Ancash.\\
	Otros: Amazonas y Huánuco.\\
	\textbf Ninguna región sube>1 semana. \\
	\textbf >Que media: \\
	La Libertad (56.9\%), Ancash (42.7\%), Tumbes (41.7\%), Piura (20.9\%), Arequipa (17.5\%) Cusco (15.2\%), Moquegua (14.5\%), Ica (13.2\%) y Lima Metropolitana (12.5\%).\\ 
	Cinco de estas nueve regiones suben esta semana.\\
	El número de camas UCI ocupadas sube levemente en Piura y Moquegua, y no baja en Arequipa y Callao.\\
} 
	\vspace{0.01cm}
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.6,1.95) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 04 de Junio del 2022.\\}
	\vspace{0.1cm}
	$\searrow$ Cusco se mantiene en la posición 26.
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.8,3.04) circle [x radius=2.8cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 04 de Junio del 2022. \\} 
		\vspace{0.01cm}
		$\nearrow$ Cusco baja a la posición 18.	
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			...
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 22}}                                                   \\ \hline
	...
	-		\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_nouci.png}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 22}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 3                    & 3                  & 50\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 22}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						2                & 1                    & 1                  & 50\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 22 }}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 0                     & 6                   & 0\%                        \\ \hline
					\end{tabular}%
				}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 21, la provincia de Paucartambo de la region del Cusco  registro \textbf{\color{mycolor5}una} defuncion por COVID-19.\\
		$\rightarrow$ La provincia del \textbf{\color{mycolor5}Cusco} registro \textbf{\color{mycolor5}cero} defunciones por COVID-19.
	\end{frame}
...
\begin{frame}[label=resumen]
	...
	\vspace{-.5cm}
	\begin{itemize}
		\item La Región de Cusco se ubica en el \textbf{\color{mycolor4}octavo lugar} de \textbf{\color{mycolor3}mortalidad} acumulada a nivel nacional, con una índice de propagación de $0.8 $.   
		\item Existe un \textbf{\color{mycolor4}ligero incremento} en el número de \textbf{\color{mycolor3}casos, más aún permanece el descenso en hospitalizados y defunciones} por COVID-19, ascenso que puede deberse al incremento de la búsqueda activa de casos.
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra   \textbf{\color{mycolor4}estacionaria} con un ligero ascenso a $2.3\%$, así como la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares también se mantiene estable con un ligero descenso  a $1.5\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}disminuyó} al $31\%$ a nivel regional (con un descenso del $8\%$). 
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}se mantuvo estable} con el $6\%$.
	\item Para la SE 22, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana, siendo las características de presentación clínica similares con las otras variantes, con casos leves en la presentación clínica, secuenciamiento que se realiza en nuestra región desde hace 02 semanas.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE21, todas las provincias permanecen en descenso de casos y fallecidos.
