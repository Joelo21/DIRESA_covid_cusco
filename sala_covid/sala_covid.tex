...
\end{frame}
	...
	\begin{frame}
		...
		\vspace{-.2cm}
		\begin{center}
			\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_regional_uci.pdf}
		\end{center}
		{\tiny Fuente de datos: Referencias, contrareferencias.}
	\end{frame}
	\begin{frame}
	...
	\begin{frame}
		...
		\vspace{-.2cm}
		\begin{center}
			\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_lorena_uci.pdf}				
		\end{center}
		{\tiny Fuente de datos: Referencias, contrareferencias.}
	\end{frame}
	\begin{frame}
	...
	\begin{frame}
		...
		\vspace{-.2cm}
		\begin{center}
			\includegraphics[width=0.8\linewidth, trim={0cm .5cm 0cm 0.2cm},clip]{../figuras/h_adolfo_uci.pdf}
		\end{center}
		{\tiny Fuente de datos: Referencias, contrareferencias}
	\end{frame}
	\begin{frame}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		$\rightarrow$ Para la SE 47,En todas las provincias de la región del \textbf{\color{mycolor5}Cusco} reportaron \textbf{\color{mycolor5}cero} defunciones por COVID-19 en la última semana.
