...
\begin{frame}[label=cobertura_vacuna]
	...
	\vspace{-.5cm}
	\begin{center}
		\includegraphics[width=0.95\linewidth, trim={.2cm .5cm .2cm .2cm},clip]{../sala_nacional/Cobertura_Vacunacion_Provincias.jpg}
	\end{center}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 13, las provincias de \textbf{\color{mycolor5}Cusco} y La Convención  registraron \textbf{\color{mycolor5} defunciones} por COVID-19. \\
