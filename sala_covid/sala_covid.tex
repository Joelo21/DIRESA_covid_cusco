...
\begin{document}
	...
	\vspace{0.01cm}
	$\rightarrow$ 68 casos Omicrón, uno en Callao. Dispersión distrital.\\
	$\rightarrow$ Transmisión comunitaria.\\
	$\rightarrow$ Delta 98\%, transición.\\
...
%	\end{tikzpicture}
	{\tiny Fuente:REUNIS (Repositorio Único Nacional de Información en Salud). Consultado el 25 de diciembre del 2021. \\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 25 de diciembre del 2021.\\}
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,276 $ defunciones por COVID-19 por millón de habitantes. \\
	\end{frame}
...
\textbf{Riesgos}:\\
				...
				Fuerte circulación comunitaria de omicrón, en Lima y resto del país.\\
				12.5 millones de no vacunados con 13.8 veces más riesgo de morir que vacunados con dos dosis.\\
				Pocas UCI disponibles en toda la costa norte-centro.\\			
\textbf{Estancamiento}:Nueve regiones suben >2, 10 regiones no varían (±1), tres crecen mínimamente (2)\\
					  Ninguna región sube fuerte (>4), No hemos observado alza exponencial (aún)\\}
\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2021-12-25.\\}
	\vspace{0.01cm}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 25 de diciembre del 2021. \\
	\textbf Nota 1: Perú: 1086 camas libres,sube 4.9\%, Lima: 340 camas libres, subió 11.1\%. \\
	\textbf Suben:{*} Amazonas, Cajamarca y San Martín,, Pasco y Junín, y Loreto, Ucayali y Madre de Dios en regiones con área amazónica, Tumbes y Lambayeque en costa norte, Áncash y Lima región en la costa sur.\\
	Cinco regiones crecen 2-3 semanas, todas con área Amazónica.\\
	Cajamarca y Ucayali en tres semanas suben 6.89\% y 6.67\%, San Martín y Junín en dos semanas crecen 6.78\% y 4.74\%.\\
	\textbf Que media: Tumbes (91.95\%), Ancash (71.25\%), Piura (65.05\%), Lambayeque (54.47\%), Lima metropolitana (53.38\%), Lima región (50.34\%), Libertad (49.51\%), Callao (48.33\%), Arequipa (47.07\%), y Ayacucho (45.69\%)\\
	Todos costa norte-centro menos Ayacucho y Arequipa. Sólo cuatro suben esta semana\\} 
	\vspace{0.01cm}
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.1,4.40) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 25 de diciembre del 2021.\\}
	\vspace{0.1cm}
	$\searrow$ Cusco se baja a la posición 9.
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.5,3.18) circle [x radius=2.0cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 25 de diciembre del 2021. \\} 
		\vspace{0.01cm}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		$\rightarrow$ Para la SE 51,las provincias de Canchis y Urubamba, reportaron defunciones por COVID-19 en la última semana epidemiológica en la región del \textbf{\color{mycolor5}Cusco}.
		...
		$\rightarrow$ La provincia de Acomayo y Canas registran \textbf{\color{mycolor5}cero} defunciones en las ultimas 9 semanas epidemiológicas.	
