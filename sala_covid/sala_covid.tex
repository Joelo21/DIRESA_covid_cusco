...
\title{Sala Situacional COVID-19, Región Cusco\footnote{Análisis con información de la región hasta el 26 de Febrero del 2022}}
...
%	\end{tikzpicture}
	{\tiny Fuente:R EUNIS (Repositorio Único Nacional de Información en Salud). Consultado el 26 de Febrero del 2022.\\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 26 de Febrero del 2022.\\}
\vspace{0.01cm}
$\nearrow$ Cusco se mantiene en el puesto 8, con $ 3,419 $ defunciones por COVID-19 por millón de habitantes. \\
		\end{frame}
...
\textbf{Riesgos}:\\
			2 regiones suben cuatro fallecidos.\\	
			Tasas de fallecidos >2.5 en la costa norte y sur.\\
			Sierra/selva norte y centro más selva baja estancados.\\
\textbf{Menor Riesgo}: \\
					Todas la costa más la sierra/selva sur baja >20.0\%.\\
					Las DIRIS bajan >35\% y todos los grupos etarios >25 años caen >20\%. \\
					Lima metropolitana, región y Callao bajan 50.0\%. \\ }
\vspace{0.01cm}
$\rightarrow$ {\color{mycolor5}Cusco}: Las defunciones representan un $8.18\% $ del pico de la segunda ola.\\
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, ultra thick] (5.35,4.70) circle [x radius=3.4cm, y radius=.18cm, rotate=0];
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2022. Actualización: 2022-02-26.\\}
	\vspace{0.01cm}
	...
	$\nearrow$ Cusco se encuentra a la posición 06 con un RT de $0.65$ $ [0.60-0.69]$.
	...
	\vspace{-.2cm}
	\begin{center}
		\includegraphics[width=0.66\linewidth]{../sala_nacional/camas_regional.png}
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, ultra thick] (3.90,4.02) circle [x radius=.50cm, y radius=.50cm, rotate=0];
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 26 de Febrero del 2022. \\
	\textbf Nota 1: Perú: 1045 camas libres, subió 10.5\% -  Lima: 407 camas libres, subió 16.3\%
	\\
	\textbf Suben*: \\
	Sierra/Selva Norte: Amazonas y Cajamarca. \\
	Siera Centro: Huancavelica y Pasco.\\
	Tres regiones suben 2-5 semanas. Cajamarca sube 33\% en 5 sem. Amazonas y Huancavelica sube 1-5\% en 3 sem. \\
	\textbf Que media: Tumbes (91.0\%), Ancash (76.2\%), Ayacucho (62.8\%), Arequipa (61.4\%), Cusco (61.1\%), Huánuco (61.0\%), Lambayeque (59.7\%), Moquegua (58.0\%), La Libertad (57.9\%), Piura (57.1\%), Lima metropolitana (57.1\%) y Lima región (49.1\%) \\ 
	Ninguna de estas 12 regiones sube.\\ } 
	\vspace{0.01cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.8,3.02) circle [x radius=2.8cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 26 de Febrero del 2022. \\} 
		\vspace{0.01cm}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 08, las provincias de Anta, Canas, Chumbivilcas,Paucartambo y Quispicanchis registraron \textbf{\color{mycolor5}cero} defunciones por COVID-19.
					
		$\rightarrow$ La provincia de \textbf{\color{mycolor5}Cusco}, registro \textbf{\color{mycolor5}tres} defunciones en la última semana epidemiológica.	
...
\begin{frame}[label=resumen]
	...
	\vspace{-.5cm}
	\begin{itemize}
		\item La Región de Cusco se ubica en el \textbf{\color{mycolor4}octavo lugar} de \textbf{\color{mycolor3}mortalidad} acumulada a nivel nacional, con una índice de propagación de $0.65 $.   
		...
		\item La \textbf{\color{mycolor3}tasa de positividad} para pruebas antigénicas se encuentra en  \textbf{\color{mycolor4}descenso} con un $7.4\%$, así como la \textbf{\color{mycolor3}tasa de positividad} de pruebas moleculares también se mantienen en descenso con un $12.2\%$.
		\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}se mantuvo} en $91\% $ a nivel regional
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}disminuyó} a $26\%$.
	\item Para la SE 08, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana, siendo las características de presentación clínica similares con las otras variantes, con casos leves en la presentación clínica.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE08, todas las provincias permanecen en  descenso de casos y fallecidos.
