...
\end{frame}
  ...
  \begin{frame}
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 06 de Agosto del 2022. \\
	\textbf Perú: 861 camas libres, sube 3.4\% -  Lima: 326 camas libres, sube 3.8\%. \\
	\textbf Suben*: \\
	Costa: Lambayeque, La Libertad, Ancash Lima región y metropolitana y Tacna.\\
	Sierra/Selva Sur: Apurimac, Ayacucho, Cusco y Puno.\\
	Sierra/Selva Norte: Cajamarcs, Amazonas y San Martin Huánuco.\\
	\textbf Nueve regiones suben 2-5 semanas. \\
	Amazonas sube 5.94\% en 3 sem.
	Ancash sube 5.65\% en 2 sem.
	Apurímac sube 17.12\% en 5 sem.
	Ayacucho sube 23.44\% en 2 sem.
	Cajamarca sube 4.17\% en 3 sem.
	Cusco sube 17.11\% en 4 sem.
	Huánuco sube 16.75\% en 2 sem.
	La Libertad sube 4.67\% en 3 sem.
	Lima región sube 13.02 en 3 sem. 
	\textbf >Que media: \\
	La Libertad (44.8\%), Arequipa (42.4\%), Ancash (40.1\%), Tumbes (33.3\%), Ayacucho (23.4\%), Apurímac (21.8\%), Cusco (20.8\%), Huánuco (16.8\%) y Amazonas (13.4\%)\\
} 
	\vspace{0.01cm}
	$\nearrow$ Siete de estas nueve regiones suben esta semana.
...
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.6,2.56) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 06 de Agosto del 2022.\\}
	\vspace{0.1cm}
...
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.8,2.15) circle [x radius=2.8cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 06 de Agosto del 2022. \\} 
		\vspace{0.01cm}
		$\nearrow$ Cusco baja a la posición 24.	
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		{\tiny Fuente de datos: SINADEF. \\}
		\vspace{0.5cm}
		$\rightarrow$ Para la SE 31, la provincia del \textbf{\color{mycolor5}Cusco} registró \textbf{\color{mycolor5}dos} defunciones por COVID-19.\\
		$\rightarrow$ La provincia de Acomayo registró \textbf{\color{mycolor5}una} defunción y la provincia de La Convención registró \textbf{\color{mycolor5}dos} defunciones por COVID-19.\\
...
\begin{frame}[label=Resumen]
	...
	\begin{itemize}
		...
		\item La \textbf{\color{mycolor3}tasa de positividad para pruebas moleculares} \textbf{\color{mycolor4}ascendió} a un $30\%$ y la \textbf{\color{mycolor3}tasa de positividad de pruebas antigénicas} ascendió a un $30.3\%$.
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} \textbf{\color{mycolor4}disminuyó} al $32\%$ a nivel regional.
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, \textbf{\color{mycolor4}se mantuvo estable con el $68\%$}. 
	\item Para la SE 30, predomina la variante ómicron en el $100\%$, del total de muestras secuenciadas por semana, siendo notorio el incremento de la variante BA.5, que tiene una mayor transmisibilidad, pero no mortalidad, pudiendo presentarse en poblaciones vacunadas debido a su capacidad de escape inmunológico.
