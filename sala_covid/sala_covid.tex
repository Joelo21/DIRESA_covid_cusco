...
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 01 de enero del 2022.\\}
	\vspace{0.1cm}
	$\searrow$ Cusco se baja a la posición 10.
\end{frame}
...
\section{Indicadores por Provincias}
	...
	\begin{frame}
		...
		$\rightarrow$ Para la SE 52,la provincia de Canchis, reportaron \textbf{\color{mycolor5}una} defuncion por COVID-19 en la última semana epidemiológica en la región del \textbf{\color{mycolor5}Cusco}.
...
\begin{frame}
	...
	\vspace{-.5cm}
	\begin{itemize}
	\item La ocupación de camas \textbf{\color{mycolor3}UCI} es \textbf{\color{mycolor4}baja} por primera vez, con un $57\% $ de ocupación a nivel regional. 
	\item La ocupación de camas \textbf{\color{mycolor3}no UCI}, ha disminuido a un $13\%$.
	\item Para la SE 51, predomina la variante delta en un $80\%$, del total de elegibles secuenciados, siendo las características de presentación clínica similares con las otras variantes.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item Para la SE51, todas las provincias presentan una disminución de casos y defunciones. El exceso regional de mortalidad general es de -16.
