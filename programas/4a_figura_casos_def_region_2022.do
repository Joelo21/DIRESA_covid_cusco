...
(scatter defuncion semana_2, msize(vsmall) mcolor("$mycolor2") mlabel(defuncion) mlabcolor("$mycolor3") mlabsize(tiny) connect() xline(1, lcolor("$mycolor1") lpattern(shortdash) lwidth(thick)) xline(13, lcolor("$mycolor2") lpattern(shortdash) lwidth(thick)) xline(15, lcolor("$mycolor3") lpattern(shortdash) lwidth(thick)) xline(23, lcolor("$mycolor4") lpattern(dash_dot) lwidth(thick))   lpattern(solid) xline(53, lcolor("$mycolor7") lpattern(shortdash) lwidth(mthick))) ///
 if semana_2 >=1 & semana_2<=$semana, ///
	...
	bgcolor(white) ///
	ylabel(, nogrid) ///	
	name(defunciones20_21_22, replace)

* 2020 y 2021
graph combine defunciones20_20 defunciones20_21_22, ///
graphregion(color(white)) ///
name(defunciones_20_21_2022, replace)
...
gr export "figuras\defunciones_crecimiento_2022.png", as(png) replace
gr export "figuras\defunciones_crecimiento_2022.pdf", as(pdf) name("defunciones20_21_22") replace
...
if semana_2 >=1 & semana_2<=$semana, ///
	...
	bgcolor(white) ///
	ylabel(, nogrid) ///	
	name(positivos20_21_22, replace)

* 2020 y 2021
graph combine positivos20_20 positivos20_21_22, ///
	graphregion(color(white)) ///
name(positivos_20_21_2022, replace)

gr export "figuras\positivos_20_21_2022.png", as(png) replace
gr export "figuras\positivos_20_21_2022.pdf", as(pdf) name("positivos_20_21_2022") replace
...
(scatter sintomatico semana_2, msymbol(Th) msize(vsmall) mcolor("$mycolor4") mlabcolor("$mycolor4") mlabsize(tiny) connect()    lpattern(solid) xline(53, lcolor("$mycolor7") lpattern(shortdash) lwidth(mthick))) ///
...
if semana_2 >=1 & semana_2 <=$semana, ///
	...
	bgcolor(white) ///
	ylabel(, nogrid) ///	
	name(sintomaticos20_21_22, replace)

* 2020 y 2021
graph combine sintomaticos20_20 sintomaticos20_21_22, ///
graphregion(color(white)) ///
name(sintomaticos_20_21_2022, replace)
...
* 2020 y 2021
graph combine sinto_prueba20_20 sinto_prueba20_21_22, ///
graphregion(color(white)) ///
name(sinto_prueba_20_21_22, replace)

gr export "figuras\sinto_prueba_20_21_2022.png", as(png) replace
gr export "figuras\sinto_prueba_20_21_2022.pdf", as(pdf) name("sinto_prueba_20_21_22") replace
...
(scatter positivo_pcr semana_2, msymbol(none) mlabel(positivo_pcr) mlabcolor("$mycolor5") mlabsize(*0.65) mlabposition(12)   /* lpattern(solid) xline(53, lcolor("$mycolor7") lpattern(shortdash) lwidth(mthick)) */)				///
...
graph export "figuras\positividad_pcr_2022.pdf", as(pdf) replace
...
(scatter positivo_ag semana_2, msymbol(none) mlabel(positivo_ag) mlabcolor("$mycolor4") mlabsize(*0.65) mlabposition(12)    /* lpattern(solid) xline(53, lcolor("$mycolor7") lpattern(shortdash) lwidth(mthick)) */)				///
...
graph export "figuras\positividad_ag_2022.pdf", as(pdf) replace

* Combinar figuras y exportar en PDF y PNG
graph combine pcr ag, graphregion(margin(zero)) name(positividad, replace)

gr export "figuras\positividad_ambas_2022.png", as(png) replace
graph export "figuras\positividad_ambas_2022.pdf", as(pdf) replace
*/