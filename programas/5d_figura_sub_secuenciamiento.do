...
twoway (bar linaje_omicron_1 mes, barwidth(0.6) yaxis(1) ylabel(0(0.2)1) yscale(range(0(0.2)1) axis(1)) color("$mycolor11")) ///
(scatter linaje_omicron_1 mes, msize(vsmall) mcolor("$mycolor11") mlabel(linaje_omicron_1) mlabcolor("$mycolor11") mlabsize(vsmall) connect()) ///
(bar linaje_omicron_2 mes, barwidth(0.6) yaxis(1) ylabel(0(0.2)1) yscale(range(0(0.2)1) axis(1)) color("$mycolor12")) ///
(scatter linaje_omicron_2 mes, msize(vsmall) mcolor("$mycolor12") mlabel(linaje_omicron_2) mlabcolor("$mycolor12") mlabsize(vsmall) connect()) ///
(bar linaje_omicron_3 mes, barwidth(0.6) yaxis(1) ylabel(0(0.2)1) yscale(range(0(0.2)1) axis(1)) color("$mycolor13")) ///
(scatter linaje_omicron_3 mes, msize(vsmall) mcolor("$mycolor13") mlabel(linaje_omicron_3) mlabcolor("$mycolor13") mlabsize(vsmall) connect()) ///
(bar linaje_omicron_4 mes, barwidth(0.6) yaxis(1) ylabel(0(0.2)1) yscale(range(0(0.2)1) axis(1)) color("$mycolor16")) ///
(scatter linaje_omicron_4 mes, msize(vsmall) mcolor("$mycolor16") mlabel(linaje_omicron_4) mlabcolor("$mycolor16") mlabsize(vsmall) connect()) ///
(bar linaje_omicron_5 mes, barwidth(0.6) yaxis(1) ylabel(0(0.2)1) yscale(range(0(0.2)1) axis(1)) color("$mycolor1")) ///
(scatter linaje_omicron_5 mes, msize(vsmall) mcolor("$mycolor1") mlabel(linaje_omicron_5) mlabcolor("$mycolor1") mlabsize(vsmall) connect()) ///
(bar linaje_omicron_6 mes, barwidth(0.6) yaxis(1) ylabel(0(0.2)1) yscale(range(0(0.2)1) axis(1)) color("$mycolor10")) ///
(scatter linaje_omicron_6 mes, msize(vsmall) mcolor("$mycolor10") mlabel(linaje_omicron_6) mlabcolor("$mycolor10") mlabsize(vsmall) connect()) ///
(bar linaje_omicron_7 mes, barwidth(0.6) yaxis(1) ylabel(0(0.2)1) yscale(range(0(0.2)1) axis(1)) color("$mycolor15")) ///
(scatter linaje_omicron_7 mes, msize(vsmall) mcolor("$mycolor15") mlabel(linaje_omicron_7) mlabcolor("$mycolor15") mlabsize(vsmall) connect()) ///
(bar linaje_omicron_8 mes, barwidth(0.6) yaxis(1) ylabel(0(0.2)1) yscale(range(0(0.2)1) axis(1)) color("$mycolor14")) ///
...
(bar linaje_omicron_9 mes, barwidth(0.6) yaxis(1) ylabel(0(0.2)1) yscale(range(0(0.2)1) axis(1)) color("$mycolor7")) ///
(scatter linaje_omicron_9 mes, msize(vsmall) mcolor("$mycolor7") mlabel(linaje_omicron_9) mlabcolor("$mycolor7") mlabsize(vsmall) connect()) ///
(bar linaje_omicron_10 mes, barwidth(0.6) yaxis(1) ylabel(0(0.2)1) yscale(range(0(0.2)1) axis(1)) color("$mycolor5")) ///
(scatter linaje_omicron_10 mes, msize(vsmall) mcolor("$mycolor5") mlabel(linaje_omicron_10) mlabcolor("$mycolor5") mlabsize(vsmall) connect()) ///
(bar linaje_omicron_11 mes, barwidth(0.6) yaxis(1) ylabel(0(0.2)1) yscale(range(0(0.2)1) axis(1)) color("$mycolor6")) ///
(scatter linaje_omicron_11 mes, msize(vsmall) mcolor("$mycolor6") mlabel(linaje_omicron_11) mlabcolor("$mycolor6") mlabsize(vsmall) connect()) ///
(bar linaje_omicron_12 mes, barwidth(0.6) yaxis(1) ylabel(0(0.2)1) yscale(range(0(0.2)1) axis(1)) color("$mycolor4")) ///
(scatter linaje_omicron_12 mes, msize(vsmall) mcolor("$mycolor4") mlabel(linaje_omicron_12) mlabcolor("$mycolor4") mlabsize(vsmall) connect()) ///
(bar linaje_omicron_13 mes, barwidth(0.6) yaxis(1) ylabel(0(0.2)1) yscale(range(0(0.2)1) axis(1)) color("$mycolor2")) ///
(scatter linaje_omicron_13 mes, msize(vsmall) mcolor("$mycolor2") mlabel(linaje_omicron_13) mlabcolor("$mycolor2") mlabsize(vsmall) connect()) ///
(bar linaje_omicron_14 mes, barwidth(0.6) yaxis(1) ylabel(0(0.2)1) yscale(range(0(0.2)1) axis(1)) color("$mycolor9")) ///
(scatter linaje_omicron_14 mes, msize(vsmall) mcolor("$mycolor9") mlabel(linaje_omicron_14) mlabcolor("$mycolor9") mlabsize(vsmall) connect()) ///
(line suma_total mes, lcolor("$mycolor4") lpattern(shortdash_dot) lwidth(thick) yaxis(2) yscale(axis(2)) ylabel(0(20)140, axis(2))) ///
(scatter suma_total mes, msize(vsmall) mcolor("$mycolor17") mlabel(suma_total) mlabposition(12) mlabcolor("$mycolor17") mlabsize(vsmall) connect() yaxis(2) yscale(axis(2)) ylabel(0(20)140, axis(2))) ///
 ,	xtitle("Mes", size(*0.7)) ///
