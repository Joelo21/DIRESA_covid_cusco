...
********************************************************************************
* Tercera ola
sum promedio_casos if fecha > d(31dec2021)
gen casos_min_3 = r(min)
gen casos_max_3 = r(max)
*
sum fecha if (promedio_casos == casos_max_3) & fecha > d(31dec2021)
...
* Generar gráfico
twoway ///
(line promedio_casos fecha, lcolor("$mycolor5") lpattern(solid) lpattern(solid) xline(22426, lcolor("$mycolor5") lpattern(shortdash) lwidth(mthick)) xline(22149, lcolor("$mycolor3") lpattern(shortdash) lwidth(mthick))) ///
...
(line casos_min_3 fecha, lcolor("$mycolor6") lpattern(shortdash) lwidth(mthick)) ///
...
(scatter defunciones_min_1 fecha if fecha == fecha_defunciones_actual, mlabel(defunciones_min_1) msize(vsmall) mcolor("$mycolor2") mlabcolor("$mycolor2")) ///
...
(scatter defunciones_min_2 fecha if fecha == fecha_defunciones_actual, mlabel(defunciones_min_2) msize(vsmall) mcolor("$mycolor3") mlabcolor("$mycolor3")) ///
...
(scatter defunciones_min_3 fecha if fecha == fecha_defunciones_actual, mlabel(defunciones_min_3) msize(vsmall) mcolor("$mycolor6") mlabcolor("$mycolor6")) ///
(line defunciones_max_1 fecha, lcolor("$mycolor2") lpattern(shortdash) lwidth(mthick)) ///
(line defunciones_min_1 fecha, lcolor("$mycolor2") lpattern(shortdash) lwidth(mthick)) ///
(line defunciones_max_2 fecha, lcolor("$mycolor3") lpattern(shortdash) lwidth(mthick)) ///
(line defunciones_min_2 fecha, lcolor("$mycolor3") lpattern(shortdash) lwidth(mthick)) ///
(line defunciones_max_3 fecha, lcolor("$mycolor6") lpattern(shortdash) lwidth(mthick)) ///
(line defunciones_min_3 fecha, lcolor("$mycolor6") lpattern(shortdash) lwidth(mthick)) ///
...
, 	ylabel(0(5)33, labsize(*0.6)) ///
	...
	text(30 21994 "{it:Actualizado al}" "{it:$fecha}", place(ne) box just(left) margin(l+4 t+1 b+1) width(21) size(small) color(white) bcolor("$mycolor7") fcolor("$mycolor7")) ///
