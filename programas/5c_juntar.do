...
replace variante = 4 if linaje1 == "BA.1" | linaje1 == "B.1.1.529" | linaje1 == "BA.1.1" | linaje1 == "BA.1.1.1" | linaje1 == "BA.2.3" | linaje1 == "BA.2.9" | linaje1 == "BA.2" | linaje1 == "BA.2.12.1" | linaje1 == "BA.2.13" | linaje1 == "BA.2.36" | linaje1 == "BA.2.38" | linaje1 == "BA.4" | linaje1 == "BA.5"
