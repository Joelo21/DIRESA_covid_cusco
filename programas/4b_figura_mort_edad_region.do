...
if semana_2 >=1, ///
	ylabel(0(3)24, labsize(*0.6)) ///
	tlabel(1(2)$semana 53 "1" 55 "3" 57 "5" 59 "7" 61 "9" 63 "11" 65 "13" 67 "15" 69 "17" 71 "19" 73 "21" 75 "23" 77 "25" 79 "27" 81 "29" 83 "31" 85 "33" 87 "35" 89 "37" 91 "39" 93 "41", labsize(*0.6)) ///
	xtitle("Semana Epidemiológica", size(*0.7)) ///
	ytitle("Mortalidad (defunciones/población*10,000)") ///
	graphregion(color(white)) ///
	title("2022", box bexpand bcolor("$mycolor3") color(white)) ///
