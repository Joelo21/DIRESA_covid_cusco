...
replace linaje_omicron_B5 = 2 if linaje == "BA.5.1"
...
* Graficamos
graph bar linaje_omicron_B5_1 linaje_omicron_B5_2 linaje_omicron_B5_3 linaje_omicron_B5_4 linaje_omicron_B5_5, ysize(5) xsize(6.1) ///
...
legend(cols(3) label(1 "BA.5") label(2 "BA.5.1") label(3 "BA.5.2") label(4 "BA.5.2.1") label(5 "BA.5.5") size(*0.8) region(col(white))) name(Sub_v_omicron_b5, replace) 
