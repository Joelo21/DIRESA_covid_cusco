...
if semana>=32 & semana <=$semana									///
  ...
  xlabel(32(1)$semana 53 "1" 54 "2" 55 "3" 56 "4" 57 "5" 58 "6" 59 "7" 60 "8" 61 "9" 62 "10" 63 "11" 64 "12" 65 "13" 66 "14" 67 "15" 68 "16" 69 "17" 70 "18" 71 "19" 72 "20" 73 "21" 74 "22" 75 "23" 76 "24" 77 "25" 78 "26" 79 "27" 80 "28" 81 "29" 82 "30" 83 "31", labsize(*0.40)) ///
...
if semana>=32 & semana <=$semana									///
  ,xtitle("Semanas Epidemológicas", size(*0.7)) 			///
  xlabel(32(2)$semana 54 "2" 56 "4" 58 "6" 60 "8" 62 "10" 64 "12" 66 "14" 68 "16" 70 "18" 72 "20" 74 "22" 76 "24" 78 "26" 80 "28" 82 "30", labsize(*0.55)) ///
